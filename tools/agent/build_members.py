...
def document(headers, names):
    return {
        'description': 'Every snake_case name the public areg headers declare or '
                       'call. A call on an areg object whose name is absent here '
                       'exists nowhere in the framework. C++ keywords, fundamental '
                       'and fixed-width type names, and conversion operators are '
                       'not members and are excluded.',
