...
<!-- h2><img src="./docs/img/pin.svg" style="width:2%;height:2%;vertical-align:text-bottom"/> Project status</h2 -->
## <img src="./docs/img/pin.svg" style="width:2%;height:2%"/> Project Status
