...
private:
     ...
     **/
    void _setServiceStatus( areg::eServiceConnection newStatus );
    /**
     ...
     **/
    void _setService( const ProxyAddress & addrProxy, areg::eServiceConnection connectStatus = areg::eServiceConnection::ServicePending );
...
inline areg::eServiceConnection ServiceProxy::getServiceStatus() const
{
