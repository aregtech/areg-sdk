...
void MultitargetRouter::printStatus(const String& status)
{
    ...
    if (MultitargetRouter::getInstance().getCurrentOption() == aregext::eServiceOption::CMD_Console)
    {
...
areg::eRemoteServices MultitargetRouter::getServiceType() const
{
    return areg::eRemoteServices::ServiceRouter;
}

areg::eConnectionTypes MultitargetRouter::getConnectionType() const
{
