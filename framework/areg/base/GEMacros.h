...
#include "areg/base/private/DebugDefs.hpp"
            ...
            #define AREG_OUTPUT_DBG(...)        areg::outputConsole(areg::DebugPriority::PrioDbg, __VA_ARGS__)
        #else
            ...
            #define AREG_OUTPUT_INFO(...)       areg::outputConsole(areg::DebugPriority::PrioInfo, __VA_ARGS__)
        #else
            ...
            #define AREG_OUTPUT_WARN(...)       areg::outputConsole(areg::DebugPriority::PrioWarn, __VA_ARGS__)
        #else
            ...
            #define AREG_OUTPUT_ERR(...)        areg::outputConsole(areg::DebugPriority::PrioErr, __VA_ARGS__)
        #else
            ...
            #define AREG_OUTPUT_MSG(...)        areg::outputConsole( __VA_ARGS__)
        #else
...
/**
 * \brief   Namespace macros. Always expand to the areg:: namespace.
 *          Use AREG_NAMESPACE_BEGIN and AREG_NAMESPACE_END to wrap
 *          framework declarations in the areg:: namespace.
 *          Use AREG_NAMESPACE_USE in .cpp files (never in headers)
 *          to import all areg:: names into the current scope.
 **/
#ifndef AREG_NAMESPACE_BEGIN
    #define AREG_NAMESPACE_BEGIN    namespace areg {
#endif  // AREG_NAMESPACE_BEGIN

#ifndef AREG_NAMESPACE_END
    #define AREG_NAMESPACE_END      }
#endif  // AREG_NAMESPACE_END

#ifndef AREG_NAMESPACE_USE
    #define AREG_NAMESPACE_USE      using namespace areg;
#endif  // AREG_NAMESPACE_USE
