...
//////////////////////////////////////////////////////////////////////////
     ...
     **/
    AREG_API SOCKETHANDLE clientSocketConnect( const areg::SocketAddress & peerAddr );
     ...
     *          Otherwise, it returns areg::InvalidSocketHandle value.
     **/
    AREG_API SOCKETHANDLE clientSocketConnect( const std::string_view & hostName, unsigned short portNr, areg::SocketAddress * out_socketAddr = nullptr );
     ...
     *          Otherwise, it returns areg::InvalidSocketHandle value.
     **/
    AREG_API SOCKETHANDLE serverSocketConnect( const areg::SocketAddress & peerAddr );
     ...
     *          Otherwise, it returns areg::InvalidSocketHandle value.
     **/
    AREG_API SOCKETHANDLE serverSocketConnect( const std::string_view & hostName, unsigned short portNr, areg::SocketAddress * out_socketAddr = nullptr );
     ...
     **/
    AREG_API bool serverListenConnection( SOCKETHANDLE serverSocket, int maxQueueSize = areg::MAXIMUM_LISTEN_QUEUE_SIZE);
     ...
     **/
    AREG_API SOCKETHANDLE serverAcceptConnection( SOCKETHANDLE serverSocket, const SOCKETHANDLE * masterList, int entriesCount, areg::SocketAddress * out_socketAddr = nullptr );
...
inline unsigned short areg::SocketAddress::getHostPort() const
{
    return mPortNr;
}
