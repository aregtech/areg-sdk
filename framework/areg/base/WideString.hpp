...
/************************************************************************/
     ...
     **/
    static int32_t makeInt32( const wchar_t * strDigit, areg::eRadix radix = areg::eRadix::RadixDecimal, const wchar_t ** end = nullptr );
    /**
     ...
     **/
    static uint32_t makeUInt32( const wchar_t * strDigit, areg::eRadix radix = areg::eRadix::RadixDecimal, const wchar_t ** end = nullptr );
    /**
     ...
     **/
    static int64_t makeInt64( const wchar_t * strDigit, areg::eRadix radix = areg::eRadix::RadixDecimal, const wchar_t ** end = nullptr );
    /**
     ...
     **/
    static uint64_t makeUInt64( const wchar_t * strDigit, areg::eRadix radix = areg::eRadix::RadixDecimal, const wchar_t ** end = nullptr );
    /**
     ...
     **/
    static WideString makeString( int32_t number, areg::eRadix radix = areg::eRadix::RadixDecimal );
    /**
     ...
     * \return  Returns converted string.
     **/
    static WideString makeString( uint32_t number, areg::eRadix radix = areg::eRadix::RadixDecimal );
    /**
     ...
     * \return  Returns converted string.
     **/
    static WideString makeString( int64_t number, areg::eRadix radix = areg::eRadix::RadixDecimal );
    /**
     ...
     * \return  Returns converted string.
     **/
    static WideString makeString( uint64_t number, areg::eRadix radix = areg::eRadix::RadixDecimal );
    /**
...
/************************************************************************/
     ...
     * \return  Returns the 32-bit integer
     **/
    inline int32_t toInt32( areg::eRadix radix = areg::eRadix::RadixDecimal ) const;
    /**
     * \brief   Converts string of digits to 32-bit unsigned integer
     * \param   radix       The base value when calculate integer.
     * \return  Returns the 32-bit unsigned integer
     **/
    inline uint32_t toUInt32( areg::eRadix radix = areg::eRadix::RadixDecimal ) const;
    /**
     * \brief   Converts string of digits to 64-bit integer
     * \param   radix       The base value when calculate integer.
     * \return  Returns the 64-bit integer
     **/
    inline int64_t toInt64( areg::eRadix radix = areg::eRadix::RadixDecimal ) const;
    /**
     * \brief   Converts string of digits to 64-bit unsigned integer
     * \param   radix       The base value when calculate integer.
     * \return  Returns the 64-bit unsigned integer
     **/
    inline uint64_t toUInt64( areg::eRadix radix = areg::eRadix::RadixDecimal ) const;
    /**
     ...
     **/
    inline WideString & fromInt32( int32_t value, areg::eRadix radix = areg::eRadix::RadixDecimal );
     ...
     *          are filled with
     **/
    inline WideString & fromUInt32( uint32_t value, areg::eRadix radix = areg::eRadix::RadixDecimal );
    /**
     ...
     *          might make sense to use FromUInt32 method.
     **/
    inline WideString & fromInt64( int64_t value, areg::eRadix radix = areg::eRadix::RadixDecimal );
    /**
     ...
     *          are filled with
     **/
    inline WideString & fromUInt64( uint64_t value, areg::eRadix radix = areg::eRadix::RadixDecimal );
    /**
...
inline int32_t WideString::toInt32( areg::eRadix radix /*= areg::RadixDecimal */ ) const
{
    return WideString::makeInt32(getString(), radix, nullptr );
}

inline uint32_t WideString::toUInt32( areg::eRadix radix /*= areg::RadixDecimal */ ) const
{
    return WideString::makeUInt32(getString(), radix, nullptr );
}

inline int64_t WideString::toInt64( areg::eRadix radix /*= areg::RadixDecimal */ ) const
{
    return WideString::makeInt64(getString(), radix, nullptr );
}

inline uint64_t WideString::toUInt64( areg::eRadix radix /*= areg::RadixDecimal */ ) const
{
...
{
    return (isEmpty() || areg::compareIgnoreCase<wchar_t, char>(getString(), areg::BOOLEAN_FALSE.data()) == areg::eCompare::Equal ? false : true);
}

inline WideString & WideString::fromInt32( int32_t value, areg::eRadix radix /*= areg::RadixDecimal */ )
{
    *this = WideString::makeString(value, radix);
    return (*this);
}

inline WideString & WideString::fromUInt32( uint32_t value, areg::eRadix radix /*= areg::RadixDecimal */ )
{
    (*this) = WideString::makeString( value, radix );
    return (*this);
}

inline WideString & WideString::fromInt64( int64_t value, areg::eRadix radix /*= areg::RadixDecimal */ )
{
    (*this) = WideString::makeString( value, radix );
    return (*this);
}

inline WideString & WideString::fromUInt64( uint64_t value, areg::eRadix radix /*= areg::RadixDecimal */ )
{
    (*this) = WideString::makeString( value, radix );
    return (*this);
}
