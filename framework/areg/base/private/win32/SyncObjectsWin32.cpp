...
void ResourceLock::_osCreateResourceLock( bool initLock )
{
    ...
    if ( initLock )
    {
        reinterpret_cast<IEResourceLock *>(mSyncObject)->lock( areg::common::WAIT_INFINITE );
    }
...
{
    void * syncHandles[areg::common::MAXIMUM_WAITING_OBJECTS] { };
