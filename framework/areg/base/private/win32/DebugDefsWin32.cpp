 ...
 * \file        areg/base/private/win32/DebugDefsWin32.cpp
...
void AREG_API_IMPL areg::dumpExceptionCallStack( struct _EXCEPTION_POINTERS *ep, std::list<std::string> & callStack )
{
    ...
    constexpr unsigned int   _sizeOfSymInfo     { areg::alignSize(static_cast<uint32_t>(sizeof( SYMBOL_INFO )) + _symNameLength * static_cast<uint32_t>(sizeof( char )), static_cast<uint32_t>(sizeof(ULONG64))) };
