...
public:
     ...
     *          Otherwise, the value of output parameter should be ignored.
     **/
    bool getString(String & out_value) const;
     ...
     *          Otherwise, the value of output parameter should be ignored.
     **/
    bool getString(WideString & out_value) const;
     ...
     *          Otherwise, the value of output parameter should be ignored.
     **/
    bool readLine(String & out_value) const;
     ...
     *          Otherwise, the value of output parameter should be ignored.
     **/
    bool readLine(WideString & out_value) const;
...
private:
    ReadConverter( void );
    ReadConverter( const ReadConverter & /*src*/ );
    const ReadConverter & operator = ( const ReadConverter & /*src*/ );
};
