...
MutexPosix::MutexPosix( bool initLocked /*= false*/, const char * asciiName /* = nullptr */)
    : SyncObjectPosix( areg::os::eSyncObject::SoMutex, asciiName)
...
MutexPosix::MutexPosix( areg::os::eSyncObject syncType, bool isRecursive, const char * asciiName /* = nullptr */ )
...
bool MutexPosix::lock( unsigned int msTimeout /*= areg::WAIT_INFINITE*/ ) const
{
    bool result = false;
    if ( mMutexValid )
    {
