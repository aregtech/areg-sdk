 ...
 *          equal to areg::common::MAXIMUM_WAITING_OBJECTS.
...
private:
    ...
    /**
     * \brief   The fixed array of waitable. The maximum size of array is areg::common::MAXIMUM_WAITING_OBJECTS
     **/
...
public:
     ...
     *                      If areg::common::WAIT_INFINITE, it will wait until event is signaled or failed.
     ...
     **/
    static int waitForSingleObject( IEWaitableBaseIX & syncWait, unsigned int msTimeout = areg::common::WAIT_INFINITE );
     ...
     *          There can be maximum areg::common::MAXIMUM_WAITING_OBJECTS in the list to wait. This limitation is synchronized
     ...
     *                          areg::common::MAXIMUM_WAITING_OBJECTS entries in the list.
     * \param   count           The number of waitables in the list. There should be no more than 
     *                          areg::common::MAXIMUM_WAITING_OBJECTS entries.
     ...
     **/
    static int waitForMultipleObjects( IEWaitableBaseIX ** listWaitables, int count, bool waitAll = false, unsigned int msTimeout = areg::common::WAIT_INFINITE);
...
private:
     ...
     * \param   listWaitables   The list of waitables. The maximum number of entries should be areg::common::MAXIMUM_WAITING_OBJECTS
     * \param   count           The number of waitables in the list. The maximum number of entries should be areg::common::MAXIMUM_WAITING_OBJECTS.
