...
//////////////////////////////////////////////////////////////////////////
    ...
    inline int32_t _formatBinary( WideString & result, DigitType number )
    {
        ...
        *dst    = static_cast<wchar_t>(areg::EndOfString);
        ...
        areg::revertString<wchar_t>(buffer, count);
        if ( isNegative )
        {
            result = L'-';
            ++ count;
     ...
     * \return  Returns the number of characters in the buffer, not including null-character.
     **/
    template<int const CharCount = areg::MSG_MIN_BUF_SIZE>
...
int32_t WideString::makeInt32( const wchar_t * strDigit, areg::eRadix radix /*= areg::RadixDecimal*/, const wchar_t ** end /*= nullptr*/ )
{
    wchar_t * temp = nullptr;
    int result  = static_cast<int>(areg::isEmpty<wchar_t>(strDigit) == false ? wcstol( strDigit, &temp, static_cast<int>(radix) ) : 0);
    if (end != nullptr)
    {
...
uint32_t WideString::makeUInt32( const wchar_t * strDigit, areg::eRadix radix /*= areg::RadixDecimal*/, const wchar_t ** end /*= nullptr*/ )
{
    wchar_t * temp = nullptr;
    unsigned int result = static_cast<unsigned int>(areg::isEmpty<wchar_t>(strDigit) == false ? wcstoul(strDigit, &temp, static_cast<int>(radix)) : 0);
    if (end != nullptr)
    {
        *end = temp != nullptr ? temp : strDigit;
    }
...
int64_t WideString::makeInt64( const wchar_t * strDigit, areg::eRadix radix /*= areg::RadixDecimal*/, const wchar_t ** end /*= nullptr*/ )
{
    wchar_t * temp = nullptr;
    int64_t result = static_cast<long long int>(areg::isEmpty<wchar_t>(strDigit) == false ? wcstoll(strDigit, &temp, static_cast<int>(radix)) : 0);
    if (end != nullptr)
    {
        *end = temp != nullptr ? temp : strDigit;
    }
...
uint64_t WideString::makeUInt64(const wchar_t * strDigit, areg::eRadix radix /*= areg::RadixDecimal*/, const wchar_t ** end /*= nullptr*/)
{
    wchar_t * temp = nullptr;
    uint64_t result = static_cast<uint64_t>(areg::isEmpty<wchar_t>(strDigit) == false ? wcstoull(strDigit, &temp, static_cast<int>(radix)) : 0);
    if (end != nullptr)
    {
        *end = temp != nullptr ? temp : strDigit;
    }
...
bool WideString::makeBool( const wchar_t * strBoolean, const wchar_t ** end /*= nullptr*/ )
{
    ...
    if ( areg::compareStrings<wchar_t, char>(strBoolean, areg::BOOLEAN_TRUE.data(), lenTrue, false) == areg::eCompare::Equal)
    {
        result = true;
        lenSkip= lenTrue;
    }
    else if ( areg::compareStrings<wchar_t, char>(strBoolean, areg::BOOLEAN_FALSE.data(), lenFalse, false) == areg::eCompare::Equal)
    {
        result = false;
        lenSkip= lenFalse;
    }
...
WideString WideString::makeString(int32_t number, areg::eRadix radix /*= areg::RadixDecimal */)
{
    WideString result;
...
WideString WideString::makeString(uint32_t number, areg::eRadix radix /*= areg::RadixDecimal */)
{
    WideString result;
...
WideString WideString::makeString(int64_t number, areg::eRadix radix /*= areg::RadixDecimal */)
{
    WideString result;
...
WideString WideString::makeString(uint64_t number, areg::eRadix radix /*= areg::RadixDecimal */)
{
    WideString result;
