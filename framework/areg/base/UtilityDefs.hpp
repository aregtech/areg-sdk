...
/************************************************************************/
     ...
     **/
    AREG_API areg::eCompare compareTimes( const sSystemTime & lhs, const sSystemTime & rhs );
     ...
     *              - areg::Bigger  if Left-Hand Operand 'lhs' is greater than Right-Hand Operand 'rhs'
     **/
    AREG_API areg::eCompare compareTimes( const TIME64 & lhs, const TIME64 & rhs );
