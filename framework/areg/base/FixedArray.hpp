...
namespace areg
{
    ...
    **/
    ...
    {
        copyElems<VALUE>(mValueList, src.mValueList, mElemCount);
    }
    ...
    {
        copyElems<VALUE>(mValueList, list, mElemCount);
    }
    ...
    {
        return ((mElemCount == other.getSize()) && equalElements<VALUE>(mValueList, other.mValueList, mElemCount));
    }
    ...
    {
        return (find(elemSearch, startAt) != INVALID_INDEX);
    }
