...
/************************************************************************/
     ...
     **/
    static int32_t makeInt32( const char * strDigit, areg::eRadix radix = areg::eRadix::RadixDecimal, const char ** end = nullptr );
    /**
     ...
     **/
    static uint32_t makeUInt32( const char * strDigit, areg::eRadix radix = areg::eRadix::RadixDecimal, const char ** end = nullptr );
    /**
     ...
     **/
    static int64_t makeInt64( const char * strDigit, areg::eRadix radix = areg::eRadix::RadixDecimal, const char ** end = nullptr );
    /**
     ...
     **/
    static uint64_t makeUInt64( const char * strDigit, areg::eRadix radix = areg::eRadix::RadixDecimal, const char ** end = nullptr );
    /**
     ...
     **/
    static String makeString( int32_t number, areg::eRadix radix = areg::eRadix::RadixDecimal );
    /**
     ...
     * \return  Returns converted string.
     **/
    static String makeString( uint32_t number, areg::eRadix radix = areg::eRadix::RadixDecimal );
    /**
     ...
     * \return  Returns converted string.
     **/
    static String makeString( int64_t number, areg::eRadix radix = areg::eRadix::RadixDecimal );
    /**
     ...
     * \return  Returns converted string.
     **/
    static String makeString( uint64_t number, areg::eRadix radix = areg::eRadix::RadixDecimal );
    /**
...
/************************************************************************/
     ...
     **/
    inline String & fromInt32( int32_t value, areg::eRadix radix = areg::eRadix::RadixDecimal );
     ...
     *          are filled with
     **/
    inline String & fromUInt32( uint32_t value, areg::eRadix radix = areg::eRadix::RadixDecimal );
    /**
     ...
     *          might make sense to use FromUInt32 method.
     **/
    inline String & fromInt64( int64_t value, areg::eRadix radix = areg::eRadix::RadixDecimal );
    /**
     ...
     *          are filled with
     **/
    inline String & fromUInt64( uint64_t value, areg::eRadix radix = areg::eRadix::RadixDecimal );
    /**
...
inline int32_t String::toInt32( areg::eRadix radix /*= areg::RadixDecimal */ ) const
{
    return String::makeInt32(getString(), radix, nullptr );
}

inline uint32_t String::toUInt32( areg::eRadix radix /*= areg::RadixDecimal */ ) const
{
    return String::makeUInt32(getString(), radix, nullptr );
}

inline int64_t String::toInt64( areg::eRadix radix /*= areg::RadixDecimal */ ) const
{
    return String::makeInt64(getString(), radix, nullptr );
}

inline uint64_t String::toUInt64( areg::eRadix radix /*= areg::RadixDecimal */ ) const
{
...
{
    return (isEmpty() || areg::compareIgnoreCase<char, char>(getString(), areg::BOOLEAN_FALSE.data()) == areg::eCompare::Equal ? false : true);
}

inline String & String::fromInt32( int32_t value, areg::eRadix radix /*= areg::RadixDecimal */ )
{
    *this = String::makeString(value, radix);
    return (*this);
}

inline String & String::fromUInt32( uint32_t value, areg::eRadix radix /*= areg::RadixDecimal */ )
{
    (*this) = String::makeString( value, radix );
    return (*this);
}

inline String & String::fromInt64( int64_t value, areg::eRadix radix /*= areg::RadixDecimal */ )
{
    (*this) = String::makeString( value, radix );
    return (*this);
}

inline String & String::fromUInt64( uint64_t value, areg::eRadix radix /*= areg::RadixDecimal */ )
{
    (*this) = String::makeString( value, radix );
    return (*this);
}
