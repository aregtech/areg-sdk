...
public:
     ...
     **/
    inline virtual bool lock( unsigned int timeout = areg::common::WAIT_INFINITE ) override;
...
public:
     ...
     **/
    virtual bool lock( unsigned int /*timeout = areg::common::WAIT_INFINITE*/) override;
...
public:
     ...
     **/
    inline bool lock( unsigned int timeout = areg::common::WAIT_INFINITE );
...
public:
     ...
     **/
    static constexpr int    LOCK_INDEX_ALL          { areg::common::MAXIMUM_WAITING_OBJECTS };
...
public:
     ...
     **/
    inline int lock( unsigned int timeout = areg::common::WAIT_INFINITE, bool waitForAll = false, bool isAlertable = false );
...
private:
     ...
     **/
    eLockedState            mLockedStates[areg::common::MAXIMUM_WAITING_OBJECTS];
    /**
...
public:
    ...
    static constexpr Duration   ONE_NS      { areg::common::DURATION_1_NS };
    //!< One microsecond duration
    static constexpr Duration   ONE_MUS     { areg::common::DURATION_1_MICRO };
    //!< One millisecond duration
    static constexpr Duration   ONE_MS      { areg::common::DURATION_1_MILLI };
    //!< One second duration
    static constexpr Duration   ONE_SEC     { areg::common::DURATION_1_SEC };
...
//////////////////////////////////////////////////////////////////////////
inline bool Mutex::lock( unsigned int timeout /* = areg::common::WAIT_INFINITE */ )
{
...
{
    return lock( areg::common::DO_NOT_WAIT );
}
...
inline bool SyncEvent::lock( unsigned int timeout /* = areg::common::WAIT_INFINITE */ )
{
...
inline bool CriticalSection::lock( unsigned int  /*timeout = areg::common::WAIT_INFINITE */ )
{
    ASSERT( mSyncObject != nullptr );
    return _osLock( );
}
...
{
    return lock( areg::common::WAIT_INFINITE );
}
...
inline bool ResourceLock::lock( unsigned int timeout /*= areg::common::WAIT_INFINITE */ )
{
    ASSERT( mSyncObject != nullptr );
...
inline bool NolockSyncObject::lock( unsigned int /*timeout = areg::common::WAIT_INFINITE*/ )
{
    return true;
}
...
inline bool SyncTimer::lock( unsigned int timeout /* = areg::common::WAIT_INFINITE */ )
{
    ASSERT( mSyncObject != nullptr );
    return _osLock( timeout );
}
...
//////////////////////////////////////////////////////////////////////////
inline bool Lock::lock(unsigned int timeout /* = areg::common::WAIT_INFINITE */)
{
...
//////////////////////////////////////////////////////////////////////////
inline int MultiLock::lock( unsigned int timeout /* = areg::common::WAIT_INFINITE */, bool waitForAll /* = false */, bool isAlertable /*= false*/ )
{
    ASSERT( mSizeCount != 0 );
