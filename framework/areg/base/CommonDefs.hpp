...
AREG_NAMESPACE_BEGIN
     ...
     **/
    constexpr ElemPos      INVALID_INDEX            { static_cast<ElemPos>(areg::eIndex::InvalidIndex) };

    /**
     * \brief   The first valid index in the buffer.
     **/
    constexpr ElemPos       FIRST_INDEX             { static_cast<ElemPos>(areg::eIndex::FirtIndex) };
    
    /**
     * \brief   The last valid position in the string.
     **/
    constexpr ElemPos       LAST_INDEX              { static_cast<ElemPos>(areg::eIndex::LastIndex) };
