...
/************************************************************************/
     ...
     **/
    virtual bool createThread( unsigned int waitForStartMs = areg::DO_NOT_WAIT );
     ...
     **/
    virtual Thread::eCompletionStatus shutdownThread( unsigned int waitForStopMs = areg::DO_NOT_WAIT );
     ...
     **/
    virtual bool completionWait( unsigned int waitForCompleteMs = areg::WAIT_INFINITE );
...
//////////////////////////////////////////////////////////////////////////
     ...
     **/
    inline static void switchThread();

    /**
     * \brief   Returns the ID of current thread.
     **/
    inline static id_type getCurrentThreadId();
...
private:
     ...
     **/
    inline bool _isValidNoLock() const;
...
private:
     ...
     **/
    static id_type _osGetCurrentThreadId();
...
inline bool Thread::_isValidNoLock() const
{
