...
namespace areg
{
    ...
    public:
         ...
         * \param	blockSize	The block size to increase. By default the block size is 4 x BLOCK_SIZE (default 64 bytes)
         **/
        explicit FileBuffer( uint32_t mode      = (static_cast<uint32_t>(FileBase::OpenMode::Write) | static_cast<uint32_t>(FileBase::OpenMode::Binary))
                        ...
                        , uint32_t blockSize = FileBuffer::DEFAULT_BLOCK_SIZE);
