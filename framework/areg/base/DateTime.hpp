...
public:
     ...
     **/
    explicit DateTime( const areg::sSystemTime & sysTime );
...
/************************************************************************/
     ...
     **/
    static void getNow( areg::sSystemTime & timeData, bool localTime );
...
/************************************************************************/
     ...
     **/
    void getDateTime(areg::sSystemTime& sysTime);
     ...
     **/
    void setDateTime(const areg::sSystemTime& sysTime);
