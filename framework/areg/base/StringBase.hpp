...
public:
     ...
     **/
    areg::eCompare compare( const CharType * strOther, areg::CharPos startAt = areg::START_POS, areg::CharCount count = areg::COUNT_ALL, bool caseSensitive = true) const;
    inline areg::eCompare compare(const StringBase<CharType> & strOther, bool caseSensitive = true) const;
    inline areg::eCompare compare(const std::basic_string<CharType>& strOther, bool caseSensitive = true) const;
    inline areg::eCompare compare(const std::basic_string_view<CharType>& strOther, bool caseSensitive = true) const;
    inline areg::eCompare compare(const StringBase<CharType>& strOther, areg::CharPos startAt = areg::START_POS, areg::CharCount count = areg::COUNT_ALL, bool caseSensitive = true) const;
    inline areg::eCompare compare(const std::basic_string<CharType>& strOther, areg::CharPos startAt = areg::START_POS, areg::CharCount count = areg::COUNT_ALL, bool caseSensitive = true) const;
     ...
     * \return  Returns modified string.
     **/
    StringBase<CharType>& moveTo(areg::CharPos startPos, int moveTo);
...
protected:
     ...
     *              areg::Bigger  if string is more than given string
     **/
    inline areg::eCompare compareString( areg::CharPos startPos, const CharType * strOther, areg::CharCount count = areg::COUNT_ALL, bool caseSensitive = true ) const;
     ...
     *              areg::Bigger  if string is more than given string
     **/
    inline areg::eCompare compareStringExact(areg::CharPos startPos, const CharType* strOther, areg::CharCount count = areg::COUNT_ALL) const;
     ...
     *              areg::Bigger  if string is more than given string
     **/
    inline areg::eCompare compareStringIgnoreCase(areg::CharPos startPos, const CharType * strOther, areg::CharCount count = areg::COUNT_ALL) const;
...
inline bool StringBase<CharType>::isValidNameChar(const CharType checkChar) const
{
    ...
    return (std::isalnum(static_cast<int>(checkChar)) != 0) || areg::isOneOf<CharType>(checkChar, symbols);
}
...
inline areg::CharPos StringBase<CharType>::findLast(const CharType* phrase, areg::CharCount phraseCount, areg::CharPos startPos, bool caseSensitive) const
{
    ...
    {
        if ((compareString(pos, phrase, count, caseSensitive) == areg::eCompare::Equal))
        {
            result = pos;
            break;
        }
...
template<typename CharType>
areg::eCompare StringBase<CharType>::compare(const CharType* what, areg::CharPos startAt /*= areg::START_POS*/, areg::CharCount count /*= areg::COUNT_ALL*/, bool caseSensitive /*= true*/) const
{
    areg::eCompare result{ areg::eCompare::Smaller };
...
template<typename CharType>
inline areg::eCompare StringBase<CharType>::compare(const StringBase<CharType>& other, bool caseSensitive /*= true*/) const
{
    return compare(other.mData, caseSensitive);
}

template<typename CharType>
inline areg::eCompare StringBase<CharType>::compare(const std::basic_string<CharType>& other, bool caseSensitive /*= true*/) const
{
    return compare(other.c_str(), areg::START_POS, static_cast<areg::CharCount>(other.length()), caseSensitive);
}

template<typename CharType>
inline areg::eCompare StringBase<CharType>::compare(const std::basic_string_view<CharType>& other, bool caseSensitive /*= true*/) const
{
    return compare(other.data(), areg::START_POS, static_cast<areg::CharCount>(other.length()), caseSensitive);
}

template<typename CharType>
inline areg::eCompare StringBase<CharType>::compare( const StringBase<CharType>& other
                                                   , areg::CharPos startPos /*= areg::START_POS*/
...
template<typename CharType>
inline areg::eCompare StringBase<CharType>::compare( const std::basic_string<CharType>& other
...
template<typename CharType>
StringBase<CharType>& StringBase<CharType>::moveTo(areg::CharPos startPos, int moveTo)
{
    if (moveTo < 0)
    {
...
template<typename CharType>
inline areg::eCompare StringBase<CharType>::compareString( areg::CharPos startPos
...
template<typename CharType>
inline areg::eCompare StringBase<CharType>::compareStringExact( areg::CharPos startPos
                                                              , const CharType * strOther
...
template<typename CharType>
inline areg::eCompare StringBase<CharType>::compareStringIgnoreCase( areg::CharPos startPos
                                                                   , const CharType * strOther
                                                                   , areg::CharCount count/*= areg::COUNT_ALL */ ) const
{
    areg::eCompare result = areg::eCompare::Smaller;
