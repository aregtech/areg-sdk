...
public:
     ...
     **/
    PropertyKey(const String& section, const String& module, const String& property, const String& position, areg::eConfigKeys keyType);
    PropertyKey(const std::string_view& section, const std::string_view& module, const std::string_view& property, const std::string_view& position, areg::eConfigKeys keyType);
...
public:
     ...
     * \param   keyType     The type of the property key.
     **/
    void setValues(const String& section, const String& property, const String& module, const String& position, areg::eConfigKeys keyType);
     ...
     **/
    areg::eConfigKeys getKeyType() const;
...
private:
     ...
     **/
    inline static areg::eConfigKeys _findKey(const String& section, const String& module, const String& property, const String& position);
