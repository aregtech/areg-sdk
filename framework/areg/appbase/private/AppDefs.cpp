...
{
      {static_cast<unsigned int>(NELogging::LoggingType::LogTypeUndefined)               , NEApplication::DefaultLogTypes[0].ltIdName        }
    , {static_cast<unsigned int>(NELogging::LoggingType::LogTypeRemote)                  , NEApplication::DefaultLogTypes[1].ltIdName        }
    , {static_cast<unsigned int>(NELogging::LoggingType::LogTypeFile)                    , NEApplication::DefaultLogTypes[2].ltIdName        }
    , {static_cast<unsigned int>(NELogging::LoggingType::LogTypeDebug)                   , NEApplication::DefaultLogTypes[3].ltIdName        }
    , {static_cast<unsigned int>(NELogging::LoggingType::LogTypeDatabase)                , NEApplication::DefaultLogTypes[4].ltIdName        }
};
