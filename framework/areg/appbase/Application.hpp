...
//////////////////////////////////////////////////////////////////////////
     ...
     **/
    using MapAppStorage     = StringHashMap<areg::uAlign>;
...
public:
     ...
     **/
    static areg::uAlign storeElement( const String & elemName, areg::uAlign elem );
     ...
     **/
    static areg::uAlign getStoredElement( const String & elemName );
     ...
     **/
    static bool waitAppQuit( unsigned int waitTimeout = areg::WAIT_INFINITE);
...
private:
     ...
     **/
    areg::eApplicationState    mAppState;
    /**
...
private:
     ...
     **/
    static bool _setAppState(areg::eApplicationState newState);
