...
/************************************************************************/
     ...
     **/
    virtual void unregisteredRemoteServiceProvider( const StubAddress & stub, areg::eDisconnectReason reason, const ITEM_ID & cookie /*= areg::COOKIE_ANY*/ ) = 0;
     ...
     *                  The parameter is ignored if 'areg::COOKIE_ANY'.
     **/
    virtual void unregisteredRemoteServiceConsumer( const ProxyAddress & proxy, areg::eDisconnectReason reason, const ITEM_ID & cookie /*= areg::COOKIE_ANY*/ ) = 0;
