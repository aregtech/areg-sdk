...
/************************************************************************/
     ...
     **/
    virtual void unregisterServiceProvider(const StubAddress& stubService, const areg::eDisconnectReason reason) = 0;
     ...
     **/
    virtual void unregisterServiceConsumer(const ProxyAddress& proxyService, const areg::eDisconnectReason reason) = 0;
