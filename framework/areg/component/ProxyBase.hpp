...
private:
    ...
    public:
         ...
         **/
        Listener( unsigned int msgId, SequenceNumber seqNr );
         ...
         **/
        Listener(unsigned int msgId, SequenceNumber seqNr, IENotificationEventConsumer * caller);
...
public:
     ...
     **/
    static RemoteResponseEvent * createRequestFailureEvent(const ProxyAddress & target, unsigned int msgId, NEService::eResultType errCode, SequenceNumber seqNr);
...
/************************************************************************/
     ...
     **/
    virtual RemoteResponseEvent * createRemoteRequestFailedEvent( const ProxyAddress & addrProxy, unsigned int msgId, NEService::eResultType reason, SequenceNumber seqNr ) const;
...
/************************************************************************/
     ...
     **/
    virtual void sendNotificationEvent( unsigned int msgId, NEService::eResultType resType, SequenceNumber seqNr, IENotificationEventConsumer * caller );
...
protected:
     ...
     **/
    inline void removeListener( unsigned int msgId, SequenceNumber seqNr, IENotificationEventConsumer * caller );
     ...
     **/
    inline bool addListener( unsigned int msgId, SequenceNumber seqNr, IENotificationEventConsumer * caller, bool unique );
     ...
     **/
    void notifyListeners( unsigned int respId, NEService::eResultType result, SequenceNumber seqNrToSearch );
     ...
     **/
    int prepareListeners( ProxyBase::ProxyListenerList & out_listenerList, unsigned int msgId, SequenceNumber seqNrToSearch );
...
inline bool ProxyBase::addListener( unsigned int msgId, SequenceNumber seqNr, IENotificationEventConsumer* caller, bool unique)
{
...
inline void ProxyBase::removeListener( unsigned int msgId, SequenceNumber seqNr, IENotificationEventConsumer* caller )
{
