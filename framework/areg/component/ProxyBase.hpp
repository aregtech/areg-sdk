...
public:
     ...
     **/
    static RemoteResponseEvent * createRequestFailureEvent(const ProxyAddress & target, unsigned int msgId, NEService::ResultType errCode, const SequenceNumber & seqNr);
...
protected:
     ...
     **/
    void notifyListeners( unsigned int respId, NEService::ResultType result, const SequenceNumber & seqNrToSearch );
