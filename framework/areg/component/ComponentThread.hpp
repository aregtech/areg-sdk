...
public:
     ...
     * \param   stackSizeKb     The stack size of thread in kilobytes (1 KB = 1024 Bytes). Pass `areg::common::STACK_SIZE_DEFAULT` (0)
...
/************************************************************************/
     ...
     *          It will return true if thread has been completed or waiting timeout is areg::common::DO_NOT_WAIT.
     ...
     **/
    virtual bool completionWait( unsigned int waitForCompleteMs = areg::common::WAIT_INFINITE ) override;
