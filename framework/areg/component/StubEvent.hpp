...
protected:
     ...
     **/
    virtual void processStubRegisteredEvent( const StubAddress & stubTarget, areg::ServiceConnectionState status ) = 0;
     ...
     **/
    virtual void processClientConnectEvent( const ProxyAddress & proxyAddress, areg::ServiceConnectionState status ) = 0;
