...
/************************************************************************/
     ...
     **/
    static void requestUnregisterServer( const StubAddress & whichServer, const areg::eDisconnectReason reason );
     ...
     **/
    static void requestUnregisterClient( const ProxyAddress & whichClient, const areg::eDisconnectReason reason );
