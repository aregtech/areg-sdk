...
ServiceManagerEventData ServiceManagerEventData::unregisterProxy( const ProxyAddress & addrProxy, areg::eDisconnectReason reason )
{
...
ServiceManagerEventData ServiceManagerEventData::unregisterStub( const StubAddress & addrStub, areg::eDisconnectReason reason )
{
...
ServiceManagerEventData ServiceManagerEventData::configureConnection(areg::eRemoteServices service, unsigned int connectTypes)
{
...
ServiceManagerEventData ServiceManagerEventData::startConnection(areg::eRemoteServices service, unsigned int connectTypes)
{
