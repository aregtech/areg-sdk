...
TimerManagerBase::TimerManagerBase(const String& threadName)
    : DispatcherThread              (threadName, areg::common::STACK_SIZE_DEFAULT, areg::common::QUEUE_SIZE_MAXIMUM)
...
bool TimerManagerBase::runDispatcher()
{
    ...
    do
    {
        whichEvent = multiLock.lock(areg::common::WAIT_INFINITE, false, true);
