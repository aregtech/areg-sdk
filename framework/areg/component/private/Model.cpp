...
areg::ServiceEntry::ServiceEntry( const String & serviceName, unsigned int major, unsigned int minor, unsigned int patch )
    : mName     ( serviceName )
...
int areg::ServiceList::findService( const areg::ServiceEntry & entry ) const
{
    return findService( entry.mName );
}

int areg::ServiceList::findService( const String & serviceName ) const
{
...
int areg::WorkerThreadList::findThread( const String & threadName ) const
{
    int result = areg::INVALID_INDEX;
...
int areg::WorkerThreadList::findThread( const areg::WorkerThreadEntry & entry ) const
{
...
int areg::DependencyList::findDependency( const areg::DependencyEntry & entry ) const
{
    return findDependency( entry.mRoleName );
}

int areg::DependencyList::findDependency( const String & roleName ) const
{
    int result = areg::INVALID_INDEX;
...
int areg::ComponentEntry::findSupportedService( const areg::ServiceEntry& entry ) const
{
    return mSupportedServices.findService(entry);
}

int areg::ComponentEntry::findSupportedService( const String & serviceName ) const
{
...
int areg::ComponentEntry::findWorkerThread( const areg::WorkerThreadEntry& entry ) const
{
    return mWorkerThreads.findThread(entry);
}

int areg::ComponentEntry::findWorkerThread( const String & workerName ) const
{
...
int areg::ComponentEntry::findDependencyService( const areg::DependencyEntry& entry ) const
{
...
int areg::ComponentEntry::findDependencyService( const String & roleName ) const
{
...
int areg::ComponentList::findComponent(const String & roleName) const
{
    int result = areg::INVALID_INDEX;
...
int areg::ComponentList::findComponent( const areg::ComponentEntry& entry ) const
{
...
int areg::ComponentThreadEntry::findComponentEntry( const areg::ComponentEntry & entry ) const
{
    return mComponents.findComponent(entry);
}

int areg::ComponentThreadEntry::findComponentEntry( const String & roleName ) const
{
...
int areg::ComponentThreadList::findThread( const areg::ComponentThreadEntry& entry ) const
{
    return findThread( entry.mThreadName );
}

int areg::ComponentThreadList::findThread( const String & threadName ) const
{
    int result = areg::INVALID_INDEX;
...
int areg::Model::findThread( const areg::ComponentThreadEntry& entry ) const
{
    return mModelThreads.findThread(entry);
}

int areg::Model::findThread( const String & threadName ) const
{
...
{
    return (mLoadState == areg::Model::eModelState::ModelLoaded);
}
