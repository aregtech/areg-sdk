...
protected:
    ...
    //////////////////////////////////////////////////////////////////////////
    virtual bool waitForDispatcherStart( unsigned int waitTimeout = areg::common::WAIT_INFINITE ) override;
...
bool NullDispatcherThread::waitForDispatcherStart( unsigned int /* waitTimeout */ /*= areg::common::WAIT_INFINITE */ )
{
    return false;
}
...
Thread::eCompletionStatus DispatcherThread::shutdownThread( unsigned int waitForStopMs /*= areg::common::DO_NOT_WAIT*/ )
{
...
bool DispatcherThread::waitForDispatcherStart( unsigned int waitTimeout /*= areg::common::WAIT_INFINITE */ )
{
