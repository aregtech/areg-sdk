...
public:
     ...
     **/
    StubConnectEvent( const StubAddress & stubTarget, areg::eServiceConnection connectStatus );
     ...
     **/
    StubConnectEvent( const ProxyAddress & proxyClient, const StubAddress & stubTarget, areg::eServiceConnection connectStatus );
...
inline areg::eServiceConnection StubConnectEvent::getConnectionStatus() const
{
