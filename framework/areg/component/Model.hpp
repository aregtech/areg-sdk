...
//////////////////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////////////////////////////////////////////
         ...
         *          Otherwise, returns -1.
         **/
        int findService(const areg::ServiceEntry & entry) const;
    ...
    //////////////////////////////////////////////////////////////////////////
         ...
         *          Otherwise, returns -1.
         **/
        int findThread( const areg::WorkerThreadEntry & entry ) const;
    ...
    //////////////////////////////////////////////////////////////////////////
         ...
         *          Otherwise, returns -1.
         **/
        int findDependency( const areg::DependencyEntry & entry ) const;
    ...
    //////////////////////////////////////////////////////////////////////////
         ...
         *          Otherwise, returns -1.
         **/
        int findSupportedService( const areg::ServiceEntry & entry ) const;
         ...
         *          Otherwise, returns -1.
         **/
        int findWorkerThread( const areg::WorkerThreadEntry & entry ) const;
         ...
         *          Otherwise, returns -1.
         **/
        int findDependencyService( const areg::DependencyEntry & entry ) const;
    ...
    //////////////////////////////////////////////////////////////////////////
         ...
         *          Otherwise, returns -1.
         **/
        int findComponent(const areg::ComponentEntry& entry) const;
    ...
    //////////////////////////////////////////////////////////////////////////
         ...
         *          Otherwise, returns -1.
         **/
        int findComponentEntry( const areg::ComponentEntry & entry ) const;
    ...
    //////////////////////////////////////////////////////////////////////////
         ...
         *          Otherwise, returns -1.
         **/
        int findThread( const areg::ComponentThreadEntry & entry ) const;
