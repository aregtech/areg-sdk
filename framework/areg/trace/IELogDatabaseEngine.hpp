#ifndef AREG_TRACE_IELOGDATABASEENGINE_HPP
#define AREG_TRACE_IELOGDATABASEENGINE_HPP
/************************************************************************
 ...
 * \file        areg/trace/IELogDatabaseEngine.hpp
...
/************************************************************************/
     ...
     **/
    virtual bool logMessage(const NETrace::sLogMessage & message, const DateTime & timestamp) = 0;
     ...
     **/
    virtual bool logScopeActivate(const NETrace::sScopeInfo & scope, const ITEM_ID & cookie, const DateTime & timestamp) = 0;
     ...
     **/
    virtual uint32_t logScopesActivate(const NETrace::ScopeNames& scopes, const ITEM_ID& cookie, const DateTime& timestamp) = 0;
...
#endif // AREG_TRACE_IELOGDATABASEENGINE_HPP
