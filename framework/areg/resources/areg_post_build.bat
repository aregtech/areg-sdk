...
set PROJECT_RESOUR_DIR=%5

:: full path of user resource folder
set USER_RESOUR_DIR=%6
...
echo PROJECT_RESOUR_DIR = %PROJECT_RESOUR_DIR%
echo USER_RESOUR_DIR = %USER_RESOUR_DIR%

echo copy /D /y %PROJECT_RESOUR_DIR%\log.init      %TARGET_DIR%\config\log.init
echo copy /D /y %PROJECT_RESOUR_DIR%\router.init   %TARGET_DIR%\config\router.init
