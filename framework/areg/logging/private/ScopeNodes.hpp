 ...
 * Implemented classes.
 ************************************************************************/
namespace areg { class ScopeLeaf; }
namespace areg { class ScopeNode; }
namespace areg { class ScopeRoot; }
...
namespace areg
{
     ...
     ************************************************************************/
         ...
         **/
        String makeScopePath( const String & prefix ) const override;
     ...
     **/
         ...
         **/
        String makeConfigString( const String & parent ) const override;
