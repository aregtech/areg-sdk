 ...
 ************************************************************************/
     ...
     **/
    areg::String makeScopePath( const areg::String & prefix ) const override;
...
protected:
     ...
     **/
    ScopeNode( ScopeNodeBase::NodeType nodeType, const areg::String & name, uint32_t prio );
 ...
 ************************************************************************/
  ...
  **/
    const ScopeNodeBase & makeChildNode( areg::String & scopePath, uint32_t prioStates ) const override;
     ...
     *          it created new entry or updated the existing.
     **/
    std::pair<ScopeNodeBase &, bool> addChildNode( areg::String & scopePath, uint32_t prioStates ) override;
     ...
     **/
    areg::String makeConfigString( const areg::String & parent ) const override;
