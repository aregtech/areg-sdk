...
namespace areg
{
    ...
    public:
         ...
         **/
        void addScopePriority( uint32_t scopeId, LogPriority addPrio );
         ...
         * \param   addPrio     The priority value to add.
         **/
        inline void addScopePriority( const String & scopeName, LogPriority addPrio );
         ...
         **/
        void removeScopePriority( uint32_t scopeId, LogPriority remPrio );
         ...
         * \param   remPrio     The priority value to remove.
         **/
        inline void removeScopePriority( const String & scopeName, LogPriority remPrio );
         ...
         *          Returns zero, if no log scope found.
         **/
        int32_t addScopeGroupPriority( const String & scopeGroupName, LogPriority addPrio );
         ...
         *          Returns zero, if no log scope found.
         **/
        int32_t removeScopeGroupPriority( const String & scopeGroupName, LogPriority remPrio );
    ...
    {
        return getScope( makeScopeId(scopeName) );
    }
    ...
    {
        setScopePriority( scopeId, static_cast<uint32_t>(stringToLogPrio( newPrio )) );
    }

    inline void ScopeController::setScopePriority( const String & scopeName, uint32_t newPrio )
    {
        setScopePriority( makeScopeId( scopeName ), newPrio );
    }

    inline void ScopeController::setScopePriority( const String & scopeName, const String & newPrio )
    {
        setScopePriority( makeScopeId( scopeName ), static_cast<uint32_t>(stringToLogPrio( newPrio )) );
    }

    inline void ScopeController::addScopePriority( uint32_t scopeId, const String & addPrio )
    {
        addScopePriority( scopeId, stringToLogPrio( addPrio ) );
    }

    inline void ScopeController::addScopePriority( const String & scopeName, LogPriority addPrio )
    {
        addScopePriority( makeScopeId( scopeName ), addPrio );
    }

    inline void ScopeController::addScopePriority( const String & scopeName, const String & addPrio )
    {
        addScopePriority( makeScopeId( scopeName ), stringToLogPrio( addPrio ) );
    }

    inline void ScopeController::removeScopePriority( uint32_t scopeId, const String & remPrio )
    {
        removeScopePriority( scopeId, stringToLogPrio( remPrio ) );
    }

    inline void ScopeController::removeScopePriority( const String & scopeName, LogPriority remPrio )
    {
        removeScopePriority( makeScopeId( scopeName ), remPrio );
    }

    inline void ScopeController::removeScopePriority( const String & scopeName, const String & remPrio )
    {
        removeScopePriority( makeScopeId( scopeName ), stringToLogPrio( remPrio ) );
    }

    inline int32_t ScopeController::setScopeGroupPriority( const String & scopeGroupName, const String & newPrio )
    {
        return setScopeGroupPriority( scopeGroupName, static_cast<uint32_t>(stringToLogPrio( newPrio )) );
    }

    inline int32_t ScopeController::addScopeGroupPriority( const String & scopeGroupName, const String & addPrio )
    {
        return addScopeGroupPriority( scopeGroupName, stringToLogPrio( addPrio ) );
    }

    inline int32_t ScopeController::removeScopeGroupPriority( const String & scopeGroupName, const String & remPrio )
    {
        return removeScopeGroupPriority( scopeGroupName, stringToLogPrio( remPrio ) );
    }
