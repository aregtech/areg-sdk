...
namespace
{
    constexpr const uint32_t _logMessageSize{ static_cast<uint32_t>(sizeof(areg::sLogMessage)) };
...
LoggingEventData::LoggingEventData( LoggingEventData::eLoggingAction action, const areg::sLogMessage & logData )
    : mAction       ( action )
