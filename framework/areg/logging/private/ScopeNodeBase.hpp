...
namespace areg
{
    ...
    protected:
         ...
         **/
        ScopeNodeBase( ScopeNodeBase::NodeType nodeType, const areg::String & nodeName, uint32_t prio = static_cast<uint32_t>(areg::LogPriority::PrioNotset) );
     ...
     ************************************************************************/
         ...
         **/
        static areg::String extractNodeName( areg::String & scopeName );
     ...
     ************************************************************************/
         ...
         **/
        virtual const ScopeNodeBase & makeChildNode( areg::String & scopePath, uint32_t prioStates ) const;
         ...
         *          it created new entry or updated the existing.
         **/
        virtual std::pair<ScopeNodeBase &, bool> addChildNode( areg::String & scopePath, uint32_t prioStates );
         ...
         **/
        virtual areg::String makeScopePath( const areg::String & prefix ) const;
         ...
         **/
        virtual areg::String makeConfigString( const areg::String & parent ) const;
         ...
         **/
        virtual uint32_t updateConfigNode(areg::ConfigManager& config, const areg::String & parentPath ) const;
    ...
    public:
         ...
         **/
        inline const areg::String & getNodeName() const;

        /**
         * \brief   Sets node name.
         **/
        inline void setNodeName( const areg::String newName );
         ...
         **/
        uint32_t addChildRecursive( areg::String & scopePath, uint32_t prioStates );
    ...
    inline const areg::String & ScopeNodeBase::getNodeName() const
    {
        return mNodeName;
    }

    inline void ScopeNodeBase::setNodeName( const areg::String newName )
    {
        mNodeName = newName;
    }
