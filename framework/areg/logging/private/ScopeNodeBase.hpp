...
protected:
     ...
     **/
    ScopeNodeBase( ScopeNodeBase::eNode nodeType, const String & nodeName, unsigned int prio = static_cast<unsigned int>(areg::eLogPriority::PrioNotset) );
...
{
    return (mPrioStates & static_cast<uint32_t>(areg::eLogPriority::PrioDebug)) != 0;
}

inline bool ScopeNodeBase::hasPrioInfo() const
{
    return (mPrioStates & static_cast<uint32_t>(areg::eLogPriority::PrioInfo)) != 0;
}

inline bool ScopeNodeBase::hasPrioWarning() const
{
    return (mPrioStates & static_cast<uint32_t>(areg::eLogPriority::PrioWarning)) != 0;
}

inline bool ScopeNodeBase::hasPrioError() const
{
    return (mPrioStates & static_cast<uint32_t>(areg::eLogPriority::PrioError)) != 0;
}

inline bool ScopeNodeBase::hasPrioFatal() const
{
    return (mPrioStates & static_cast<uint32_t>(areg::eLogPriority::PrioFatal)) != 0;
}

inline bool ScopeNodeBase::hasLogsEneabled() const
{
    return (mPrioStates & static_cast<uint32_t>(areg::eLogPriority::PrioLogs)) != 0;
}

inline bool ScopeNodeBase::hasLogScopes() const
{
    return (mPrioStates & static_cast<uint32_t>(areg::eLogPriority::PrioScope)) != 0;
}
