...
/************************************************************************/
     ...
     **/
    virtual void logMessage( const areg::LogEntry & msgLog, areg::OutStream & stream ) const = 0;
...
/************************************************************************/
     ...
     * \param   stream  The streaming object, where the text message should be written.
     **/
    void logMessage( const areg::LogEntry & msgLog, areg::OutStream & stream ) const override;
};
