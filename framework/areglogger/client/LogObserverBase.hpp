...
namespace areglogger
{
     ...
     ************************************************************************/
         ...
         **/
        virtual void onLogInstancesConnect(const std::vector< areg::ConnectedInstance > & instances) = 0;
         ...
         **/
        virtual void onLogInstancesDisconnect(const std::vector< areg::ConnectedInstance > & instances) = 0;
