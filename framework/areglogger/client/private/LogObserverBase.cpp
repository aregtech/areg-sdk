...
void LogObserverBase::getLogInstanceInfos(std::vector< areg::sServiceConnectedInstance>& infos)
{
    LoggerClient::getInstance().getLogInstanceInfos(infos);
}

void LogObserverBase::getLogInstScopes(std::vector<areg::sScopeInfo>& scopes, ITEM_ID instId)
{
