...
public:
     ...
     *                          ID.
     **/
    void notify_service_connection(const areg::EventEnvelope& msgReceived);
     ...
     **/
    void notify_connected_clients(const areg::EventEnvelope& msgReceived);
     ...
     *                          scopes.
     **/
    void notify_log_register_scopes(const areg::EventEnvelope& msgReceived);
     ...
     **/
    void notify_log_update_scopes(const areg::EventEnvelope& msgReceived);
     ...
     **/
    void notify_log_message(const areg::EventEnvelope& msgReceived);
...
private:
     ...
     **/
    void _clients_connected(const areg::EventEnvelope& msgReceived);
     ...
     **/
    void _clients_disconnected(const areg::EventEnvelope& msgReceived);
