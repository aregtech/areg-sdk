...
private:
    ...
    static constexpr ITEM_ID                            TargetID        { areg::COOKIE_LOGGER };

    //!< The type of the service. It is a log collector service.
    static constexpr areg::eRemoteServices   ServiceType     { areg::eRemoteServices::ServiceLogger };

    //!< The connection type. At the moment only TCP/IP
    static constexpr areg::eConnectionTypes  ConnectType     { areg::eConnectionTypes::ConnectTcpip };

    //!< The message source. It is marked as an observer.
    static constexpr areg::eMessageSource          SourceType      { areg::eMessageSource::MessageSourceObserver };
...
public:
     ...
     **/
    inline void getLogInstanceInfos(std::vector< areg::sServiceConnectedInstance>& infos);
     ...
     **/
    inline void getLogInstScopes(std::vector<areg::sScopeInfo>& scopes, ITEM_ID instId);
...
inline void LoggerClient::getLogInstanceInfos(std::vector< areg::sServiceConnectedInstance>& infos)
{
    mLogDatabase.getLogInstanceInfos(infos);
}

inline void LoggerClient::getLogInstScopes(std::vector<areg::sScopeInfo>& scopes, ITEM_ID instId)
{
