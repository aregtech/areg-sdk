 ...
 * \file        observer/app/NELogObserverSettings.hpp
...
#if !defined(IMP_OBSERVER_DLL) && !defined(IMP_OBSERVER_LIB)
    #define     IMP_OBSERVER_DLL
#endif  // !defined(IMP_OBSERVER_DLL) || !defined(IMP_OBSERVER_LIB)
...
namespace NELogObserverSettings
{
     ...
     **/
    constexpr char      LOG_OBSERVER_THREAD_NAME[]  { "_AREG_LOG_OBSERVER_THREAD_" };
