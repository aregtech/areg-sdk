...
int ServiceApplicationBase::serviceMain(aregext::eServiceOption optStartup, const char* argument)
{
    ...
    case aregext::eServiceOption::CMD_Load:     // fall through
    case aregext::eServiceOption::CMD_Console:  // fall through
...
bool ServiceApplicationBase::serviceInitialize(aregext::eServiceOption /*option*/, const char* /*value*/, const char * fileConfig)
{
...
bool ServiceApplicationBase::serviceStart()
{
    ...
    bool result{ false };
    areg::eRemoteServices serviceType = getServiceType();
    areg::eConnectionTypes connectType = getConnectionType();
    if (serviceType != areg::eRemoteServices::ServiceUnknown)
    {
        ...
        {
            result = setState(aregext::eSystemServiceState::ServiceRunning);
        }
        else
        {
...
void ServiceApplicationBase::servicePause()
{
    ...
    setState(aregext::eSystemServiceState::ServicePausing);
    mCommunication.disconnectServiceHost();
    mCommunication.waitToComplete();
    setState(aregext::eSystemServiceState::ServicePaused);
}
...
bool ServiceApplicationBase::serviceContinue()
{
    ...
    bool result = false;
    setState(aregext::eSystemServiceState::ServiceContinuing);
    if (mCommunication.isServiceHostSetup() && mCommunication.connectServiceHost())
    {
        result = true;
        setState(aregext::eSystemServiceState::ServiceRunning);
    }
    else
    {
...
void ServiceApplicationBase::serviceStop()
{
    ...
    setState(aregext::eSystemServiceState::ServiceStopping);
    mCommunication.disconnectServiceHost();
    mCommunication.waitToComplete();
    Application::signalAppQuit();
}
...
bool ServiceApplicationBase::setState(aregext::eSystemServiceState newState)
{
