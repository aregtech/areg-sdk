...
namespace aregext
{
    ...
    public:
         ...
         **/
        ServerReceiveThread( aregext::ConnectionHandler & connectHandler, areg::RemoteMessageHandler& remoteService, aregext::ServerConnection & connection );
        /**
         * \brief   Destructor
         **/
    ...
    private:
         ...
         **/
        aregext::ConnectionHandler& mConnectHandler;
        /**
