...
const OptionParser::sOptionSetup LogCollector::ValidOptions[ ]
{
    ...
    , { "-s", "--service"   , static_cast<int>(eLoggerOptions::CMD_LogService)      , OptionParser::FREESTYLE_DATA  , {}, {}, {} }
...
void LogCollector::printStatus(const String& status)
{
    ...
    if (LogCollector::getInstance().getCurrentOption() == aregext::eServiceOption::CMD_Console)
    {
...
areg::eRemoteServices LogCollector::getServiceType() const
{
    return areg::eRemoteServices::ServiceLogger;
}

areg::eConnectionTypes LogCollector::getConnectionType() const
{
    return areg::eConnectionTypes::ConnectTcpip;
}
...
inline void LogCollector::_enableLocalLogs(ConfigManager& config, bool enable)
{
    ...
    unsigned int prios = enable
                ? static_cast<unsigned int>(areg::eLogPriority::PrioNotset) | static_cast<unsigned int>(areg::eLogPriority::PrioNotset)
