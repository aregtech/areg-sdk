...
public:
     ...
     */
    inline const NEService::MapInstances & getObservers() const;
...
/************************************************************************/
     ...
     **/
    void addInstance(const ITEM_ID & cookie, const NEService::ConnectedInstance & instance ) override;
...
inline const NEService::MapInstances & LogCollectorServerService::getObservers() const
{
    return mObservers;
}
