...
public:
     ...
     **/
    void dispatch_and_forward_logger_message(const RemoteMessage& msgForward);
...
/************************************************************************/
     ...
     **/
    void add_instance(const ITEM_ID & cookie, const NEService::ConnectedInstance & instance ) override;
...
inline const NEService::MapInstances & LogCollectorServerService::observers() const
{
    return mObservers;
}
