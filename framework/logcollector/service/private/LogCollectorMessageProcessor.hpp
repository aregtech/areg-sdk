...
public:
     ...
     **/
    void queryConnectedInstances(const areg::RemoteMessage & msgReceived) const;

    /**
     * \brief   Creates a communication message with the information of connected instances
     *          and sends the notification to the specified observer target. If target is areg::TARGET_ALL
     ...
     **/
    void notifyConnectedInstances(const areg::MapInstances& instances, const ITEM_ID & target = areg::TARGET_ALL) const;
     ...
     * \param   msgReceived     The message to process.
     **/
    void registerScopesAtObserver(const areg::RemoteMessage & msgReceived) const;
     ...
     * \param   msgReceived     The message to process.
     **/
    void updateLogSourceScopes(const areg::RemoteMessage & msgReceived) const;
     ...
     * \param   msgReceived     The message to process.
     **/
    void queryLogSourceScopes(const areg::RemoteMessage & msgReceived) const;
     ...
     * \param   msgReceived     The message to process.
     **/
    void saveLogSourceConfiguration(const areg::RemoteMessage & msgReceived);

    /**
     * \brief   Called to forward the log message to the observer application.
     * \param   msgReceived     The message to process.
     **/
    void logMessage(const areg::RemoteMessage& msgReceived) const;
     ...
     * \param   msgReceived     The message to process.
     **/
    void logSourceScopesUpadated(const areg::RemoteMessage& msgReceived);
     ...
     * \param   msgReceived     The message to process.
     **/
    void logSourceConfigurationSaved(const areg::RemoteMessage& msgReceived);
     ...
     **/
    static bool isLogSource(areg::MessageSource msgSource);
     ...
     **/
    static bool isLogObserver(areg::MessageSource msgSource);
...
private:
     ...
     *          If the target in the remote message is areg::TARGET_ALL, the message is sent to all clients.
     * \param   msgReceived     The remote message received from observer or generated by the Log Collector.
     **/
    inline void _forwardMessageToLogSources(const areg::RemoteMessage& msgReceived) const;

    /**
     * \brief   Forwards specified message to the log observer.
     *          If the target in the remote message is areg::TARGET_ALL, the message is sent to all observers.
     * \param   msgReceived     The remote message received from a client.
     **/
    inline void _forwardMessageToObservers(const areg::RemoteMessage& msgReceived) const;
//////////////////////////////////////////////////////////////////////////
// Member variables
//////////////////////////////////////////////////////////////////////////
private:
