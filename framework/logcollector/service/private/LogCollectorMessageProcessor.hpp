...
public:
     ...
     **/
    void query_connected_instances(const areg::EventEnvelope & msgReceived) const;
     ...
     * \param   msgReceived     The message to process.
     **/
    void register_scopes_at_observer(const areg::EventEnvelope & msgReceived) const;
     ...
     * \param   msgReceived     The message to process.
     **/
    void update_log_source_scopes(const areg::EventEnvelope & msgReceived) const;
     ...
     * \param   msgReceived     The message to process.
     **/
    void query_log_source_scopes(const areg::EventEnvelope & msgReceived) const;
     ...
     * \param   msgReceived     The message to process.
     **/
    void save_log_source_configuration(const areg::EventEnvelope & msgReceived);
     ...
     * \param   msgReceived     The message to process.
     **/
    void log_message(const areg::EventEnvelope& msgReceived) const;
     ...
     * \param   msgReceived     The message to process.
     **/
    void log_source_scopes_updated(const areg::EventEnvelope& msgReceived);
     ...
     * \param   msgReceived     The message to process.
     **/
    void log_source_configuration_saved(const areg::EventEnvelope& msgReceived);
...
private:
     ...
     *                          Collector.
     **/
    inline void _forward_message_to_log_sources(const areg::EventEnvelope& msgReceived) const;
     ...
     **/
    inline void _forward_message_to_observers(const areg::EventEnvelope& msgReceived) const;
//////////////////////////////////////////////////////////////////////////
// Member variables
//////////////////////////////////////////////////////////////////////////
private:
