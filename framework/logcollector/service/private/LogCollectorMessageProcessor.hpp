...
public:
     ...
     **/
    void query_connected_instances(const areg::MessageEnvelope & msgReceived) const;
     ...
     * \param   msgReceived     The message to process.
     **/
    void register_scopes_at_observer(const areg::MessageEnvelope & msgReceived) const;
     ...
     * \param   msgReceived     The message to process.
     **/
    void update_log_source_scopes(const areg::MessageEnvelope & msgReceived) const;
     ...
     * \param   msgReceived     The message to process.
     **/
    void query_log_source_scopes(const areg::MessageEnvelope & msgReceived) const;
     ...
     * \param   msgReceived     The message to process.
     **/
    void save_log_source_configuration(const areg::MessageEnvelope & msgReceived);
     ...
     * \param   msgReceived     The message to process.
     **/
    void log_message(const areg::MessageEnvelope& msgReceived) const;
     ...
     * \param   msgReceived     The message to process.
     **/
    void log_source_scopes_updated(const areg::MessageEnvelope& msgReceived);
...
private:
     ...
     *                          Collector.
     **/
    inline void _forward_message_to_log_sources(const areg::MessageEnvelope& msgReceived) const;
     ...
     **/
    inline void _forward_message_to_observers(const areg::MessageEnvelope& msgReceived) const;
//////////////////////////////////////////////////////////////////////////
// Member variables
//////////////////////////////////////////////////////////////////////////
private:
