...
This file describes the instruction to compile **AREG SDK** and example source codes under _Windows_ platform with the help of _Visual Studio_. The minimum requirement to compile sources is **Visual Studio 10 or higher** version. Open **[areg-sdk.sln](https://github.com/aregtech/areg-sdk/blob/master/areg-sdk.sln)** solution file in **Visual Studio 2012** or in higher version of VS IDE and compile **areg** or all projects. By default, the **AREG** connectivity and communication framework is compiled as _dynamically linked library (areg.dll)_. BY default, all sources are build in **”product/build/xxx”** folders.
