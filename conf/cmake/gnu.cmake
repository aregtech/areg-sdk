...
if (MINGW)
    ...
    if ("${CMAKE_BUILD_TYPE}" MATCHES "Release")
        ...
        list(APPEND AREG_LDFLAGS   -Wl,--gc-sections -Wl,-O1   stdc++   m   pthread   advapi32   psapi   shell32   ws2_32   synchronization)
        set(AREG_LDFLAGS_STR    "-Wl,--gc-sections -Wl,-O1 -lstdc++ -lm -lpthread -ladvapi32 -lpsapi -lshell32 -lws2_32 -lsynchronization")
    else()
        list(APPEND AREG_COMPILER_OPTIONS -O0 -g3)
        list(APPEND AREG_LDFLAGS   stdc++   m   pthread   advapi32   psapi   shell32   ws2_32   dbghelp   synchronization)
        set(AREG_LDFLAGS_STR    "-lstdc++ -lm -lpthread -ladvapi32 -lpsapi -lshell32 -lws2_32 -ldbghelp -lsynchronization")
    endif()
else()
    ...
    if ("${CMAKE_BUILD_TYPE}" MATCHES "Release")
        ...
        if (NOT CYGWIN)
            ...
            if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS 14)
                ...
                message(STATUS "AREG: GCC ${CMAKE_CXX_COMPILER_VERSION} with LTO, speculative devirtualization is switched off")
            endif()
        endif()
    else()
        list(APPEND AREG_COMPILER_OPTIONS -O0 -g3)
