...
macro(macro_find_gtest_package var_include var_library var_found)
    ...
    if (GTest_FOUND)
        ...
        if (EXISTS "${GTEST_LIBRARIES}")
            ...
            set("<<< 1. _gtest_location = ${_gtest_location}")
            if (NOT _gtest_location)
                get_target_property(_gtest_location2 GTest::GTest IMPORTED_LOCATION)
                set("<<< 2. _gtest_location2 = ${_gtest_location2}")
                set(_gtest_location "${_gtest_location2}")
            endif()
        endif()
