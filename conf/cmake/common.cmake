...
message(STATUS "=======================================================================================")
message(STATUS "AREG: >>> CMAKE_SOURCE_DIR = \'${CMAKE_SOURCE_DIR}\'")
message(STATUS "AREG: >>> Build ...........: \'${CMAKE_SYSTEM_NAME}\' system, \'${AREG_BITNESS}\'-bit platform, '${AREG_PROCESSOR}' CPU, build type \'${CMAKE_BUILD_TYPE}\'")
