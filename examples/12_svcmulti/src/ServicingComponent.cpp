...
DEF_LOG_SCOPE(examples_12_svcmulti_ServicingComponent, startup_service_interface);
DEF_LOG_SCOPE(examples_12_svcmulti_ServicingComponent, shutdown_service_intrface);
DEF_LOG_SCOPE(examples_12_svcmulti_ServicingComponent, process_timer);
...
{
    LOG_SCOPE( examples_12_svcmulti_ServicingComponent, startup_service_interface );
...
{
    LOG_SCOPE( examples_12_svcmulti_ServicingComponent, shutdown_service_intrface );
...
void ServicingComponent::process_timer([[maybe_unused]] areg::Timer & timer)
{
    LOG_SCOPE( examples_12_svcmulti_ServicingComponent, process_timer );
