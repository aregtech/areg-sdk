...
bool PublicServiceComponent::clientConnected(const ProxyAddress & client, areg::eServiceConnection status)
{
    ...
    {
        if (status == areg::eServiceConnection::ServiceConnected)
        {
