#ifndef PUBMESH_COMMON_SRC_PUBMESHDEFS_HPP
#define PUBMESH_COMMON_SRC_PUBMESHDEFS_HPP

/************************************************************************
 * \file        common/src/PubMeshDefs.hpp
...
namespace mesh
{
    ...
    //!< Third remote service that is implemented in "16_secondipcmix" process.
