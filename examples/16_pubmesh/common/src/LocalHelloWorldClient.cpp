...
LocalHelloWorldClient::LocalHelloWorldClient( const areg::DependencyEntry & dependency, Component & owner, unsigned int timeout)
...
bool LocalHelloWorldClient::serviceConnected( areg::eServiceConnection status, ProxyBase & proxy)
{
