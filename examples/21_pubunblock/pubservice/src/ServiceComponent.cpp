...
DEF_LOG_SCOPE( examples_21_pubservice_ServiceComponent_startupServiceInterface );
DEF_LOG_SCOPE( examples_21_pubservice_ServiceComponent_requestIdentifier );
DEF_LOG_SCOPE( examples_21_pubservice_ServiceComponent_requestHelloUblock );
DEF_LOG_SCOPE( examples_21_pubservice_ServiceComponent_processTimer );
...
{
    LOG_SCOPE( examples_21_pubservice_ServiceComponent_startupServiceInterface );
...
{
    LOG_SCOPE( examples_21_pubservice_ServiceComponent_requestIdentifier );
...
{
    LOG_SCOPE( examples_21_pubservice_ServiceComponent_requestHelloUblock );
...
{
    LOG_SCOPE( examples_21_pubservice_ServiceComponent_processTimer );
