...
This project demonstrates the use of custom events used in multithreading communication. It as well demonstrates 
how to dynamically create a model  during run-time that can be loaded and unloaded.
...
This project creates a dynamic model. There can be several instances of application started. There can be multiple 
instances of applications run on the same or different machines. The traffic light has symbolic directions 
South-North and East-West. Each application should select the role:
