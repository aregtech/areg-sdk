...
protected:
     ...
     **/
    virtual void onTrafficSouthNorthUpdate( const TrafficController::sTrafficLight & TrafficSouthNorth, areg::eDataStateType state ) override;
     ...
     * \param   state           The data validation flag.
     **/
    virtual void onTrafficEastWestUpdate( const TrafficController::sTrafficLight & TrafficEastWest, areg::eDataStateType state ) override;
