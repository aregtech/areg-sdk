//////////////////////////////////////////////////////////////////////////
// Begin generate generated/private/HelloWatchdogClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2023
 *
 * Generated at     22.07.2023  03:08:55 GMT+02:00
 *                  Create by AREG SDK code generator tool from source HelloWatchdog.
 *
 * \file            generated/HelloWatchdogClientBase.hpp
 ...
 * Include files
 ************************************************************************/
#include "generated/HelloWatchdogClientBase.hpp"
...
DEF_TRACE_SCOPE(generated_HelloWatchdogClientBase_serviceConnected);
bool HelloWatchdogClientBase::serviceConnected( NEService::eNetConnection status, ProxyBase & proxy )
{
    TRACE_SCOPE(generated_HelloWatchdogClientBase_serviceConnected);

    bool result { false };
    if(mProxy == &proxy)
    {
        mIsConnected= NEService::isNeConnected(status);
        result      = true;
...
DEF_TRACE_SCOPE(generated_HelloWatchdogClientBase_processNotificationEvent);
void HelloWatchdogClientBase::processNotificationEvent( NotificationEvent & eventElem )
{
    ...
    case NEService::eResultType::DataInvalid:
         ...
         ************************************************************************/
            ...
            default:
                {
                    TRACE_SCOPE(generated_HelloWatchdogClientBase_processNotificationEvent);
 ...
 ************************************************************************/
DEF_TRACE_SCOPE(generated_HelloWatchdogClientBase_invalidResponse);
void HelloWatchdogClientBase::invalidResponse( NEHelloWatchdog::eMessageIDs InvalidRespId )
{
    TRACE_SCOPE(generated_HelloWatchdogClientBase_invalidResponse);
...
DEF_TRACE_SCOPE(generated_HelloWatchdogClientBase_invalidRequest);
void HelloWatchdogClientBase::invalidRequest( NEHelloWatchdog::eMessageIDs InvalidReqId )
{
    TRACE_SCOPE(generated_HelloWatchdogClientBase_invalidRequest);
...
DEF_TRACE_SCOPE(generated_HelloWatchdogClientBase_requestFailed);
void HelloWatchdogClientBase::requestFailed( NEHelloWatchdog::eMessageIDs FailureMsgId, NEService::eResultType FailureReason )
{
    TRACE_SCOPE(generated_HelloWatchdogClientBase_requestFailed);
...
DEF_TRACE_SCOPE(generated_HelloWatchdogClientBase_onServiceStateUpdate);
void HelloWatchdogClientBase::onServiceStateUpdate( NEHelloWatchdog::eState /* ServiceState */, NEService::eDataStateType /* state */ )
{
    TRACE_SCOPE(generated_HelloWatchdogClientBase_onServiceStateUpdate);
...
DEF_TRACE_SCOPE(generated_HelloWatchdogClientBase_requestStartSleepFailed);
void HelloWatchdogClientBase::requestStartSleepFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(generated_HelloWatchdogClientBase_requestStartSleepFailed);
...
DEF_TRACE_SCOPE(generated_HelloWatchdogClientBase_requestStopServiceFailed);
void HelloWatchdogClientBase::requestStopServiceFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(generated_HelloWatchdogClientBase_requestStopServiceFailed);
...
DEF_TRACE_SCOPE(generated_HelloWatchdogClientBase_requestShutdownServiceFailed);
void HelloWatchdogClientBase::requestShutdownServiceFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(generated_HelloWatchdogClientBase_requestShutdownServiceFailed);
...
DEF_TRACE_SCOPE(generated_HelloWatchdogClientBase_responseStartSleep);
void HelloWatchdogClientBase::responseStartSleep( unsigned int /* timeoutSleep */ )
{
    TRACE_SCOPE(generated_HelloWatchdogClientBase_responseStartSleep);
...
//////////////////////////////////////////////////////////////////////////
// End generate generated/private/HelloWatchdogClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
