//////////////////////////////////////////////////////////////////////////
// Begin generate generated/private/HelloWatchdogStub.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2023
 *
 ...
 *
 * \file            generated/HelloWatchdogStub.hpp
 ...
 * Includes
 ************************************************************************/
#include "generated/HelloWatchdogStub.hpp"
#include "generated/private/HelloWatchdogEvents.hpp"
...
DEF_TRACE_SCOPE(generated_HelloWatchdogStub_startupServiceInterface);
void HelloWatchdogStub::startupServiceInterface( Component & holder )
{
    TRACE_SCOPE(generated_HelloWatchdogStub_startupServiceInterface);
...
DEF_TRACE_SCOPE(generated_HelloWatchdogStub_shutdownServiceIntrface);
void HelloWatchdogStub::shutdownServiceIntrface( Component & holder )
{
    TRACE_SCOPE(generated_HelloWatchdogStub_shutdownServiceIntrface);
...
DEF_TRACE_SCOPE(generated_HelloWatchdogStub_sendNotification);
void HelloWatchdogStub::sendNotification( unsigned int msgId )
{
    ...
    default:
        {
            TRACE_SCOPE(generated_HelloWatchdogStub_sendNotification);
...
DEF_TRACE_SCOPE(generated_HelloWatchdogStub_errorRequest);
 ...
 ************************************************************************/
    ...
    {
        TRACE_SCOPE(generated_HelloWatchdogStub_errorRequest);
...
DEF_TRACE_SCOPE(generated_HelloWatchdogStub_processRequestEvent);
void HelloWatchdogStub::processRequestEvent( ServiceRequestEvent & eventElem )
{
    ...
    if ( (reqEvent != nullptr) && (reqEvent->getRequestType() == NEService::eRequestType::CallFunction) )
    {
        ...
        default:
            {
                TRACE_SCOPE(generated_HelloWatchdogStub_processRequestEvent);
...
DEF_TRACE_SCOPE(generated_HelloWatchdogStub_processAttributeEvent);
void HelloWatchdogStub::processAttributeEvent( ServiceRequestEvent & eventElem )
{
    ...
    else
    {
        ...
        else if (reqType == NEService::eRequestType::StartNotify)
        {
            ...
            {
                TRACE_SCOPE(generated_HelloWatchdogStub_processAttributeEvent);
...
//////////////////////////////////////////////////////////////////////////
// End generate generated/private/HelloWatchdogStub.cpp file
//////////////////////////////////////////////////////////////////////////
