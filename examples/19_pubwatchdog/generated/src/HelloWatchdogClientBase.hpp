 ...
 ************************************************************************/
     ...
     **/
    inline const SequenceNumber &  requestStartSleep( unsigned int timeoutSleep );
    /**
...
inline const SequenceNumber &  HelloWatchdogClientBase::requestStartSleep( unsigned int timeoutSleep )
{
    ASSERT(mProxy != nullptr);
