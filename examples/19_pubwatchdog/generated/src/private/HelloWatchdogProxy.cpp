 ...
 * (c) copyright    2023
 *
 * Generated at     15.11.2023  14:52:11 GMT+01:00
...
RemoteResponseEvent * HelloWatchdogProxy::createRemoteRequestFailedEvent(const ProxyAddress & addrProxy, unsigned int msgId, NEService::eResultType reason, const SequenceNumber &  seqNr) const
{
...
{
    ProxyBase::ServiceAvailableEvent* event = static_cast<ProxyBase::ServiceAvailableEvent *>( DEBUG_NEW HelloWatchdogProxy::HelloWatchdogServiceAvailableEvent(consumer) );
    if (event != nullptr)
    {
...
const SequenceNumber &  HelloWatchdogProxy::requestStartSleep( IENotificationEventConsumer & caller, unsigned int timeoutSleep )
{
