...
int main()
{
    ...
    do 
    {
        unsigned int timeout{ areg::WAIT_10_SECONDS };
        ...
        unsigned int duration = static_cast<unsigned int>(Application::findModel( _modelName ).getAliveDuration( ) / areg::DURATION_1_MILLI);
