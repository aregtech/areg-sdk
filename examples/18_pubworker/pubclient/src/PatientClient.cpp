...
bool PatientClient::serviceConnected( areg::eServiceConnection status, ProxyBase & proxy)
{
...
void PatientClient::onPatientUpdate(const PatientInformation::PatientInfo & Patient, areg::eDataStateType state)
{
