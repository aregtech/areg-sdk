...
int main()
{
    ...
    console.waitForInput( [&]( const String cmd ) -> bool
        {
            bool result{ false };
            if ( cmd.compare( directions[0], false ) == areg::eCompare::Equal )
            {
            ...
            else if ( cmd.compare( directions[1], false ) == areg::eCompare::Equal )
            {
            ...
            else if ( cmd.compare( directions[2], false ) == areg::eCompare::Equal )
            {
