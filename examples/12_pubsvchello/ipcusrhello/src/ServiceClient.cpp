/************************************************************************
 * \file        ipcusrhello/src/ServiceClient.cpp
 ...
 * Include files.
 ************************************************************************/
#include "ipcusrhello/src/ServiceClient.hpp"
#include "areg/trace/GETrace.h"
#include "areg/component/ComponentThread.hpp"
#include "areg/appbase/Application.hpp"

DEF_TRACE_SCOPE(examples_12_ipcusrhello_ipcusrhello_ServiceClient_serviceConnected);
DEF_TRACE_SCOPE(examples_12_ipcusrhello_ipcusrhello_ServiceClient_broadcastServiceUnavailable);
DEF_TRACE_SCOPE(examples_12_ipcusrhello_ipcusrhello_ServiceClient_responseHelloWorld);
DEF_TRACE_SCOPE(examples_12_ipcusrhello_ipcusrhello_ServiceClient_requestHelloWorldFailed);
DEF_TRACE_SCOPE(examples_12_ipcusrhello_ipcusrhello_ServiceClient_requestClientShutdownFailed);
DEF_TRACE_SCOPE(examples_12_ipcusrhello_ipcusrhello_ServiceClient_processTimer);
DEF_TRACE_SCOPE(examples_12_ipcusrhello_ipcusrhello_ServiceClient_ServiceClient);
...
ServiceClient::ServiceClient(const NERegistry::ComponentEntry & entry, ComponentThread & owner)
    ...
    , mID                   ( 0 )
{
    TRACE_SCOPE(examples_12_ipcusrhello_ipcusrhello_ServiceClient_ServiceClient);
...
{
    TRACE_SCOPE(examples_12_ipcusrhello_ipcusrhello_ServiceClient_serviceConnected);
...
{
    TRACE_SCOPE(examples_12_ipcusrhello_ipcusrhello_ServiceClient_responseHelloWorld);
...
{
    TRACE_SCOPE(examples_12_ipcusrhello_ipcusrhello_ServiceClient_broadcastServiceUnavailable);
...
{
    TRACE_SCOPE(examples_12_ipcusrhello_ipcusrhello_ServiceClient_processTimer);
    ASSERT(&timer == &mTimer);
...
void ServiceClient::requestHelloWorldFailed(NEService::eResultType FailureReason)
{
    ...
    TRACE_SCOPE(examples_12_ipcusrhello_ipcusrhello_ServiceClient_requestHelloWorldFailed);
...
{
    // make error handling here.
    TRACE_SCOPE(examples_12_ipcusrhello_ipcusrhello_ServiceClient_requestClientShutdownFailed);
