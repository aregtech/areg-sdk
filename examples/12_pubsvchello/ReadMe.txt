...
This project contains instances of public service, which is discoverable in the network. The connected clients 
should specify the name of service they wait and as soon as the service is available in the network, the clients get 
notification and start triggering requests.
