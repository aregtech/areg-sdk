/************************************************************************
 * \file        ipcsvchello/src/ServicingComponent.cpp
...
DEF_TRACE_SCOPE(examples_12_ipcsvchello_ipcsvchello_ServicingComponent_startupServiceInterface);
DEF_TRACE_SCOPE(examples_12_ipcsvchello_ipcsvchello_ServicingComponent_requestHelloWorld);
DEF_TRACE_SCOPE(examples_12_ipcsvchello_ipcsvchello_ServicingComponent_requestClientShutdown);
...
{
    TRACE_SCOPE(examples_12_ipcsvchello_ipcsvchello_ServicingComponent_startupServiceInterface);
...
{
    TRACE_SCOPE(examples_12_ipcsvchello_ipcsvchello_ServicingComponent_requestHelloWorld);
...
{
    TRACE_SCOPE(examples_12_ipcsvchello_ipcsvchello_ServicingComponent_requestClientShutdown);
