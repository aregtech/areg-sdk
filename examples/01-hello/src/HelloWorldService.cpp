...
const unsigned int CESystemStub::GetNumberOfRequests( void ) const
{
    return NESystem::NumberofRequests;
}

const unsigned int CESystemStub::GetNumberOfResponses( void ) const
{
    return NESystem::NumberofResponses;
}

const unsigned int CESystemStub::GetNumberOfAttributes( void ) const
{
...
CEResponseEvent * CESystemStub::CreateResponseEvent( const CEProxyAddress & proxy, const unsigned int msgId, const NEService::eResultType result, const CEEventDataStream & data ) const
{
...
void CESystemStub::SendNotification( const unsigned int msgId )
{
...
void CESystemStub::ErrorRequest( const unsigned int msgId, const bool msgCancel )
{
