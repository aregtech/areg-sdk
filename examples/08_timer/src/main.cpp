...
{
    static constexpr unsigned int TIMEOUT_ONE_TIME{ areg::TIMEOUT_1_MS * 500 }; //!< The timeout in milliseconds of one time timer
    static constexpr unsigned int TIMEOUT_PERIODIC_TIME{ areg::TIMEOUT_1_MS * 80 }; //!< The timeout in milliseconds of periodic timer
    static constexpr unsigned int TIMEOUT_CONTINUOUS_TIME{ areg::TIMEOUT_1_MS * 50 }; //!< The timeout in milliseconds of continues timer
...
namespace
{
    constexpr unsigned int TIMEOUT_APPLICATION = areg::TIMEOUT_1_SEC * 5;
