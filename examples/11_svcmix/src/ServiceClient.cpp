...
DEF_TRACE_SCOPE(examples_11_svcmix_ServiceClient_serviceConnected);
DEF_TRACE_SCOPE(examples_11_svcmix_ServiceClient_onConnectedClientsUpdate);
DEF_TRACE_SCOPE(examples_11_svcmix_ServiceClient_onRemainOutputUpdate);
DEF_TRACE_SCOPE(examples_11_svcmix_ServiceClient_broadcastHelloClients);
DEF_TRACE_SCOPE(examples_11_svcmix_ServiceClient_broadcastServiceUnavailable);
DEF_TRACE_SCOPE(examples_11_svcmix_ServiceClient_responseHelloWorld);
DEF_TRACE_SCOPE(examples_11_svcmix_ServiceClient_requestHelloWorldFailed);
DEF_TRACE_SCOPE(examples_11_svcmix_ServiceClient_requestClientShutdownFailed);
DEF_TRACE_SCOPE(examples_11_svcmix_ServiceClient_processTimer);
DEF_TRACE_SCOPE(examples_11_svcmix_ServiceClient_ServiceClient);
...
ServiceClient::ServiceClient(const String & roleName, Component & owner)
    ...
    , mID                   ( 0 )
{
    TRACE_SCOPE(examples_11_svcmix_ServiceClient_ServiceClient);
...
{
    TRACE_SCOPE(examples_11_svcmix_ServiceClient_serviceConnected);
...
{
    TRACE_SCOPE(examples_11_svcmix_ServiceClient_broadcastHelloClients);
...
{
    TRACE_SCOPE(examples_11_svcmix_ServiceClient_broadcastServiceUnavailable);
...
{
    TRACE_SCOPE(examples_11_svcmix_ServiceClient_requestHelloWorldFailed);
...
{
    TRACE_SCOPE(examples_11_svcmix_ServiceClient_requestClientShutdownFailed);
...
{
    TRACE_SCOPE(examples_11_svcmix_ServiceClient_processTimer);
    ASSERT(&timer == &mTimer);
