//////////////////////////////////////////////////////////////////////////
// Begin generate generated/src/private/LargeDataProxy.hpp file
//////////////////////////////////////////////////////////////////////////
#ifndef  GENERATED_SRC_PRIVATE_LARGEDATAPROXY_HPP
#define  GENERATED_SRC_PRIVATE_LARGEDATAPROXY_HPP

/************************************************************************
 * (c) copyright    2023
 *
 * Generated at     15.11.2023  14:52:14 GMT+01:00
...
//////////////////////////////////////////////////////////////////////////
// LargeDataProxy class declaration Begin
//////////////////////////////////////////////////////////////////////////
/**
 * \brief       LargeData Service Interface proxy class.
...
private:
     ...
     **/
    class LargeDataServiceAvailableEvent : public ProxyBase::ServiceAvailableEvent
    {
    //////////////////////////////////////////////////////////////////////////
    // Runtime internals
    //////////////////////////////////////////////////////////////////////////
        DECLARE_RUNTIME_EVENT(LargeDataProxy::LargeDataServiceAvailableEvent)
    ...
    public:
         ...
         **/
        explicit LargeDataServiceAvailableEvent( IENotificationEventConsumer & consumer );
        /**
         * \brief   Destructor.
         **/
        virtual ~LargeDataServiceAvailableEvent( void ) = default;
    //////////////////////////////////////////////////////////////////////////
    // Forbidden calls
    //////////////////////////////////////////////////////////////////////////
    private:
        LargeDataServiceAvailableEvent( void ) = delete;
        DECLARE_NOCOPY_NOMOVE( LargeDataServiceAvailableEvent );
    };
//////////////////////////////////////////////////////////////////////////
...
protected:
     ...
     **/
    static LargeDataProxy * createProxy( const String & roleName, IEProxyListener & connectListener, DispatcherThread & ownerThread );
     ...
     * \return  Returns pointer to instantiated proxy object.
     **/
    static LargeDataProxy * createProxy( const String & roleName, IEProxyListener & connectListener, const String & ownerThread = String::EmptyString );
...
protected:
     ...
     *                      If nullptr, current dispatching thread is used to dispatch messages.
     **/
    explicit LargeDataProxy( const String & roleName, DispatcherThread * ownerThread = nullptr );
    /**
     * \brief   Destructor
     **/
    virtual ~LargeDataProxy( void ) = default;
...
public:
     ...
     **/
    inline void setNotification( NELargeData::eMessageIDs notifyId, IENotificationEventConsumer & listener, bool notifyAlways = false );
    /**
     * \brief   Clears listener entries of specified Notification Event consumer
     * \param   msgId       The Notification Message ID
     * \param   consumer    The pointer of Notification Event Consumer.
     **/
    inline void clearNotification( NELargeData::eMessageIDs notifyId, IENotificationEventConsumer & listener );
    /**
 ...
 ************************************************************************/
     ...
     **/
    void updateData( LargeDataResponseEvent & eventElem, NELargeData::eMessageIDs respId );
    /**
     ...
     **/
    void processResponse( LargeDataResponseEvent & evenElem );

    /**
     * \brief   returns reference LargeDataProxy object
     **/
    inline LargeDataProxy & self( void );
...
//////////////////////////////////////////////////////////////////////////
private:
    LargeDataProxy( void ) = delete;
    DECLARE_NOCOPY_NOMOVE( LargeDataProxy );
};

//////////////////////////////////////////////////////////////////////////
// LargeDataProxy class declaration End
//////////////////////////////////////////////////////////////////////////

//////////////////////////////////////////////////////////////////////////
// LargeDataProxy class inline functions implementation
//////////////////////////////////////////////////////////////////////////
...
inline void LargeDataProxy::setNotification( NELargeData::eMessageIDs notifyId, IENotificationEventConsumer & listener, bool notifyAlways /* = false */ )
{
    ProxyBase::setNotification(static_cast<unsigned int>(notifyId), &listener, notifyAlways);
}

inline void LargeDataProxy::clearNotification( NELargeData::eMessageIDs notifyId, IENotificationEventConsumer & listener )
{
    ProxyBase::clearNotification(static_cast<unsigned int>(notifyId), &listener);
}

inline void LargeDataProxy::clearAllNotifications( IENotificationEventConsumer & listener )
{
...
//////////////////////////////////////////////////////////////////////////
// End generate generated/src/private/LargeDataProxy.hpp file
//////////////////////////////////////////////////////////////////////////
