...
protected:
     ...
     * \return  Returns pointer to instantiated proxy object.
     **/
    static LargeDataProxy * createProxy( const String & roleName, IEProxyListener & connectListener, const String & ownerThread = String::getEmptyString() );
