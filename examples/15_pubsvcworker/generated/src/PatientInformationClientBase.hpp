 ...
 * \brief           This is an automatic generated code of PatientInformation Service Interface Client base class declaration.
 ************************************************************************/
...
protected:
     ...
     **/
    PatientInformationClientBase( const char* roleName, const char * ownerThread = static_cast<const char *>(NULL) );
...
//////////////////////////////////////////////////////////////////////////
private:
    PatientInformationClientBase( void );
    PatientInformationClientBase( const PatientInformationClientBase & /* src */ );
    const PatientInformationClientBase & operator = ( const PatientInformationClientBase & /* src */ );
};
...
{
    PatientInformationClientBase::notifyOn( NEPatientInformation::MSG_ID_Patient, notify, false );
}
