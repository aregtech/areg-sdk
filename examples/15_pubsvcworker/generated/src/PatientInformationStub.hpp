 ...
 * \brief           This is an automatic generated code of PatientInformation Service Interface Stub class declaration.
 ************************************************************************/
...
protected:
     ...
     **/
    PatientInformationStub( Component & masterComp );
    /**
     * \brief   Destructor.
     **/
    virtual ~PatientInformationStub( void );
...
//////////////////////////////////////////////////////////////////////////
private:
    PatientInformationStub( void );
    PatientInformationStub( const PatientInformationStub & /* src */ );
    const PatientInformationStub & operator = ( const PatientInformationStub & /* src */ );
};
...
{
    return (mPatientState  == NEService::DATA_OK);
}

inline void PatientInformationStub::invalidatePatient( void )
{
    errorRequest( static_cast<unsigned int>(NEPatientInformation::MSG_ID_Patient), false );
}
