 ...
 * \brief           This is an automatic generated code of PatientInformation Service Interface Event classes declaration.
 ************************************************************************/
...
public:
     ...
     * \brief   Destructor.
     **/
    virtual ~PatientInformationRequestEvent( void );

//////////////////////////////////////////////////////////////////////////
// Forbidden calls
//////////////////////////////////////////////////////////////////////////
private:
    PatientInformationRequestEvent( void );
    PatientInformationRequestEvent( const PatientInformationRequestEvent & /* src */ );
    const PatientInformationRequestEvent & operator = ( const PatientInformationRequestEvent & /* src */ );
};
...
public:
     ...
     * \brief   Destructor.
     **/
    virtual ~PatientInformationNotifyRequestEvent( void );

//////////////////////////////////////////////////////////////////////////
// Forbidden calls
//////////////////////////////////////////////////////////////////////////
private:
    PatientInformationNotifyRequestEvent( void );
    PatientInformationNotifyRequestEvent( const PatientInformationNotifyRequestEvent & /* src */ );
    const PatientInformationNotifyRequestEvent & operator = ( const PatientInformationNotifyRequestEvent & /* src */ );
};
...
public:
     ...
     * \brief   Destructor
     **/
    virtual ~PatientInformationResponseEvent( void );
...
//////////////////////////////////////////////////////////////////////////
private:
    PatientInformationResponseEvent( void );
    PatientInformationResponseEvent( const PatientInformationResponseEvent & /* src */ );
    const PatientInformationResponseEvent & operator = ( const PatientInformationResponseEvent & /* src */ );
};
...
public:
     ...
     **/
    PatientInformationNotificationEvent( const NotificationEventData & data );

protected:
    /**
     * \brief   Destructor. Protected
     **/
    virtual ~PatientInformationNotificationEvent( void );
    
//////////////////////////////////////////////////////////////////////////
// Forbidden calls
//////////////////////////////////////////////////////////////////////////
private:
    PatientInformationNotificationEvent( void );
    PatientInformationNotificationEvent( const PatientInformationNotificationEvent & /* src */ );
    const PatientInformationNotificationEvent & operator = ( const PatientInformationNotificationEvent & /* src */ );
};
