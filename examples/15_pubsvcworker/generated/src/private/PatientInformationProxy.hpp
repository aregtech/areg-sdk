...
//////////////////////////////////////////////////////////////////////////
#ifndef  GENERATED_SRC_PRIVATE_PATIENTINFORMATIONPROXY_HPP
#define  GENERATED_SRC_PRIVATE_PATIENTINFORMATIONPROXY_HPP
/************************************************************************
 * (c) copyright    2021
 ...
 * \brief           This is an automatic generated code of PatientInformation Service Interface Proxy class declaration.
 ************************************************************************/
...
private:
    ...
    public:
         ...
         **/
        PatientInformationServiceAvailableEvent( IENotificationEventConsumer & consumer );
        /**
         * \brief   Destructor
         **/
        virtual ~PatientInformationServiceAvailableEvent( void );
    //////////////////////////////////////////////////////////////////////////
    // Forbidden calls
    //////////////////////////////////////////////////////////////////////////
    private:
        PatientInformationServiceAvailableEvent( void );
        PatientInformationServiceAvailableEvent( const PatientInformationServiceAvailableEvent & /*src*/ );
        const PatientInformationServiceAvailableEvent & operator = ( const PatientInformationServiceAvailableEvent & /*src*/ );
    };
//////////////////////////////////////////////////////////////////////////
...
public:
     ...
     * \return  Returns pointer to instantiated proxy object.
     **/
    static PatientInformationProxy * createProxy( const char * roleName, IEProxyListener & connectListener, const char * ownerThread = static_cast<const char *>(NULL) );
...
protected:
     ...
     *                      If NULL, current dispatching thread is used to dispatch messages.
     **/
    PatientInformationProxy( const char * roleName, DispatcherThread * ownerThread = static_cast<DispatcherThread *>(NULL) );
    /**
     * \brief   Destructor
     **/
...
{
    return (getProxyData().getAttributeState(NEPatientInformation::MSG_ID_Patient) == NEService::DATA_OK);
}

inline const NEPatientInformation::PatientInfo & PatientInformationProxy::getPatient( NEService::eDataStateType & state ) const
{
    state = getProxyData().getAttributeState(NEPatientInformation::MSG_ID_Patient);
    return mPatient;
}

#endif   // GENERATED_SRC_PRIVATE_PATIENTINFORMATIONPROXY_HPP
