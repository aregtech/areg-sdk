...
DEF_LOG_SCOPE(examples_08_service_ServicingComponent_startupServiceInterface);
DEF_LOG_SCOPE(examples_08_service_ServicingComponent_shutdownServiceIntrface);
DEF_LOG_SCOPE(examples_08_service_ServicingComponent_processTimer);
...
{
    LOG_SCOPE(examples_08_service_ServicingComponent_startupServiceInterface);
...
{
    LOG_SCOPE(examples_08_service_ServicingComponent_shutdownServiceIntrface);
...
{
    LOG_SCOPE(examples_08_service_ServicingComponent_processTimer);
