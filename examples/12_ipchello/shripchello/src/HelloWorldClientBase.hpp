//////////////////////////////////////////////////////////////////////////
// Begin generate shripchello/src/HelloWorldClientBase.hpp file
//////////////////////////////////////////////////////////////////////////
#ifndef  SHRIPCHELLO_SRC_HELLOWORLDCLIENTBASE_HPP
#define  SHRIPCHELLO_SRC_HELLOWORLDCLIENTBASE_HPP
/************************************************************************
 * (c) copyright    2021
...
/************************************************************************
 * \file            shripchello/src/HelloWorldClientBase.hpp
 * \ingroup         HelloWorld Service Interface
 * \brief           This is an automatic generated code of HelloWorld Service Interface Client base class declaration.
 ************************************************************************/
...
#include "shripchello/src/private/HelloWorldProxy.hpp"
...
protected:
     ...
     **/
    HelloWorldClientBase( const char* roleName, const char * ownerThread = static_cast<const char *>(NULL) );
...
/************************************************************************/
    ...
    HelloWorldClientBase & self( void );

//////////////////////////////////////////////////////////////////////////
// Forbidden calls
//////////////////////////////////////////////////////////////////////////
private:
    HelloWorldClientBase( void );
    HelloWorldClientBase( const HelloWorldClientBase & /* src */ );
    const HelloWorldClientBase & operator = ( const HelloWorldClientBase & /* src */ );
};
...
{
    notifyOn( NEHelloWorld::MSG_ID_ConnectedClients, notify, false );
}
...
{
    notifyOn( NEHelloWorld::MSG_ID_RemainOutput, notify, false );
}
...
{
    notifyOn(NEHelloWorld::MSG_ID_responseHelloWorld, notify, false);
}
...
{
    notifyOn(NEHelloWorld::MSG_ID_broadcastHelloClients, notify, false);
}

inline void HelloWorldClientBase::notifyOnBroadcastServiceUnavailable( bool notify /* = true */ )
{
    notifyOn(NEHelloWorld::MSG_ID_broadcastServiceUnavailable, notify, false);
}
...
#endif   // SHRIPCHELLO_SRC_HELLOWORLDCLIENTBASE_HPP

//////////////////////////////////////////////////////////////////////////
// End generate shripchello/src/HelloWorldClientBase.hpp file
//////////////////////////////////////////////////////////////////////////
