//////////////////////////////////////////////////////////////////////////
// Begin generate shripchello/src/private/HelloWorldProxy.hpp file
//////////////////////////////////////////////////////////////////////////
#ifndef  SHRIPCHELLO_SRC_PRIVATE_HELLOWORLDPROXY_HPP
#define  SHRIPCHELLO_SRC_PRIVATE_HELLOWORLDPROXY_HPP
/************************************************************************
 * (c) copyright    2021
...
/************************************************************************
 * \file            shripchello/src/private/HelloWorldProxy.hpp
 * \ingroup         HelloWorld Service Interface
 * \brief           This is an automatic generated code of HelloWorld Service Interface Proxy class declaration.
 ************************************************************************/
...
private:
    ...
    public:
         ...
         **/
        HelloWorldServiceAvailableEvent( IENotificationEventConsumer & consumer );
        /**
         * \brief   Destructor
         **/
        virtual ~HelloWorldServiceAvailableEvent( void );
    //////////////////////////////////////////////////////////////////////////
    // Forbidden calls
    //////////////////////////////////////////////////////////////////////////
    private:
        HelloWorldServiceAvailableEvent( void );
        HelloWorldServiceAvailableEvent( const HelloWorldServiceAvailableEvent & /*src*/ );
        const HelloWorldServiceAvailableEvent & operator = ( const HelloWorldServiceAvailableEvent & /*src*/ );
    };
//////////////////////////////////////////////////////////////////////////
...
public:
     ...
     **/
    static HelloWorldProxy * createProxy( const char * roleName, IEProxyListener & connectListener, DispatcherThread & ownerThread );
     ...
     * \return  Returns pointer to instantiated proxy object.
     **/
    static HelloWorldProxy * createProxy( const char * roleName, IEProxyListener & connectListener, const char * ownerThread = static_cast<const char *>(NULL) );
...
protected:
     ...
     *                      If NULL, current dispatching thread is used to dispatch messages.
     **/
    HelloWorldProxy( const char * roleName, DispatcherThread * ownerThread = static_cast<DispatcherThread *>(NULL) );
    /**
     * \brief   Destructor
     **/
...
{
    return (getProxyData().getAttributeState(NEHelloWorld::MSG_ID_ConnectedClients) == NEService::DATA_OK);
}

inline const NEHelloWorld::ConnectionList & HelloWorldProxy::getConnectedClients( NEService::eDataStateType & state ) const
{
    state = getProxyData().getAttributeState(NEHelloWorld::MSG_ID_ConnectedClients);
    return mConnectedClients;
}

inline bool HelloWorldProxy::isRemainOutputValid( void ) const
{
    return (getProxyData().getAttributeState(NEHelloWorld::MSG_ID_RemainOutput) == NEService::DATA_OK);
}

inline short HelloWorldProxy::getRemainOutput( NEService::eDataStateType & state ) const
{
    state = getProxyData().getAttributeState(NEHelloWorld::MSG_ID_RemainOutput);
...
#endif   // SHRIPCHELLO_SRC_PRIVATE_HELLOWORLDPROXY_HPP

//////////////////////////////////////////////////////////////////////////
// End generate shripchello/src/private/HelloWorldProxy.hpp file
//////////////////////////////////////////////////////////////////////////
