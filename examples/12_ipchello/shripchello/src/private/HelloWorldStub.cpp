//////////////////////////////////////////////////////////////////////////
// Begin generate shripchello/src/private/HelloWorldStub.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2021
...
/************************************************************************
 * \file            shripchello/src/private/HelloWorldStub.cpp
 ...
 * Includes
 ************************************************************************/
#include "shripchello/src/HelloWorldStub.hpp"
...
DEF_TRACE_SCOPE(shripchello_src_HelloWorldStub_startupServiceInterface);
void HelloWorldStub::startupServiceInterface( Component & holder )
{
    TRACE_SCOPE(shripchello_src_HelloWorldStub_startupServiceInterface);
...
DEF_TRACE_SCOPE(shripchello_src_HelloWorldStub_shutdownServiceIntrface);
void HelloWorldStub::shutdownServiceIntrface( Component & holder )
{
    TRACE_SCOPE(shripchello_src_HelloWorldStub_shutdownServiceIntrface);
...
DEF_TRACE_SCOPE(shripchello_src_HelloWorldStub_sendNotification);
void HelloWorldStub::sendNotification( unsigned int msgId )
{
    ...
    default:
        {
            TRACE_SCOPE(shripchello_src_HelloWorldStub_sendNotification);
...
DEF_TRACE_SCOPE(shripchello_src_HelloWorldStub_errorRequest);
 ...
 ************************************************************************/
    ...
    {
        TRACE_SCOPE(shripchello_src_HelloWorldStub_errorRequest);
...
DEF_TRACE_SCOPE(shripchello_src_HelloWorldStub_processRequestEvent);
void HelloWorldStub::processRequestEvent( ServiceRequestEvent & eventElem )
{
    ...
    if ( (reqEvent != static_cast<HelloWorldRequestEvent *>(NULL)) && (reqEvent->getRequestType() == NEService::REQUEST_CALL) )
    {
        ...
        default:
            {
                TRACE_SCOPE(shripchello_src_HelloWorldStub_processRequestEvent);
...
DEF_TRACE_SCOPE(shripchello_src_HelloWorldStub_processAttributeEvent);
void HelloWorldStub::processAttributeEvent( ServiceRequestEvent & eventElem )
{
    ...
    else
    {
        ...
        else if (reqType == NEService::REQUEST_START_NOTIFY)
        {
            ...
            {
                TRACE_SCOPE(shripchello_src_HelloWorldStub_processAttributeEvent);
...
//////////////////////////////////////////////////////////////////////////
// End generate shripchello/src/private/HelloWorldStub.cpp file
//////////////////////////////////////////////////////////////////////////
