...
DEF_LOG_SCOPE(examples_14_locsvcmesh_ServiceClient_service_connected);
DEF_LOG_SCOPE(examples_14_locsvcmesh_ServiceClient_broadcast_reached_maximum);
DEF_LOG_SCOPE(examples_14_locsvcmesh_ServiceClient_response_hello_world);
...
{
    LOG_SCOPE(examples_14_locsvcmesh_ServiceClient_service_connected);
...
{
    LOG_SCOPE(examples_14_locsvcmesh_ServiceClient_response_hello_world);
...
{
    LOG_SCOPE(examples_14_locsvcmesh_ServiceClient_broadcast_reached_maximum);
