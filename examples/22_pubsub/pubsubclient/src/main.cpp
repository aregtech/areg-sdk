...
constexpr char const _serviceName[]{ "PubSubServiceProvider" }; //!< The name of the service
const String     _serviceClient  = NEUtilities::generateName("PubSubServiceConsumer"); //!< Generated name of service client component
...
// main method.
//////////////////////////////////////////////////////////////////////////
DEF_TRACE_SCOPE(example_22_pubsub_pubsubclient_main_main);
/**
...
int main()
{
    ...
    do
    {
        TRACE_SCOPE(example_22_pubsub_pubsubclient_main_main);
