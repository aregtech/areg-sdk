...
DEF_LOG_SCOPE(examples_22_publisher_Publisher_clientConnected);
DEF_LOG_SCOPE(examples_22_publisher_Publisher_start);
DEF_LOG_SCOPE(examples_22_publisher_Publisher_stop);
DEF_LOG_SCOPE(examples_22_publisher_Publisher_invalidate);
DEF_LOG_SCOPE(examples_22_publisher_Publisher_quit);
DEF_LOG_SCOPE(examples_22_publisher_Publisher_processTimer);
...
{
    LOG_SCOPE(examples_22_publisher_Publisher_clientConnected);
...
{
    LOG_SCOPE(examples_22_publisher_Publisher_start);
...
{
    LOG_SCOPE(examples_22_publisher_Publisher_stop);
...
{
    LOG_SCOPE(examples_22_publisher_Publisher_invalidate);
...
{
    LOG_SCOPE(examples_22_publisher_Publisher_quit);
...
{
    LOG_SCOPE(examples_22_publisher_Publisher_processTimer);
