...
DEF_TRACE_SCOPE(examples_22_publisher_Publisher_clientConnected);
DEF_TRACE_SCOPE(examples_22_publisher_Publisher_start);
DEF_TRACE_SCOPE(examples_22_publisher_Publisher_stop);
DEF_TRACE_SCOPE(examples_22_publisher_Publisher_invalidate);
DEF_TRACE_SCOPE(examples_22_publisher_Publisher_quit);
DEF_TRACE_SCOPE(examples_22_publisher_Publisher_processTimer);
...
{
    TRACE_SCOPE(examples_22_publisher_Publisher_clientConnected);
...
{
    TRACE_SCOPE(examples_22_publisher_Publisher_start);
...
{
    TRACE_SCOPE(examples_22_publisher_Publisher_stop);
...
{
    TRACE_SCOPE(examples_22_publisher_Publisher_invalidate);
...
{
    TRACE_SCOPE(examples_22_publisher_Publisher_quit);
...
{
    TRACE_SCOPE(examples_22_publisher_Publisher_processTimer);
