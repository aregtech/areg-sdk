...
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServiceClient_RemoteServiceClient);
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServiceClient_serviceConnected);
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServiceClient_responseRegister);
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServiceClient_responseHelloWorld);
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServiceClient_broadcastServiceUnavailable);
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServiceClient_onServiceStateUpdate);
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServiceClient_processTimer);
...
RemoteServiceClient::RemoteServiceClient(const String & roleName, Component & owner, unsigned int timeout)
    ...
    , mClient                   (                                                               )
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServiceClient_RemoteServiceClient);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServiceClient_serviceConnected);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServiceClient_responseRegister);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServiceClient_responseHelloWorld);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServiceClient_broadcastServiceUnavailable);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServiceClient_onServiceStateUpdate);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServiceClient_processTimer);
    ASSERT(&timer == &mTimer);
