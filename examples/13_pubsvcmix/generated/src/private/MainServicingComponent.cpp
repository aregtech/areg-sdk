...
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_MainServicingComponent_requestUnregister);
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_MainServicingComponent_requestRegister);
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_MainServicingComponent_requestHelloWorld);
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_MainServicingComponent_startupServiceInterface);
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_MainServicingComponent_clientConnected);
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_MainServicingComponent_processTimer);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_MainServicingComponent_requestUnregister);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_MainServicingComponent_requestRegister);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_MainServicingComponent_requestHelloWorld);
    if (getServiceState() == NESystemShutdown::ServiceReady)
    {
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_MainServicingComponent_startupServiceInterface);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_MainServicingComponent_clientConnected);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_MainServicingComponent_processTimer);
