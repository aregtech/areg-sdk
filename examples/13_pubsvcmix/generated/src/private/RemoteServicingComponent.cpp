...
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServicingComponent_startupServiceInterface);
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServicingComponent_requestRegister);
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServicingComponent_requestUnregister);
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServicingComponent_requestHelloWorld);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServicingComponent_startupServiceInterface);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServicingComponent_requestRegister);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServicingComponent_requestUnregister);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_RemoteServicingComponent_requestHelloWorld);
