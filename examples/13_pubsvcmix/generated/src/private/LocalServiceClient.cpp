...
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_LocalServiceClient_processTimer);
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_LocalServiceClient_LocalServiceClient);
...
LocalServiceClient::LocalServiceClient(const String & roleName, Component & owner, unsigned int timeout)
    ...
    , mID                       ( 0                                                             )
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_LocalServiceClient_LocalServiceClient);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_LocalServiceClient_serviceConnected);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_LocalServiceClient_responseHelloWorld);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_LocalServiceClient_processTimer);
    ASSERT(&timer == &mTimer);
