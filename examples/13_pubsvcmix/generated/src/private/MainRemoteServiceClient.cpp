...
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_MainRemoteServiceClient_broadcastServiceShutdown);
DEF_TRACE_SCOPE(examples_13_pubsvcmix_generated_MainRemoteServiceClient_serviceConnected);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_MainRemoteServiceClient_broadcastServiceShutdown);
...
{
    TRACE_SCOPE(examples_13_pubsvcmix_generated_MainRemoteServiceClient_serviceConnected);
