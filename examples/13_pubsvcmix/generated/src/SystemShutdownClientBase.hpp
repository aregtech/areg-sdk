...
{
    SystemShutdownClientBase::notifyOn( NESystemShutdown::MSG_ID_ServiceState, notify, false );
}
...
{
    SystemShutdownClientBase::notifyOn(NESystemShutdown::MSG_ID_broadcastServiceUnavailable, notify, false);
}

inline void SystemShutdownClientBase::notifyOnBroadcastServiceShutdown( bool notify /* = true */ )
{
    SystemShutdownClientBase::notifyOn(NESystemShutdown::MSG_ID_broadcastServiceShutdown, notify, false);
}
