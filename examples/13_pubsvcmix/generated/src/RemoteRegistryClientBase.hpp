...
{
    RemoteRegistryClientBase::notifyOn( NERemoteRegistry::MSG_ID_RegistryList, notify, false );
}
...
{
    RemoteRegistryClientBase::notifyOn( NERemoteRegistry::MSG_ID_RemainOutputs, notify, false );
}
...
{
    RemoteRegistryClientBase::notifyOn(NERemoteRegistry::MSG_ID_responseRegister, notify, false);
}

inline void RemoteRegistryClientBase::notifyOnResponseHelloWorld( bool notify /* = true */ )
{
    RemoteRegistryClientBase::notifyOn(NERemoteRegistry::MSG_ID_responseHelloWorld, notify, false);
}
