...
{
    LocalHelloWorldClientBase::notifyOn( NELocalHelloWorld::MSG_ID_ConnectedClients, notify, false );
}
...
{
    LocalHelloWorldClientBase::notifyOn( NELocalHelloWorld::MSG_ID_RemainOutput, notify, false );
}
...
{
    LocalHelloWorldClientBase::notifyOn(NELocalHelloWorld::MSG_ID_responseHelloWorld, notify, false);
}
