#ifndef AREG_EXAMPLES_13_PUBSVCMIX_GENERATED_SRC_REMOTESERVICINGCOMPONENT_HPP
#define AREG_EXAMPLES_13_PUBSVCMIX_GENERATED_SRC_REMOTESERVICINGCOMPONENT_HPP
/************************************************************************
...
protected:
     ...
     * \brief   Destructor.
     **/
    virtual ~RemoteServicingComponent(void);
...
// Forbidden calls
//////////////////////////////////////////////////////////////////////////
    RemoteServicingComponent( void );
    RemoteServicingComponent( const RemoteServicingComponent & /*src*/);
    const RemoteServicingComponent & operator = ( const RemoteServicingComponent & /*src*/ );
};
...
#endif // AREG_EXAMPLES_13_PUBSVCMIX_GENERATED_SRC_REMOTESERVICINGCOMPONENT_HPP
