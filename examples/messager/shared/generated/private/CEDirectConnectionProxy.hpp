...
public:
     ...
     **/
    static CEDirectConnectionProxy * CreateProxy( const char * roleName, IEProxyListener & connectListener, CEDispatcherThread & ownerThread );
     ...
     * \return  Returns pointer to instantiated proxy object.
     **/
    static CEDirectConnectionProxy * CreateProxy( const char * roleName, IEProxyListener & connectListener, const char * ownerThread = static_cast<const char *>(NULL) );
...
protected:
     ...
     *                      If NULL, current dispatching thread is used to dispatch messages.
     **/
    CEDirectConnectionProxy( const char * roleName, CEDispatcherThread * ownerThread = static_cast<CEDispatcherThread *>(NULL) );
    /**
     * \brief   Destructor
     **/
 ...
 ************************************************************************/
     ...
     **/
    void UpdateData( CEDirectConnectionResponseEvent & eventElem, NEDirectConnection::eMessageIDs respId );
    /**
...
inline void CEDirectConnectionProxy::SetNotification( NEDirectConnection::eMessageIDs notifyId, IENotificationEventConsumer & listener, bool notifyAlways /* = false */ )
{   CEProxyBase::SetNotification(static_cast<unsigned int>(notifyId), &listener, notifyAlways); }

inline void CEDirectConnectionProxy::ClearNotification( NEDirectConnection::eMessageIDs notifyId, IENotificationEventConsumer & listener )
