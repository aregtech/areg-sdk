//////////////////////////////////////////////////////////////////////////
// Begin generate shared/generated/private/ConnectionManagerProxy.hpp file
//////////////////////////////////////////////////////////////////////////
#ifndef  SHARED_GENERATED_PRIVATE_CONNECTIONMANAGERPROXY_HPP
#define  SHARED_GENERATED_PRIVATE_CONNECTIONMANAGERPROXY_HPP
/************************************************************************
 * (c) copyright    2021
...
/************************************************************************
 * \file            shared/generated/private/ConnectionManagerProxy.hpp
...
private:
    ...
    public:
         ...
         **/
        ConnectionManagerServiceAvailableEvent( IENotificationEventConsumer & consumer );
        /**
         * \brief   Destructor
         **/
        virtual ~ConnectionManagerServiceAvailableEvent( void );
    //////////////////////////////////////////////////////////////////////////
    // Forbidden calls
    //////////////////////////////////////////////////////////////////////////
    private:
        ConnectionManagerServiceAvailableEvent( void );
        ConnectionManagerServiceAvailableEvent( const ConnectionManagerServiceAvailableEvent & /*src*/ );
        const ConnectionManagerServiceAvailableEvent & operator = ( const ConnectionManagerServiceAvailableEvent & /*src*/ );
    };
//////////////////////////////////////////////////////////////////////////
...
public:
     ...
     * \return  Returns pointer to instantiated proxy object.
     **/
    static ConnectionManagerProxy * createProxy( const char * roleName, IEProxyListener & connectListener, const char * ownerThread = static_cast<const char *>(NULL) );
...
protected:
     ...
     *                      If NULL, current dispatching thread is used to dispatch messages.
     **/
    ConnectionManagerProxy( const char * roleName, DispatcherThread * ownerThread = static_cast<DispatcherThread *>(NULL) );
    /**
     * \brief   Destructor
     **/
...
{
    state = getProxyData().getAttributeState(NEConnectionManager::MSG_ID_ConnectionList);
...
#endif   // SHARED_GENERATED_PRIVATE_CONNECTIONMANAGERPROXY_HPP

//////////////////////////////////////////////////////////////////////////
// End generate shared/generated/private/ConnectionManagerProxy.hpp file
//////////////////////////////////////////////////////////////////////////
