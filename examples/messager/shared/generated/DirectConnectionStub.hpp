//////////////////////////////////////////////////////////////////////////
// Begin generate shared/generated/DirectConnectionStub.hpp file
//////////////////////////////////////////////////////////////////////////
#ifndef  SHARED_GENERATED_DIRECTCONNECTIONSTUB_HPP
#define  SHARED_GENERATED_DIRECTCONNECTIONSTUB_HPP
/************************************************************************
 * (c) copyright    2021
...
/************************************************************************
 * \file            shared/generated/DirectConnectionStub.hpp
...
protected:
     ...
     **/
    DirectConnectionStub( Component & masterComp );
    /**
     * \brief   Destructor.
     **/
    virtual ~DirectConnectionStub( void );
...
//////////////////////////////////////////////////////////////////////////
private:
    DirectConnectionStub( void );
    DirectConnectionStub( const DirectConnectionStub & /* src */ );
    const DirectConnectionStub & operator = ( const DirectConnectionStub & /* src */ );
};
...
{
    errorRequest( static_cast<unsigned int>(NEDirectConnection::MSG_ID_InitiatedConnections), false );
}
...
#endif   // SHARED_GENERATED_DIRECTCONNECTIONSTUB_HPP

//////////////////////////////////////////////////////////////////////////
// End generate shared/generated/DirectConnectionStub.hpp file
//////////////////////////////////////////////////////////////////////////
