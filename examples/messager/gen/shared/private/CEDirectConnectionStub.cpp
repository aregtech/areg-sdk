//////////////////////////////////////////////////////////////////////////
// Begin generate gen/shared/private/CEDirectConnectionStub.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2019
...
/************************************************************************
 * \file            gen/shared/private/CEDirectConnectionStub.cpp
 ...
 * Includes
 ************************************************************************/
#include "gen/shared/CEDirectConnectionStub.hpp"
...
DEF_TRACE_SCOPE(gen_shared_CEDirectConnectionStub_StartupServiceInterface);
void CEDirectConnectionStub::StartupServiceInterface( CEComponent & holder )
{
    TRACE_SCOPE(gen_shared_CEDirectConnectionStub_StartupServiceInterface);
...
DEF_TRACE_SCOPE(gen_shared_CEDirectConnectionStub_ShutdownServiceIntrface);
void CEDirectConnectionStub::ShutdownServiceIntrface( CEComponent & holder )
{
    TRACE_SCOPE(gen_shared_CEDirectConnectionStub_ShutdownServiceIntrface);
...
DEF_TRACE_SCOPE(gen_shared_CEDirectConnectionStub_SendNotification);
void CEDirectConnectionStub::SendNotification( const unsigned int msgId )
{
    ...
    default:
        {
            TRACE_SCOPE(gen_shared_CEDirectConnectionStub_SendNotification);
...
DEF_TRACE_SCOPE(gen_shared_CEDirectConnectionStub_ErrorRequest);
 ...
 ************************************************************************/
    ...
    {
        TRACE_SCOPE(gen_shared_CEDirectConnectionStub_ErrorRequest);
...
DEF_TRACE_SCOPE(gen_shared_CEDirectConnectionStub_ProcessRequestEvent);
void CEDirectConnectionStub::ProcessRequestEvent( CEServiceRequestEvent & eventElem )
{
    ...
    if ( (reqEvent != static_cast<CEDirectConnectionRequestEvent *>(NULL)) && (reqEvent->GetRequestType() == NEService::REQUEST_CALL) )
    {
        ...
        default:
            {
                TRACE_SCOPE(gen_shared_CEDirectConnectionStub_ProcessRequestEvent);
...
DEF_TRACE_SCOPE(gen_shared_CEDirectConnectionStub_ProcessAttributeEvent);
void CEDirectConnectionStub::ProcessAttributeEvent( CEServiceRequestEvent & eventElem )
{
    ...
    else
    {
        ...
        else if (reqType == NEService::REQUEST_START_NOTIFY)
        {
            ...
            {
                TRACE_SCOPE(gen_shared_CEDirectConnectionStub_ProcessAttributeEvent);
...
//////////////////////////////////////////////////////////////////////////
// End generate gen/shared/private/CEDirectConnectionStub.cpp file
//////////////////////////////////////////////////////////////////////////
