//////////////////////////////////////////////////////////////////////////
// Begin generate gen/shared/private/CEDirectMessagerStub.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2019
...
/************************************************************************
 * \file            gen/shared/private/CEDirectMessagerStub.cpp
 ...
 * Includes
 ************************************************************************/
#include "gen/shared/CEDirectMessagerStub.hpp"
#include "gen/shared/private/CEDirectMessagerEvents.hpp"
...
DEF_TRACE_SCOPE(gen_shared_CEDirectMessagerStub_StartupServiceInterface);
void CEDirectMessagerStub::StartupServiceInterface( CEComponent & holder )
{
    TRACE_SCOPE(gen_shared_CEDirectMessagerStub_StartupServiceInterface);
...
DEF_TRACE_SCOPE(gen_shared_CEDirectMessagerStub_ShutdownServiceIntrface);
void CEDirectMessagerStub::ShutdownServiceIntrface( CEComponent & holder )
{
    TRACE_SCOPE(gen_shared_CEDirectMessagerStub_ShutdownServiceIntrface);
...
DEF_TRACE_SCOPE(gen_shared_CEDirectMessagerStub_SendNotification);
void CEDirectMessagerStub::SendNotification( const unsigned int msgId )
{
    ...
    default:
        {
            TRACE_SCOPE(gen_shared_CEDirectMessagerStub_SendNotification);
...
DEF_TRACE_SCOPE(gen_shared_CEDirectMessagerStub_ErrorRequest);
 ...
 ************************************************************************/
    ...
    {
        TRACE_SCOPE(gen_shared_CEDirectMessagerStub_ErrorRequest);
...
DEF_TRACE_SCOPE(gen_shared_CEDirectMessagerStub_ProcessRequestEvent);
void CEDirectMessagerStub::ProcessRequestEvent( CEServiceRequestEvent & eventElem )
{
    ...
    if ( (reqEvent != static_cast<CEDirectMessagerRequestEvent *>(NULL)) && (reqEvent->GetRequestType() == NEService::REQUEST_CALL) )
    {
        ...
        default:
            {
                TRACE_SCOPE(gen_shared_CEDirectMessagerStub_ProcessRequestEvent);
...
DEF_TRACE_SCOPE(gen_shared_CEDirectMessagerStub_ProcessAttributeEvent);
void CEDirectMessagerStub::ProcessAttributeEvent( CEServiceRequestEvent & eventElem )
{
    ...
    else
    {
        ...
        else if (reqType == NEService::REQUEST_START_NOTIFY)
        {
            ...
            {
                TRACE_SCOPE(gen_shared_CEDirectMessagerStub_ProcessAttributeEvent);
...
//////////////////////////////////////////////////////////////////////////
// End generate gen/shared/private/CEDirectMessagerStub.cpp file
//////////////////////////////////////////////////////////////////////////
