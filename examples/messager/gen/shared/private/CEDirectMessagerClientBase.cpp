//////////////////////////////////////////////////////////////////////////
// Begin generate gen/shared/private/CEDirectMessagerClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2019
...
/************************************************************************
 * \file            gen/shared/private/CEDirectMessagerClientBase.cpp
 ...
 * Include files
 ************************************************************************/
#include "gen/shared/CEDirectMessagerClientBase.hpp"
...
DEF_TRACE_SCOPE(gen_shared_CEDirectMessagerClientBase_ServiceConnected);
bool CEDirectMessagerClientBase::ServiceConnected( const bool isConnected, CEProxyBase & proxy )
{
    TRACE_SCOPE(gen_shared_CEDirectMessagerClientBase_ServiceConnected);
...
DEF_TRACE_SCOPE(gen_shared_CEDirectMessagerClientBase_ProcessNotificationEvent);
void CEDirectMessagerClientBase::ProcessNotificationEvent( CENotificationEvent & eventElem )
{
    ...
    case NEService::RESULT_DATA_INVALID:
         ...
         ************************************************************************/
            ...
            default:
                {
                    TRACE_SCOPE(gen_shared_CEDirectMessagerClientBase_ProcessNotificationEvent);
 ...
 ************************************************************************/
DEF_TRACE_SCOPE(gen_shared_CEDirectMessagerClientBase_InvalidResponse);
void CEDirectMessagerClientBase::InvalidResponse( const NEDirectMessager::eMessageIDs InvalidRespId )
{
    TRACE_SCOPE(gen_shared_CEDirectMessagerClientBase_InvalidResponse);
...
DEF_TRACE_SCOPE(gen_shared_CEDirectMessagerClientBase_InvalidRequest);
void CEDirectMessagerClientBase::InvalidRequest( const NEDirectMessager::eMessageIDs InvalidReqId )
{
    TRACE_SCOPE(gen_shared_CEDirectMessagerClientBase_InvalidRequest);
...
DEF_TRACE_SCOPE(gen_shared_CEDirectMessagerClientBase_RequestFailed);
...
{
    TRACE_SCOPE(gen_shared_CEDirectMessagerClientBase_RequestFailed);
...
{
    CEClientBase::InfoNotImplemented( "CEDirectMessagerClientBase", static_cast<unsigned int>(NEDirectMessager::MSG_ID_BroadcastMessageSent) );
}
...
{
    CEClientBase::InfoNotImplemented( "CEDirectMessagerClientBase", static_cast<unsigned int>(NEDirectMessager::MSG_ID_BroadcastMessageTyped) );
}
...
{
    CEClientBase::InfoNotImplemented( "CEDirectMessagerClientBase", static_cast<unsigned int>(NEDirectMessager::MSG_ID_BroadcastParticipantJoined) );
}
...
{
    CEClientBase::InfoNotImplemented( "CEDirectMessagerClientBase", static_cast<unsigned int>(NEDirectMessager::MSG_ID_BroadcastParticipantLeft) );
}

void CEDirectMessagerClientBase::BroadcastChatClosed( void )
{
    CEClientBase::InfoNotImplemented( "CEDirectMessagerClientBase", static_cast<unsigned int>(NEDirectMessager::MSG_ID_BroadcastChatClosed) );
}


//////////////////////////////////////////////////////////////////////////
// End generate gen/shared/private/CEDirectMessagerClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
