//////////////////////////////////////////////////////////////////////////
// Begin generate gen/shared/private/CECentralMessagerStub.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2019
...
/************************************************************************
 * \file            gen/shared/private/CECentralMessagerStub.cpp
 ...
 * Includes
 ************************************************************************/
#include "gen/shared/CECentralMessagerStub.hpp"
...
DEF_TRACE_SCOPE(gen_shared_CECentralMessagerStub_StartupServiceInterface);
void CECentralMessagerStub::StartupServiceInterface( CEComponent & holder )
{
    TRACE_SCOPE(gen_shared_CECentralMessagerStub_StartupServiceInterface);
...
DEF_TRACE_SCOPE(gen_shared_CECentralMessagerStub_ShutdownServiceIntrface);
void CECentralMessagerStub::ShutdownServiceIntrface( CEComponent & holder )
{
    TRACE_SCOPE(gen_shared_CECentralMessagerStub_ShutdownServiceIntrface);
...
DEF_TRACE_SCOPE(gen_shared_CECentralMessagerStub_SendNotification);
void CECentralMessagerStub::SendNotification( const unsigned int msgId )
{
    TRACE_SCOPE(gen_shared_CECentralMessagerStub_SendNotification);
...
DEF_TRACE_SCOPE(gen_shared_CECentralMessagerStub_ErrorRequest);
 ...
 ************************************************************************/
    ...
    {
        TRACE_SCOPE(gen_shared_CECentralMessagerStub_ErrorRequest);
...
DEF_TRACE_SCOPE(gen_shared_CECentralMessagerStub_ProcessRequestEvent);
void CECentralMessagerStub::ProcessRequestEvent( CEServiceRequestEvent & eventElem )
{
    ...
    if ( (reqEvent != static_cast<CECentralMessagerRequestEvent *>(NULL)) && (reqEvent->GetRequestType() == NEService::REQUEST_CALL) )
    {
        ...
        default:
            {
                TRACE_SCOPE(gen_shared_CECentralMessagerStub_ProcessRequestEvent);
...
DEF_TRACE_SCOPE(gen_shared_CECentralMessagerStub_ProcessAttributeEvent);
void CECentralMessagerStub::ProcessAttributeEvent( CEServiceRequestEvent & eventElem )
{
    ...
    else
    {
        ...
        else if (reqType == NEService::REQUEST_START_NOTIFY)
        {
            ...
            {
                TRACE_SCOPE(gen_shared_CECentralMessagerStub_ProcessAttributeEvent);
...
//////////////////////////////////////////////////////////////////////////
// End generate gen/shared/private/CECentralMessagerStub.cpp file
//////////////////////////////////////////////////////////////////////////
