//////////////////////////////////////////////////////////////////////////
// Begin generate gen/shared/private/CEConnectionManagerStub.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2019
...
/************************************************************************
 * \file            gen/shared/private/CEConnectionManagerStub.cpp
 ...
 * Includes
 ************************************************************************/
#include "gen/shared/CEConnectionManagerStub.hpp"
#include "gen/shared/private/CEConnectionManagerEvents.hpp"

#include "areg/core/component/CEServiceResponseEvent.hpp"
...
DEF_TRACE_SCOPE(gen_shared_CEConnectionManagerStub_StartupServiceInterface);
void CEConnectionManagerStub::StartupServiceInterface( CEComponent & holder )
{
    TRACE_SCOPE(gen_shared_CEConnectionManagerStub_StartupServiceInterface);
...
DEF_TRACE_SCOPE(gen_shared_CEConnectionManagerStub_ShutdownServiceIntrface);
void CEConnectionManagerStub::ShutdownServiceIntrface( CEComponent & holder )
{
    TRACE_SCOPE(gen_shared_CEConnectionManagerStub_ShutdownServiceIntrface);
...
DEF_TRACE_SCOPE(gen_shared_CEConnectionManagerStub_SendNotification);
void CEConnectionManagerStub::SendNotification( const unsigned int msgId )
{
    ...
    default:
        {
            TRACE_SCOPE(gen_shared_CEConnectionManagerStub_SendNotification);
...
DEF_TRACE_SCOPE(gen_shared_CEConnectionManagerStub_ErrorRequest);
 ...
 ************************************************************************/
    ...
    {
        TRACE_SCOPE(gen_shared_CEConnectionManagerStub_ErrorRequest);
...
DEF_TRACE_SCOPE(gen_shared_CEConnectionManagerStub_ProcessRequestEvent);
void CEConnectionManagerStub::ProcessRequestEvent( CEServiceRequestEvent & eventElem )
{
    ...
    if ( (reqEvent != static_cast<CEConnectionManagerRequestEvent *>(NULL)) && (reqEvent->GetRequestType() == NEService::REQUEST_CALL) )
    {
        ...
        default:
            {
                TRACE_SCOPE(gen_shared_CEConnectionManagerStub_ProcessRequestEvent);
...
DEF_TRACE_SCOPE(gen_shared_CEConnectionManagerStub_ProcessAttributeEvent);
void CEConnectionManagerStub::ProcessAttributeEvent( CEServiceRequestEvent & eventElem )
{
    ...
    else
    {
        ...
        else if (reqType == NEService::REQUEST_START_NOTIFY)
        {
            ...
            {
                TRACE_SCOPE(gen_shared_CEConnectionManagerStub_ProcessAttributeEvent);
...
//////////////////////////////////////////////////////////////////////////
// End generate gen/shared/private/CEConnectionManagerStub.cpp file
//////////////////////////////////////////////////////////////////////////
