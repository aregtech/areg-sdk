...
{
    ProxyBase::ServiceAvailableEvent* event = static_cast<ProxyBase::ServiceAvailableEvent *>( DEBUG_NEW SimpleTrafficLightProxy::SimpleTrafficLightServiceAvailableEvent(consumer) );
    if (event != nullptr)
    {
