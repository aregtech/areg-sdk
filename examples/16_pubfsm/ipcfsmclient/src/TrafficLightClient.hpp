#ifndef  AREG_EXAMPLES_16_PUBFSM_IPCFSMCLIENT_SRC_TRAFFICLIGHTCLIENT_HPP
#define  AREG_EXAMPLES_16_PUBFSM_IPCFSMCLIENT_SRC_TRAFFICLIGHTCLIENT_HPP
/************************************************************************
 * \file        ipcfsmclient/src/TrafficLightClient.hpp
...
private:
     ...
     * \brief   Destructor
     **/
    virtual ~TrafficLightClient(void);
...
//////////////////////////////////////////////////////////////////////////
private:
    TrafficLightClient( void );
    TrafficLightClient( const TrafficLightClient & /*src*/ );
    const TrafficLightClient & operator = ( const TrafficLightClient & /*src*/ );
};

#endif // AREG_EXAMPLES_16_PUBFSM_IPCFSMCLIENT_SRC_TRAFFICLIGHTCLIENT_HPP
