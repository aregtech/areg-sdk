/************************************************************************
 * \file        ipcfsmclient/src/TrafficLightClient.cpp
...
DEF_TRACE_SCOPE(ipcfsmclient_src_TrafficLightClient_onTrafficSouthNorthUpdate);
DEF_TRACE_SCOPE(ipcfsmclient_src_TrafficLightClient_onTrafficEastWestUpdate);
DEF_TRACE_SCOPE(ipcfsmclient_src_TrafficLightClient_broadcastSouthNorth);
DEF_TRACE_SCOPE(ipcfsmclient_src_TrafficLightClient_broadcastEastWest);
DEF_TRACE_SCOPE(ipcfsmclient_src_TrafficLightClient_serviceConnected);
...
TrafficLightClient::~TrafficLightClient(void)
{
}
...
{
    TRACE_SCOPE(ipcfsmclient_src_TrafficLightClient_onTrafficSouthNorthUpdate);
    ...
    {
        printf("\tVehicle Light: %12s    |\tPedestrian Light: %s\n", NECommon::getName(NETrafficController::VhicleLightOFF), NECommon::getName(NETrafficController::PedestrianLightOFF));
    }
}
...
{
    TRACE_SCOPE(ipcfsmclient_src_TrafficLightClient_onTrafficEastWestUpdate);
...
{
    TRACE_SCOPE(ipcfsmclient_src_TrafficLightClient_broadcastSouthNorth);
...
{
    TRACE_SCOPE(ipcfsmclient_src_TrafficLightClient_broadcastEastWest);
...
{
    TRACE_SCOPE(ipcfsmclient_src_TrafficLightClient_serviceConnected);
