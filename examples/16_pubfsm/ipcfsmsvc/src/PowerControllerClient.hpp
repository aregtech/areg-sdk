#ifndef  AREG_EXAMPLES_16_PUBFSM_IPCFSMSVC_SRC_POWERCONTROLLERCLIENT_HPP
#define  AREG_EXAMPLES_16_PUBFSM_IPCFSMSVC_SRC_POWERCONTROLLERCLIENT_HPP
/************************************************************************
 * \file        ipcfsmsvc/src/PowerControllerClient.hpp
...
private:
     ...
     **/
    static const char * const   ConsoleThreadName   /*= "ConsoleThread"*/;
...
public:
     ...
     * \brief   Destructor.
     **/
    virtual ~PowerControllerClient( void );
...
/************************************************************************/
     ...
     **/
    virtual void processEvent( const PowerControllerEventData & data );
...
//////////////////////////////////////////////////////////////////////////
private:
    PowerControllerClient( void );
    PowerControllerClient( const PowerControllerClient & /*src*/ );
    const PowerControllerClient & operator = ( const PowerControllerClient & /*src*/ );
};
...
inline PowerControllerEventData::PowerControllerEventData(void)
    : mAction   (PowerControllerEventData::NoAction)
{
}
...
#endif  // AREG_EXAMPLES_16_PUBFSM_IPCFSMSVC_SRC_POWERCONTROLLERCLIENT_HPP
