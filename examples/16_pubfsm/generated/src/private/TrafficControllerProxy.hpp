...
private:
    ...
    public:
         ...
         **/
        explicit TrafficControllerServiceAvailableEvent( IENotificationEventConsumer & consumer );
        /**
         * \brief   Destructor.
         **/
        virtual ~TrafficControllerServiceAvailableEvent( void ) = default;
    //////////////////////////////////////////////////////////////////////////
    // Forbidden calls
    //////////////////////////////////////////////////////////////////////////
    private:
        TrafficControllerServiceAvailableEvent( void ) = delete;
        DECLARE_NOCOPY_NOMOVE( TrafficControllerServiceAvailableEvent );
    };
//////////////////////////////////////////////////////////////////////////
...
protected:
     ...
     **/
    static TrafficControllerProxy * createProxy( const String & roleName, IEProxyListener & connectListener, DispatcherThread & ownerThread );
     ...
     * \return  Returns pointer to instantiated proxy object.
     **/
    static TrafficControllerProxy * createProxy( const String & roleName, IEProxyListener & connectListener, const String & ownerThread = String::EmptyString );
...
protected:
     ...
     *                      If nullptr, current dispatching thread is used to dispatch messages.
     **/
    explicit TrafficControllerProxy( const String & roleName, DispatcherThread * ownerThread = nullptr );
    /**
     * \brief   Destructor
     **/
    virtual ~TrafficControllerProxy( void ) = default;
...
//////////////////////////////////////////////////////////////////////////
private:
    TrafficControllerProxy( void ) = delete;
    DECLARE_NOCOPY_NOMOVE( TrafficControllerProxy );
};
...
{
    return (getProxyData().getAttributeState( static_cast<msg_id>(NETrafficController::eMessageIDs::MsgId_TrafficSouthNorth) ) == NEService::eDataStateType::DataIsOK);
}
...
{
    state = getProxyData().getAttributeState( static_cast<msg_id>(NETrafficController::eMessageIDs::MsgId_TrafficSouthNorth) );
    return mTrafficSouthNorth;
}

inline bool TrafficControllerProxy::isTrafficEastWestValid( void ) const
{
    return (getProxyData().getAttributeState( static_cast<msg_id>(NETrafficController::eMessageIDs::MsgId_TrafficEastWest) ) == NEService::eDataStateType::DataIsOK);
}
...
{
    state = getProxyData().getAttributeState( static_cast<msg_id>(NETrafficController::eMessageIDs::MsgId_TrafficEastWest) );
