...
areg::Model ChatParticipantService::GetModel( const DirectMessager::sParticipant & initiator, const DirectMessager::ListParticipants & /* listParticipants */, std::any data )
{
