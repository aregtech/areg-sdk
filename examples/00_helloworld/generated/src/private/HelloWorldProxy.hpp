...
public:
     ...
     * \return  Returns pointer to instantiated proxy object.
     **/
    static HelloWorldProxy * createProxy( const char * roleName, IEProxyListener & connectListener, const char * ownerThread = nullptr );
...
protected:
     ...
     *                      If nullptr, current dispatching thread is used to dispatch messages.
     **/
    explicit HelloWorldProxy( const char * roleName, DispatcherThread * ownerThread = nullptr );
    /**
     * \brief   Destructor
     **/
