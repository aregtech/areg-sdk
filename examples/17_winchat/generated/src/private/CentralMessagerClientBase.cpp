//////////////////////////////////////////////////////////////////////////
// Begin generate generated/src/private/CentralMessagerClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2023
 *
 ...
 *
 * \file            generated/src/CentralMessagerClientBase.hpp
 ...
 * Include files
 ************************************************************************/
#include "generated/src/CentralMessagerClientBase.hpp"
...
DEF_TRACE_SCOPE(generated_src_CentralMessagerClientBase_serviceConnected);
bool CentralMessagerClientBase::serviceConnected( NEService::eServiceConnection status, ProxyBase & proxy )
{
    TRACE_SCOPE(generated_src_CentralMessagerClientBase_serviceConnected);
...
DEF_TRACE_SCOPE(generated_src_CentralMessagerClientBase_processNotificationEvent);
void CentralMessagerClientBase::processNotificationEvent( NotificationEvent & eventElem )
{
    ...
    case NEService::eResultType::RequestOK:
         ...
         ************************************************************************/
            ...
            default:
                {
                    TRACE_SCOPE(generated_src_CentralMessagerClientBase_processNotificationEvent);
 ...
 ************************************************************************/
DEF_TRACE_SCOPE(generated_src_CentralMessagerClientBase_invalidResponse);
void CentralMessagerClientBase::invalidResponse( NECentralMessager::eMessageIDs InvalidRespId )
{
    TRACE_SCOPE(generated_src_CentralMessagerClientBase_invalidResponse);
...
DEF_TRACE_SCOPE(generated_src_CentralMessagerClientBase_invalidRequest);
void CentralMessagerClientBase::invalidRequest( NECentralMessager::eMessageIDs InvalidReqId )
{
    TRACE_SCOPE(generated_src_CentralMessagerClientBase_invalidRequest);
...
DEF_TRACE_SCOPE(generated_src_CentralMessagerClientBase_requestFailed);
...
{
    TRACE_SCOPE(generated_src_CentralMessagerClientBase_requestFailed);
    ...
    msg_id index { static_cast<msg_id>( NEService::isResponseId(static_cast<unsigned int>(FailureMsgId)) ? NECentralMessager::getRequestId(FailureMsgId) : FailureMsgId) };
...
DEF_TRACE_SCOPE(generated_src_CentralMessagerClientBase_requestSendMessageFailed);
void CentralMessagerClientBase::requestSendMessageFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(generated_src_CentralMessagerClientBase_requestSendMessageFailed);
...
DEF_TRACE_SCOPE(generated_src_CentralMessagerClientBase_requestKeyTypingFailed);
void CentralMessagerClientBase::requestKeyTypingFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(generated_src_CentralMessagerClientBase_requestKeyTypingFailed);
...
DEF_TRACE_SCOPE(generated_src_CentralMessagerClientBase_broadcastSendMessage);
...
{
    TRACE_SCOPE(generated_src_CentralMessagerClientBase_broadcastSendMessage);
...
DEF_TRACE_SCOPE(generated_src_CentralMessagerClientBase_broadcastKeyTyping);
void CentralMessagerClientBase::broadcastKeyTyping( const String & /* nickName */, unsigned int /* cookie */, const String & /* newMessage */ )
{
    TRACE_SCOPE(generated_src_CentralMessagerClientBase_broadcastKeyTyping);
...
DEF_TRACE_SCOPE(generated_src_CentralMessagerClientBase_broadcastBroadcastMessage);
void CentralMessagerClientBase::broadcastBroadcastMessage( const String & /* serverMessage */, const DateTime & /* dateTime */ )
{
    TRACE_SCOPE(generated_src_CentralMessagerClientBase_broadcastBroadcastMessage);
...
//////////////////////////////////////////////////////////////////////////
// End generate generated/src/private/CentralMessagerClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
