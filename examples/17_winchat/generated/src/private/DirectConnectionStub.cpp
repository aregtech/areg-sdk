//////////////////////////////////////////////////////////////////////////
// Begin generate generated/src/private/DirectConnectionStub.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2023
 *
 ...
 *
 * \file            generated/src/DirectConnectionStub.hpp
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionStub_startupServiceInterface);
void DirectConnectionStub::startupServiceInterface( Component & holder )
{
    TRACE_SCOPE(generated_src_DirectConnectionStub_startupServiceInterface);
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionStub_shutdownServiceIntrface);
void DirectConnectionStub::shutdownServiceIntrface( Component & holder )
{
    TRACE_SCOPE(generated_src_DirectConnectionStub_shutdownServiceIntrface);
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionStub_sendNotification);
void DirectConnectionStub::sendNotification( unsigned int msgId )
{
    ...
    default:
        {
            TRACE_SCOPE(generated_src_DirectConnectionStub_sendNotification);
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionStub_errorRequest);
 ...
 ************************************************************************/
    ...
    {
        TRACE_SCOPE(generated_src_DirectConnectionStub_errorRequest);
...
{
    constexpr NEDirectConnection::eMessageIDs msgId { NEDirectConnection::eMessageIDs::MsgId_responseConnectoinSetup };
    EventDataStream args(EventDataStream::eEventData::EventDataExternal);
    IEOutStream & stream = args.getStreamForWrite();
    stream << succeeded;
    stream << target;
...
{
    constexpr NEDirectConnection::eMessageIDs msgId { NEDirectConnection::eMessageIDs::MsgId_responseAddParticipant };
    EventDataStream args(EventDataStream::eEventData::EventDataExternal);
    IEOutStream & stream = args.getStreamForWrite();
    stream << succeeded;
    stream << listParticipants;
...
{
    constexpr NEDirectConnection::eMessageIDs msgId { NEDirectConnection::eMessageIDs::MsgId_responseRemoveParticipant };
    EventDataStream args(EventDataStream::eEventData::EventDataExternal);
    IEOutStream & stream = args.getStreamForWrite();
    stream << succeeded;
    stream << listParticipants;
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionStub_processRequestEvent);
void DirectConnectionStub::processRequestEvent( ServiceRequestEvent & eventElem )
{
    ...
    if ( (reqEvent != nullptr) && (reqEvent->getRequestType() == NEService::eRequestType::CallFunction) )
    {
        ...
        default:
            {
                TRACE_SCOPE(generated_src_DirectConnectionStub_processRequestEvent);
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionStub_processAttributeEvent);
void DirectConnectionStub::processAttributeEvent( ServiceRequestEvent & eventElem )
{
    ...
    else
    {
        ...
        else if (reqType == NEService::eRequestType::StartNotify)
        {
            ...
            {
                TRACE_SCOPE(generated_src_DirectConnectionStub_processAttributeEvent);
...
//////////////////////////////////////////////////////////////////////////
// End generate generated/src/private/DirectConnectionStub.cpp file
//////////////////////////////////////////////////////////////////////////
