//////////////////////////////////////////////////////////////////////////
// Begin generate generated/src/private/ConnectionManagerClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2023
 *
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerClientBase_serviceConnected);
bool ConnectionManagerClientBase::serviceConnected( NEService::eServiceConnection status, ProxyBase & proxy )
{
    TRACE_SCOPE(generated_src_ConnectionManagerClientBase_serviceConnected);
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerClientBase_processNotificationEvent);
void ConnectionManagerClientBase::processNotificationEvent( NotificationEvent & eventElem )
{
    ...
    case NEService::eResultType::DataInvalid:
         ...
         ************************************************************************/
            ...
            default:
                {
                    TRACE_SCOPE(generated_src_ConnectionManagerClientBase_processNotificationEvent);
 ...
 ************************************************************************/
DEF_TRACE_SCOPE(generated_src_ConnectionManagerClientBase_invalidResponse);
void ConnectionManagerClientBase::invalidResponse( NEConnectionManager::eMessageIDs InvalidRespId )
{
    TRACE_SCOPE(generated_src_ConnectionManagerClientBase_invalidResponse);
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerClientBase_invalidRequest);
void ConnectionManagerClientBase::invalidRequest( NEConnectionManager::eMessageIDs InvalidReqId )
{
    TRACE_SCOPE(generated_src_ConnectionManagerClientBase_invalidRequest);
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerClientBase_requestFailed);
...
{
    TRACE_SCOPE(generated_src_ConnectionManagerClientBase_requestFailed);
    ...
    msg_id index { static_cast<msg_id>( NEService::isResponseId(static_cast<unsigned int>(FailureMsgId)) ? NEConnectionManager::getRequestId(FailureMsgId) : FailureMsgId) };
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerClientBase_onConnectionListUpdate);
...
{
    TRACE_SCOPE(generated_src_ConnectionManagerClientBase_onConnectionListUpdate);
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerClientBase_requestConnectFailed);
void ConnectionManagerClientBase::requestConnectFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(generated_src_ConnectionManagerClientBase_requestConnectFailed);
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerClientBase_requestRegisterConnectionFailed);
void ConnectionManagerClientBase::requestRegisterConnectionFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(generated_src_ConnectionManagerClientBase_requestRegisterConnectionFailed);
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerClientBase_requestDisconnectFailed);
void ConnectionManagerClientBase::requestDisconnectFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(generated_src_ConnectionManagerClientBase_requestDisconnectFailed);
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerClientBase_responseConnect);
...
{
    TRACE_SCOPE(generated_src_ConnectionManagerClientBase_responseConnect);
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerClientBase_responseRegisterConnection);
...
{
    TRACE_SCOPE(generated_src_ConnectionManagerClientBase_responseRegisterConnection);
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerClientBase_broadcastConnectionUpdated);
void ConnectionManagerClientBase::broadcastConnectionUpdated( const NEConnectionManager::MapConnection & /* updatedList */ )
{
    TRACE_SCOPE(generated_src_ConnectionManagerClientBase_broadcastConnectionUpdated);
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerClientBase_broadcastClientConnected);
void ConnectionManagerClientBase::broadcastClientConnected( const NEConnectionManager::sConnection & /* clientConnected */ )
{
    TRACE_SCOPE(generated_src_ConnectionManagerClientBase_broadcastClientConnected);
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerClientBase_broadcastClientDisconnected);
void ConnectionManagerClientBase::broadcastClientDisconnected( const NEConnectionManager::sConnection & /* clientLeft */ )
{
    TRACE_SCOPE(generated_src_ConnectionManagerClientBase_broadcastClientDisconnected);
...
//////////////////////////////////////////////////////////////////////////
// End generate generated/src/private/ConnectionManagerClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
