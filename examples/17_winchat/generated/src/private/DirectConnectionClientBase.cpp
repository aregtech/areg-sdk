//////////////////////////////////////////////////////////////////////////
// Begin generate generated/src/private/DirectConnectionClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2023
 *
 * Generated at     15.11.2023  14:52:02 GMT+01:00
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionClientBase_serviceConnected);
bool DirectConnectionClientBase::serviceConnected( NEService::eServiceConnection status, ProxyBase & proxy )
{
    TRACE_SCOPE(generated_src_DirectConnectionClientBase_serviceConnected);
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionClientBase_processNotificationEvent);
void DirectConnectionClientBase::processNotificationEvent( NotificationEvent & eventElem )
{
    ...
    case NEService::eResultType::DataInvalid:
         ...
         ************************************************************************/
            ...
            default:
                {
                    TRACE_SCOPE(generated_src_DirectConnectionClientBase_processNotificationEvent);
 ...
 ************************************************************************/
DEF_TRACE_SCOPE(generated_src_DirectConnectionClientBase_invalidResponse);
void DirectConnectionClientBase::invalidResponse( NEDirectConnection::eMessageIDs InvalidRespId )
{
    TRACE_SCOPE(generated_src_DirectConnectionClientBase_invalidResponse);
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionClientBase_invalidRequest);
void DirectConnectionClientBase::invalidRequest( NEDirectConnection::eMessageIDs InvalidReqId )
{
    TRACE_SCOPE(generated_src_DirectConnectionClientBase_invalidRequest);
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionClientBase_requestFailed);
...
{
    TRACE_SCOPE(generated_src_DirectConnectionClientBase_requestFailed);
    ...
    msg_id index { static_cast<msg_id>( NEService::isResponseId(static_cast<unsigned int>(FailureMsgId)) ? NEDirectConnection::getRequestId(FailureMsgId) : FailureMsgId) };
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionClientBase_onInitiatedConnectionsUpdate);
...
{
    TRACE_SCOPE(generated_src_DirectConnectionClientBase_onInitiatedConnectionsUpdate);
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionClientBase_requestConnectoinSetupFailed);
void DirectConnectionClientBase::requestConnectoinSetupFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(generated_src_DirectConnectionClientBase_requestConnectoinSetupFailed);
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionClientBase_requestAddParticipantFailed);
void DirectConnectionClientBase::requestAddParticipantFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(generated_src_DirectConnectionClientBase_requestAddParticipantFailed);
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionClientBase_requestRemoveParticipantFailed);
void DirectConnectionClientBase::requestRemoveParticipantFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(generated_src_DirectConnectionClientBase_requestRemoveParticipantFailed);
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionClientBase_requestCloseConnectionFailed);
void DirectConnectionClientBase::requestCloseConnectionFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(generated_src_DirectConnectionClientBase_requestCloseConnectionFailed);
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionClientBase_responseConnectoinSetup);
...
{
    TRACE_SCOPE(generated_src_DirectConnectionClientBase_responseConnectoinSetup);
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionClientBase_responseAddParticipant);
...
{
    TRACE_SCOPE(generated_src_DirectConnectionClientBase_responseAddParticipant);
...
DEF_TRACE_SCOPE(generated_src_DirectConnectionClientBase_responseRemoveParticipant);
...
{
    TRACE_SCOPE(generated_src_DirectConnectionClientBase_responseRemoveParticipant);
...
//////////////////////////////////////////////////////////////////////////
// End generate generated/src/private/DirectConnectionClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
