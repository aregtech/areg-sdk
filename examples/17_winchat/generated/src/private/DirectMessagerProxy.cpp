//////////////////////////////////////////////////////////////////////////
// Begin generate generated/src/private/DirectMessagerProxy.cpp file
//////////////////////////////////////////////////////////////////////////
 ...
 * Includes
 ************************************************************************/
#include "generated/src/private/DirectMessagerProxy.hpp"
...
RemoteResponseEvent * DirectMessagerProxy::createRemoteRequestFailedEvent(const ProxyAddress & addrProxy, unsigned int msgId, NEService::eResultType reason, const SequenceNumber &  seqNr) const
{
...
{
    ProxyBase::ServiceAvailableEvent* event = static_cast<ProxyBase::ServiceAvailableEvent *>( DEBUG_NEW DirectMessagerProxy::DirectMessagerServiceAvailableEvent(consumer) );
    if (event != nullptr)
    {
...
const SequenceNumber &  DirectMessagerProxy::requestChatJoin( IENotificationEventConsumer & caller, const NEDirectMessager::sParticipant & participant, const DateTime & timeConnect )
{
...
DEF_TRACE_SCOPE(generated_src_private_DirectMessagerProxy_updateData);
void DirectMessagerProxy::updateData( DirectMessagerResponseEvent & eventElem, NEDirectMessager::eMessageIDs respId )
{
    ...
    default:
        {
            TRACE_SCOPE(generated_src_private_DirectMessagerProxy_updateData);
...
//////////////////////////////////////////////////////////////////////////
// End generate generated/src/private/DirectMessagerProxy.cpp file
//////////////////////////////////////////////////////////////////////////
