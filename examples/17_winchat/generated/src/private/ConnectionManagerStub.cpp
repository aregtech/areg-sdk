//////////////////////////////////////////////////////////////////////////
// Begin generate generated/src/private/ConnectionManagerStub.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2023
 *
 ...
 *
 * \file            generated/src/ConnectionManagerStub.hpp
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerStub_startupServiceInterface);
void ConnectionManagerStub::startupServiceInterface( Component & holder )
{
    TRACE_SCOPE(generated_src_ConnectionManagerStub_startupServiceInterface);
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerStub_shutdownServiceIntrface);
void ConnectionManagerStub::shutdownServiceIntrface( Component & holder )
{
    TRACE_SCOPE(generated_src_ConnectionManagerStub_shutdownServiceIntrface);
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerStub_sendNotification);
void ConnectionManagerStub::sendNotification( unsigned int msgId )
{
    ...
    default:
        {
            TRACE_SCOPE(generated_src_ConnectionManagerStub_sendNotification);
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerStub_errorRequest);
 ...
 ************************************************************************/
    ...
    {
        TRACE_SCOPE(generated_src_ConnectionManagerStub_errorRequest);
...
{
    constexpr NEConnectionManager::eMessageIDs msgId { NEConnectionManager::eMessageIDs::MsgId_responseConnect };
    EventDataStream args(EventDataStream::eEventData::EventDataExternal);
    IEOutStream & stream = args.getStreamForWrite();
    stream << nickName;
    stream << cookie;
...
{
    constexpr NEConnectionManager::eMessageIDs msgId { NEConnectionManager::eMessageIDs::MsgId_responseRegisterConnection };
    EventDataStream args(EventDataStream::eEventData::EventDataExternal);
    IEOutStream & stream = args.getStreamForWrite();
    stream << connection;
...
{
    constexpr NEConnectionManager::eMessageIDs msgId { NEConnectionManager::eMessageIDs::MsgId_broadcastConnectionUpdated };
    EventDataStream args(EventDataStream::eEventData::EventDataExternal);
    IEOutStream & stream = args.getStreamForWrite();
    stream << updatedList;
    sendResponseEvent( static_cast<msg_id>(msgId), args );
...
{
    constexpr NEConnectionManager::eMessageIDs msgId { NEConnectionManager::eMessageIDs::MsgId_broadcastClientConnected };
    EventDataStream args(EventDataStream::eEventData::EventDataExternal);
    IEOutStream & stream = args.getStreamForWrite();
...
{
    constexpr NEConnectionManager::eMessageIDs msgId { NEConnectionManager::eMessageIDs::MsgId_broadcastClientDisconnected };
    EventDataStream args(EventDataStream::eEventData::EventDataExternal);
    IEOutStream & stream = args.getStreamForWrite();
    stream << clientLeft;
    sendResponseEvent( static_cast<msg_id>(msgId), args );
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerStub_processRequestEvent);
void ConnectionManagerStub::processRequestEvent( ServiceRequestEvent & eventElem )
{
    ...
    if ( (reqEvent != nullptr) && (reqEvent->getRequestType() == NEService::eRequestType::CallFunction) )
    {
        ...
        default:
            {
                TRACE_SCOPE(generated_src_ConnectionManagerStub_processRequestEvent);
...
DEF_TRACE_SCOPE(generated_src_ConnectionManagerStub_processAttributeEvent);
void ConnectionManagerStub::processAttributeEvent( ServiceRequestEvent & eventElem )
{
    ...
    else
    {
        ...
        else if (reqType == NEService::eRequestType::StartNotify)
        {
            ...
            {
                TRACE_SCOPE(generated_src_ConnectionManagerStub_processAttributeEvent);
...
//////////////////////////////////////////////////////////////////////////
// End generate generated/src/private/ConnectionManagerStub.cpp file
//////////////////////////////////////////////////////////////////////////
