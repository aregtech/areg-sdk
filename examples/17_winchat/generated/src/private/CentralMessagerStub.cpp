//////////////////////////////////////////////////////////////////////////
// Begin generate generated/src/private/CentralMessagerStub.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2023
 *
 ...
 *
 * \file            generated/src/CentralMessagerStub.hpp
...
DEF_TRACE_SCOPE(generated_src_CentralMessagerStub_startupServiceInterface);
void CentralMessagerStub::startupServiceInterface( Component & holder )
{
    TRACE_SCOPE(generated_src_CentralMessagerStub_startupServiceInterface);
...
DEF_TRACE_SCOPE(generated_src_CentralMessagerStub_shutdownServiceIntrface);
void CentralMessagerStub::shutdownServiceIntrface( Component & holder )
{
    TRACE_SCOPE(generated_src_CentralMessagerStub_shutdownServiceIntrface);
...
DEF_TRACE_SCOPE(generated_src_CentralMessagerStub_sendNotification);
void CentralMessagerStub::sendNotification( unsigned int msgId )
{
    TRACE_SCOPE(generated_src_CentralMessagerStub_sendNotification);
...
DEF_TRACE_SCOPE(generated_src_CentralMessagerStub_errorRequest);
 ...
 ************************************************************************/
    ...
    {
        TRACE_SCOPE(generated_src_CentralMessagerStub_errorRequest);
...
{
    constexpr NECentralMessager::eMessageIDs msgId { NECentralMessager::eMessageIDs::MsgId_broadcastSendMessage };
...
{
    constexpr NECentralMessager::eMessageIDs msgId { NECentralMessager::eMessageIDs::MsgId_broadcastKeyTyping };
    EventDataStream args(EventDataStream::eEventData::EventDataExternal);
    IEOutStream & stream = args.getStreamForWrite();
    stream << nickName;
    stream << cookie;
...
{
    constexpr NECentralMessager::eMessageIDs msgId { NECentralMessager::eMessageIDs::MsgId_broadcastBroadcastMessage };
    EventDataStream args(EventDataStream::eEventData::EventDataExternal);
    IEOutStream & stream = args.getStreamForWrite();
...
DEF_TRACE_SCOPE(generated_src_CentralMessagerStub_processRequestEvent);
void CentralMessagerStub::processRequestEvent( ServiceRequestEvent & eventElem )
{
    ...
    if ( (reqEvent != nullptr) && (reqEvent->getRequestType() == NEService::eRequestType::CallFunction) )
    {
        ...
        default:
            {
                TRACE_SCOPE(generated_src_CentralMessagerStub_processRequestEvent);
...
DEF_TRACE_SCOPE(generated_src_CentralMessagerStub_processAttributeEvent);
void CentralMessagerStub::processAttributeEvent( ServiceRequestEvent & eventElem )
{
    ...
    else
    {
        ...
        else if (reqType == NEService::eRequestType::StartNotify)
        {
            ...
            {
                TRACE_SCOPE(generated_src_CentralMessagerStub_processAttributeEvent);
...
//////////////////////////////////////////////////////////////////////////
// End generate generated/src/private/CentralMessagerStub.cpp file
//////////////////////////////////////////////////////////////////////////
