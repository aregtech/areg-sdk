//////////////////////////////////////////////////////////////////////////
// Begin generate generated/src/private/DirectMessagerClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2023
 *
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerClientBase_serviceConnected);
bool DirectMessagerClientBase::serviceConnected( NEService::eServiceConnection status, ProxyBase & proxy )
{
    TRACE_SCOPE(generated_src_DirectMessagerClientBase_serviceConnected);
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerClientBase_processNotificationEvent);
void DirectMessagerClientBase::processNotificationEvent( NotificationEvent & eventElem )
{
    ...
    case NEService::eResultType::DataInvalid:
         ...
         ************************************************************************/
            ...
            default:
                {
                    TRACE_SCOPE(generated_src_DirectMessagerClientBase_processNotificationEvent);
 ...
 ************************************************************************/
DEF_TRACE_SCOPE(generated_src_DirectMessagerClientBase_invalidResponse);
void DirectMessagerClientBase::invalidResponse( NEDirectMessager::eMessageIDs InvalidRespId )
{
    TRACE_SCOPE(generated_src_DirectMessagerClientBase_invalidResponse);
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerClientBase_invalidRequest);
void DirectMessagerClientBase::invalidRequest( NEDirectMessager::eMessageIDs InvalidReqId )
{
    TRACE_SCOPE(generated_src_DirectMessagerClientBase_invalidRequest);
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerClientBase_requestFailed);
...
{
    TRACE_SCOPE(generated_src_DirectMessagerClientBase_requestFailed);
    ...
    msg_id index { static_cast<msg_id>( NEService::isResponseId(static_cast<unsigned int>(FailureMsgId)) ? NEDirectMessager::getRequestId(FailureMsgId) : FailureMsgId) };
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerClientBase_onChatParticipantsUpdate);
...
{
    TRACE_SCOPE(generated_src_DirectMessagerClientBase_onChatParticipantsUpdate);
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerClientBase_requestChatJoinFailed);
void DirectMessagerClientBase::requestChatJoinFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(generated_src_DirectMessagerClientBase_requestChatJoinFailed);
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerClientBase_requestMessageSendFailed);
void DirectMessagerClientBase::requestMessageSendFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(generated_src_DirectMessagerClientBase_requestMessageSendFailed);
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerClientBase_requestMessageTypeFailed);
void DirectMessagerClientBase::requestMessageTypeFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(generated_src_DirectMessagerClientBase_requestMessageTypeFailed);
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerClientBase_requestChatLeaveFailed);
void DirectMessagerClientBase::requestChatLeaveFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(generated_src_DirectMessagerClientBase_requestChatLeaveFailed);
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerClientBase_responseChatJoin);
...
{
    TRACE_SCOPE(generated_src_DirectMessagerClientBase_responseChatJoin);
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerClientBase_broadcastMessageSent);
...
{
    TRACE_SCOPE(generated_src_DirectMessagerClientBase_broadcastMessageSent);
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerClientBase_broadcastMessageTyped);
void DirectMessagerClientBase::broadcastMessageTyped( const NEDirectMessager::sParticipant & /* participant */, const String & /* msgText */ )
{
    TRACE_SCOPE(generated_src_DirectMessagerClientBase_broadcastMessageTyped);
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerClientBase_broadcastParticipantJoined);
...
{
    TRACE_SCOPE(generated_src_DirectMessagerClientBase_broadcastParticipantJoined);
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerClientBase_broadcastParticipantLeft);
...
{
    TRACE_SCOPE(generated_src_DirectMessagerClientBase_broadcastParticipantLeft);
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerClientBase_broadcastChatClosed);
void DirectMessagerClientBase::broadcastChatClosed( void )
{
    TRACE_SCOPE(generated_src_DirectMessagerClientBase_broadcastChatClosed);
...
//////////////////////////////////////////////////////////////////////////
// End generate generated/src/private/DirectMessagerClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
