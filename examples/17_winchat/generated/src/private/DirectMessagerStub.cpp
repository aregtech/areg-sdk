//////////////////////////////////////////////////////////////////////////
// Begin generate generated/src/private/DirectMessagerStub.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2023
 *
 ...
 *
 * \file            generated/src/DirectMessagerStub.hpp
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerStub_startupServiceInterface);
void DirectMessagerStub::startupServiceInterface( Component & holder )
{
    TRACE_SCOPE(generated_src_DirectMessagerStub_startupServiceInterface);
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerStub_shutdownServiceIntrface);
void DirectMessagerStub::shutdownServiceIntrface( Component & holder )
{
    TRACE_SCOPE(generated_src_DirectMessagerStub_shutdownServiceIntrface);
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerStub_sendNotification);
void DirectMessagerStub::sendNotification( unsigned int msgId )
{
    ...
    default:
        {
            TRACE_SCOPE(generated_src_DirectMessagerStub_sendNotification);
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerStub_errorRequest);
 ...
 ************************************************************************/
    ...
    {
        TRACE_SCOPE(generated_src_DirectMessagerStub_errorRequest);
...
{
    constexpr NEDirectMessager::eMessageIDs msgId { NEDirectMessager::eMessageIDs::MsgId_responseChatJoin };
    EventDataStream args(EventDataStream::eEventData::EventDataExternal);
    IEOutStream & stream = args.getStreamForWrite();
    stream << succeed;
...
{
    constexpr NEDirectMessager::eMessageIDs msgId { NEDirectMessager::eMessageIDs::MsgId_broadcastMessageSent };
    EventDataStream args(EventDataStream::eEventData::EventDataExternal);
    IEOutStream & stream = args.getStreamForWrite();
    stream << sender;
    stream << msgText;
...
{
    constexpr NEDirectMessager::eMessageIDs msgId { NEDirectMessager::eMessageIDs::MsgId_broadcastMessageTyped };
    EventDataStream args(EventDataStream::eEventData::EventDataExternal);
    IEOutStream & stream = args.getStreamForWrite();
    stream << participant;
    stream << msgText;
...
{
    constexpr NEDirectMessager::eMessageIDs msgId { NEDirectMessager::eMessageIDs::MsgId_broadcastParticipantJoined };
    EventDataStream args(EventDataStream::eEventData::EventDataExternal);
    IEOutStream & stream = args.getStreamForWrite();
    stream << participant;
    stream << timeJoined;
...
{
    constexpr NEDirectMessager::eMessageIDs msgId { NEDirectMessager::eMessageIDs::MsgId_broadcastParticipantLeft };
    EventDataStream args(EventDataStream::eEventData::EventDataExternal);
    IEOutStream & stream = args.getStreamForWrite();
    stream << participant;
    stream << timeLeft;
...
{
    constexpr NEDirectMessager::eMessageIDs msgId { NEDirectMessager::eMessageIDs::MsgId_broadcastChatClosed };
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerStub_processRequestEvent);
void DirectMessagerStub::processRequestEvent( ServiceRequestEvent & eventElem )
{
    ...
    if ( (reqEvent != nullptr) && (reqEvent->getRequestType() == NEService::eRequestType::CallFunction) )
    {
        ...
        default:
            {
                TRACE_SCOPE(generated_src_DirectMessagerStub_processRequestEvent);
...
DEF_TRACE_SCOPE(generated_src_DirectMessagerStub_processAttributeEvent);
void DirectMessagerStub::processAttributeEvent( ServiceRequestEvent & eventElem )
{
    ...
    else
    {
        ...
        else if (reqType == NEService::eRequestType::StartNotify)
        {
            ...
            {
                TRACE_SCOPE(generated_src_DirectMessagerStub_processAttributeEvent);
...
//////////////////////////////////////////////////////////////////////////
// End generate generated/src/private/DirectMessagerStub.cpp file
//////////////////////////////////////////////////////////////////////////
