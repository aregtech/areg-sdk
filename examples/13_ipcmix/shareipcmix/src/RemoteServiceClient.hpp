#ifndef AREG_EXAMPLES_13_IPCMIX_SHAREIPCMIX_REMOTESERVICECLIENT_HPP
#define AREG_EXAMPLES_13_IPCMIX_SHAREIPCMIX_REMOTESERVICECLIENT_HPP
/************************************************************************
 * \file        shareipcmix/src/RemoteServiceClient.hpp
...
public:
     ...
     * \brief   Destructor
     **/
    virtual ~RemoteServiceClient(void);
...
//////////////////////////////////////////////////////////////////////////
private:
    RemoteServiceClient( void );
    RemoteServiceClient( const RemoteServiceClient & /*src*/ );
    const RemoteServiceClient & operator = ( const RemoteServiceClient & /*src*/ );
};
...
#endif // AREG_EXAMPLES_13_IPCMIX_SHAREIPCMIX_REMOTESERVICECLIENT_HPP
