//////////////////////////////////////////////////////////////////////////
// Begin generate shareipcmix/src/SystemShutdownClientBase.hpp file
//////////////////////////////////////////////////////////////////////////
#ifndef  SHAREIPCMIX_SRC_SYSTEMSHUTDOWNCLIENTBASE_HPP
#define  SHAREIPCMIX_SRC_SYSTEMSHUTDOWNCLIENTBASE_HPP
/************************************************************************
 * (c) copyright    2021
...
/************************************************************************
 * \file            shareipcmix/src/SystemShutdownClientBase.hpp
 * \ingroup         SystemShutdown Service Interface
 * \brief           This is an automatic generated code of SystemShutdown Service Interface Client base class declaration.
 ************************************************************************/
...
#include "shareipcmix/src/private/SystemShutdownProxy.hpp"
...
protected:
     ...
     **/
    SystemShutdownClientBase( const char* roleName, const char * ownerThread = static_cast<const char *>(NULL) );
     ...
     **/
    SystemShutdownClientBase( const char* roleName, DispatcherThread & ownerThread );
     ...
     **/
    SystemShutdownClientBase( const char* roleName, Component & owner );
...
//////////////////////////////////////////////////////////////////////////
private:
    SystemShutdownClientBase( void );
    SystemShutdownClientBase( const SystemShutdownClientBase & /* src */ );
    const SystemShutdownClientBase & operator = ( const SystemShutdownClientBase & /* src */ );
};
...
{
    notifyOn( NESystemShutdown::MSG_ID_ServiceState, notify, false );
}
...
{
    notifyOn(NESystemShutdown::MSG_ID_broadcastServiceUnavailable, notify, false);
}

inline void SystemShutdownClientBase::notifyOnBroadcastServiceShutdown( bool notify /* = true */ )
{
    notifyOn(NESystemShutdown::MSG_ID_broadcastServiceShutdown, notify, false);
}
...
#endif   // SHAREIPCMIX_SRC_SYSTEMSHUTDOWNCLIENTBASE_HPP

//////////////////////////////////////////////////////////////////////////
// End generate shareipcmix/src/SystemShutdownClientBase.hpp file
//////////////////////////////////////////////////////////////////////////
