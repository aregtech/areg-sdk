//////////////////////////////////////////////////////////////////////////
// Begin generate shareipcmix/src/SystemShutdownStub.hpp file
//////////////////////////////////////////////////////////////////////////
#ifndef  SHAREIPCMIX_SRC_SYSTEMSHUTDOWNSTUB_HPP
#define  SHAREIPCMIX_SRC_SYSTEMSHUTDOWNSTUB_HPP
/************************************************************************
 * (c) copyright    2021
...
/************************************************************************
 * \file            shareipcmix/src/SystemShutdownStub.hpp
 * \ingroup         SystemShutdown Service Interface
 * \brief           This is an automatic generated code of SystemShutdown Service Interface Stub class declaration.
 ************************************************************************/
...
protected:
     ...
     **/
    SystemShutdownStub( Component & masterComp );
    /**
     * \brief   Destructor.
     **/
    virtual ~SystemShutdownStub( void );
...
//////////////////////////////////////////////////////////////////////////
private:
    SystemShutdownStub( void );
    SystemShutdownStub( const SystemShutdownStub & /* src */ );
    const SystemShutdownStub & operator = ( const SystemShutdownStub & /* src */ );
};
...
{
    return (mServiceStateState  == NEService::DATA_OK);
}

inline void SystemShutdownStub::invalidateServiceState( void )
{
    errorRequest( static_cast<unsigned int>(NESystemShutdown::MSG_ID_ServiceState), false );
}
...
#endif   // SHAREIPCMIX_SRC_SYSTEMSHUTDOWNSTUB_HPP

//////////////////////////////////////////////////////////////////////////
// End generate shareipcmix/src/SystemShutdownStub.hpp file
//////////////////////////////////////////////////////////////////////////
