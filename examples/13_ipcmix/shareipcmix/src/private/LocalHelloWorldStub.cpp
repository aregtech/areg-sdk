//////////////////////////////////////////////////////////////////////////
// Begin generate shareipcmix/src/private/LocalHelloWorldStub.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2021
...
/************************************************************************
 * \file            shareipcmix/src/private/LocalHelloWorldStub.cpp
...
DEF_TRACE_SCOPE(shareipcmix_src_LocalHelloWorldStub_startupServiceInterface);
void LocalHelloWorldStub::startupServiceInterface( Component & holder )
{
    TRACE_SCOPE(shareipcmix_src_LocalHelloWorldStub_startupServiceInterface);
...
DEF_TRACE_SCOPE(shareipcmix_src_LocalHelloWorldStub_shutdownServiceIntrface);
void LocalHelloWorldStub::shutdownServiceIntrface( Component & holder )
{
    TRACE_SCOPE(shareipcmix_src_LocalHelloWorldStub_shutdownServiceIntrface);
...
DEF_TRACE_SCOPE(shareipcmix_src_LocalHelloWorldStub_sendNotification);
void LocalHelloWorldStub::sendNotification( unsigned int msgId )
{
    ...
    default:
        {
            TRACE_SCOPE(shareipcmix_src_LocalHelloWorldStub_sendNotification);
...
DEF_TRACE_SCOPE(shareipcmix_src_LocalHelloWorldStub_errorRequest);
 ...
 ************************************************************************/
    ...
    {
        TRACE_SCOPE(shareipcmix_src_LocalHelloWorldStub_errorRequest);
...
DEF_TRACE_SCOPE(shareipcmix_src_LocalHelloWorldStub_processRequestEvent);
void LocalHelloWorldStub::processRequestEvent( ServiceRequestEvent & eventElem )
{
    ...
    if ( (reqEvent != static_cast<LocalHelloWorldRequestEvent *>(NULL)) && (reqEvent->getRequestType() == NEService::REQUEST_CALL) )
    {
        ...
        default:
            {
                TRACE_SCOPE(shareipcmix_src_LocalHelloWorldStub_processRequestEvent);
...
DEF_TRACE_SCOPE(shareipcmix_src_LocalHelloWorldStub_processAttributeEvent);
void LocalHelloWorldStub::processAttributeEvent( ServiceRequestEvent & eventElem )
{
    ...
    else
    {
        ...
        else if (reqType == NEService::REQUEST_START_NOTIFY)
        {
            ...
            {
                TRACE_SCOPE(shareipcmix_src_LocalHelloWorldStub_processAttributeEvent);
...
//////////////////////////////////////////////////////////////////////////
// End generate shareipcmix/src/private/LocalHelloWorldStub.cpp file
//////////////////////////////////////////////////////////////////////////
