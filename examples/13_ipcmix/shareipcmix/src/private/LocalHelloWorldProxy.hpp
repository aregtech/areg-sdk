//////////////////////////////////////////////////////////////////////////
// Begin generate shareipcmix/src/private/LocalHelloWorldProxy.hpp file
//////////////////////////////////////////////////////////////////////////
#ifndef  SHAREIPCMIX_SRC_PRIVATE_LOCALHELLOWORLDPROXY_HPP
#define  SHAREIPCMIX_SRC_PRIVATE_LOCALHELLOWORLDPROXY_HPP
/************************************************************************
 * (c) copyright    2021
...
/************************************************************************
 * \file            shareipcmix/src/private/LocalHelloWorldProxy.hpp
 * \ingroup         LocalHelloWorld Service Interface
 * \brief           This is an automatic generated code of LocalHelloWorld Service Interface Proxy class declaration.
 ************************************************************************/
...
private:
    ...
    public:
         ...
         **/
        LocalHelloWorldServiceAvailableEvent( IENotificationEventConsumer & consumer );
        /**
         * \brief   Destructor
         **/
        virtual ~LocalHelloWorldServiceAvailableEvent( void );
    //////////////////////////////////////////////////////////////////////////
    // Forbidden calls
    //////////////////////////////////////////////////////////////////////////
    private:
        LocalHelloWorldServiceAvailableEvent( void );
        LocalHelloWorldServiceAvailableEvent( const LocalHelloWorldServiceAvailableEvent & /*src*/ );
        const LocalHelloWorldServiceAvailableEvent & operator = ( const LocalHelloWorldServiceAvailableEvent & /*src*/ );
    };
//////////////////////////////////////////////////////////////////////////
...
public:
     ...
     **/
    static LocalHelloWorldProxy * createProxy( const char * roleName, IEProxyListener & connectListener, DispatcherThread & ownerThread );
     ...
     * \return  Returns pointer to instantiated proxy object.
     **/
    static LocalHelloWorldProxy * createProxy( const char * roleName, IEProxyListener & connectListener, const char * ownerThread = static_cast<const char *>(NULL) );
...
protected:
     ...
     *                      If NULL, current dispatching thread is used to dispatch messages.
     **/
    LocalHelloWorldProxy( const char * roleName, DispatcherThread * ownerThread = static_cast<DispatcherThread *>(NULL) );
    /**
     * \brief   Destructor
     **/
...
{
    return (getProxyData().getAttributeState(NELocalHelloWorld::MSG_ID_ConnectedClients) == NEService::DATA_OK);
}
...
{
    state = getProxyData().getAttributeState(NELocalHelloWorld::MSG_ID_ConnectedClients);
    return mConnectedClients;
}

inline bool LocalHelloWorldProxy::isRemainOutputValid( void ) const
{
    return (getProxyData().getAttributeState(NELocalHelloWorld::MSG_ID_RemainOutput) == NEService::DATA_OK);
}

inline short LocalHelloWorldProxy::getRemainOutput( NEService::eDataStateType & state ) const
{
    state = getProxyData().getAttributeState(NELocalHelloWorld::MSG_ID_RemainOutput);
...
//////////////////////////////////////////////////////////////////////////
// End generate shareipcmix/src/private/LocalHelloWorldProxy.hpp file
//////////////////////////////////////////////////////////////////////////
