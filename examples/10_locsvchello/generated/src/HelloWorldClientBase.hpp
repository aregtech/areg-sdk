...
{
    HelloWorldClientBase::notifyOn( NEHelloWorld::MSG_ID_ConnectedClients, notify, false );
}
...
{
    HelloWorldClientBase::notifyOn( NEHelloWorld::MSG_ID_RemainOutput, notify, false );
}
...
{
    HelloWorldClientBase::notifyOn(NEHelloWorld::MSG_ID_responseHelloWorld, notify, false);
}
...
{
    HelloWorldClientBase::notifyOn(NEHelloWorld::MSG_ID_broadcastHelloClients, notify, false);
}

inline void HelloWorldClientBase::notifyOnBroadcastServiceUnavailable( bool notify /* = true */ )
{
    HelloWorldClientBase::notifyOn(NEHelloWorld::MSG_ID_broadcastServiceUnavailable, notify, false);
}
