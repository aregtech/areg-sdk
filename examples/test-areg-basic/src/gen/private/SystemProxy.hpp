//////////////////////////////////////////////////////////////////////////
// Begin generate src/gen/private/SystemProxy.hpp file
//////////////////////////////////////////////////////////////////////////
#ifndef  SRC_GEN_PRIVATE_SYSTEMPROXY_HPP
#define  SRC_GEN_PRIVATE_SYSTEMPROXY_HPP
/************************************************************************
 * (c) copyright    2021
...
/************************************************************************
 * \file            src/gen/private/SystemProxy.hpp
...
//////////////////////////////////////////////////////////////////////////
// SystemProxy class declaration Begin
//////////////////////////////////////////////////////////////////////////
/**
...
private:
    //////////////////////////////////////////////////////////////////////////
    // SystemProxy::SystemServiceAvailableEvent class declaration
    //////////////////////////////////////////////////////////////////////////
    /**
     ...
     *  
     **/
    class SystemServiceAvailableEvent : public ProxyBase::ServiceAvailableEvent
    {
    //////////////////////////////////////////////////////////////////////////
    // Runtime internals
    //////////////////////////////////////////////////////////////////////////
        DECLARE_RUNTIME_EVENT(SystemProxy::SystemServiceAvailableEvent)
    ...
    public:
         ...
         **/
        SystemServiceAvailableEvent( IENotificationEventConsumer & consumer );
        /**
         * \brief   Destructor
         **/
        virtual ~SystemServiceAvailableEvent( void );
    //////////////////////////////////////////////////////////////////////////
    // Forbidden calls
    //////////////////////////////////////////////////////////////////////////
    private:
        SystemServiceAvailableEvent( void );
        SystemServiceAvailableEvent( const SystemServiceAvailableEvent & /*src*/ );
        const SystemServiceAvailableEvent & operator = ( const SystemServiceAvailableEvent & /*src*/ );
    };
//////////////////////////////////////////////////////////////////////////
// SystemProxy predefined constants and static members.
//////////////////////////////////////////////////////////////////////////
public:
    /**
     ...
     **/
    static SystemProxy * createProxy( const char * roleName, IEProxyListener & connectListener, DispatcherThread & ownerThread );
     ...
     * \return  Returns pointer to instantiated proxy object.
     **/
    static SystemProxy * createProxy( const char * roleName, IEProxyListener & connectListener, const char * ownerThread = static_cast<const char *>(NULL) );
...
protected:
     ...
     *                      If NULL, current dispatching thread is used to dispatch messages.
     **/
    SystemProxy( const char * roleName, DispatcherThread * ownerThread = static_cast<DispatcherThread *>(NULL) );
    /**
     * \brief   Destructor
     **/
    virtual ~SystemProxy( void );
 ...
 ************************************************************************/
     ...
     **/
    inline NESystem::eSystemState getSystemState( NEService::eDataStateType & state ) const;
 ...
 ************************************************************************/
     ...
     **/
    void updateData( SystemResponseEvent & eventElem, NESystem::eMessageIDs respId );
    /**
     ...
     **/
    void processResponse( SystemResponseEvent & evenElem );

    /**
     * \brief   returns reference SystemProxy object
     **/
    inline SystemProxy & self( void );
...
//////////////////////////////////////////////////////////////////////////
// SystemProxy class declaration End
//////////////////////////////////////////////////////////////////////////

//////////////////////////////////////////////////////////////////////////
// SystemProxy class inline functions implementation
//////////////////////////////////////////////////////////////////////////
...
inline void SystemProxy::setNotification( NESystem::eMessageIDs notifyId, IENotificationEventConsumer & listener, bool notifyAlways /* = false */ )
{
    ProxyBase::setNotification(static_cast<unsigned int>(notifyId), &listener, notifyAlways);
}

inline void SystemProxy::clearNotification( NESystem::eMessageIDs notifyId, IENotificationEventConsumer & listener )
{
    ProxyBase::clearNotification(static_cast<unsigned int>(notifyId), &listener);
}

inline void SystemProxy::clearAllNotifications( IENotificationEventConsumer & listener )
{
    ProxyBase::unregisterListener( &listener );
}

inline SystemProxy & SystemProxy::self( void )
{
    return (*this);
}
...
inline bool SystemProxy::isSystemStateValid( void ) const
{
    return (getProxyData().getAttributeState(NESystem::MSG_ID_SystemState) == NEService::DATA_OK);
}

inline NESystem::eSystemState SystemProxy::getSystemState( NEService::eDataStateType & state ) const
{
    state = getProxyData().getAttributeState(NESystem::MSG_ID_SystemState);
    return mSystemState;
}

#endif   // SRC_GEN_PRIVATE_SYSTEMPROXY_HPP

//////////////////////////////////////////////////////////////////////////
// End generate src/gen/private/SystemProxy.hpp file
//////////////////////////////////////////////////////////////////////////
