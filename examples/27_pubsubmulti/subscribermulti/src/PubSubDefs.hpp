...
/************************************************************************
 * \file        subscribermulti/src/PubSubDefs.hpp
...
namespace pubsub
{
    ...
    constexpr areg::ext::Console::Coord    CoordStatus    { 0, 3 };

    constexpr areg::ext::Console::Coord    Coord1Subtitle  { 0, 4 };
    constexpr areg::ext::Console::Coord    Coord1Integer   { 0, 5 };
    constexpr areg::ext::Console::Coord    Coord1String    { 0, 6 };

    constexpr areg::ext::Console::Coord    Coord2Subtitle  { 0, 7 };
    constexpr areg::ext::Console::Coord    Coord2Integer   { 0, 8 };
    constexpr areg::ext::Console::Coord    Coord2String    { 0, 9 };
}
