...
bool SubscriberSecond::serviceConnected( areg::eServiceConnection status, ProxyBase & proxy )
{
...
void SubscriberSecond::onServiceProviderStateUpdate(PubSub::eServiceState ServiceProviderState, areg::eDataStateType state)
{
