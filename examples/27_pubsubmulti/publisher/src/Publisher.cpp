...
DEF_LOG_SCOPE(examples_27_pubsubmulti_publisher_Publisher, consumer_connected);
DEF_LOG_SCOPE(examples_27_pubsubmulti_publisher_Publisher, start);
DEF_LOG_SCOPE(examples_27_pubsubmulti_publisher_Publisher, stop);
DEF_LOG_SCOPE(examples_27_pubsubmulti_publisher_Publisher, invalidate);
DEF_LOG_SCOPE(examples_27_pubsubmulti_publisher_Publisher, quit);
DEF_LOG_SCOPE(examples_27_pubsubmulti_publisher_Publisher, process_timer);
...
{
    LOG_SCOPE( examples_27_pubsubmulti_publisher_Publisher, consumer_connected);
...
{
    LOG_SCOPE( examples_27_pubsubmulti_publisher_Publisher, start );
...
void Publisher::stop()
{
    LOG_SCOPE( examples_27_pubsubmulti_publisher_Publisher, stop );
...
{
    LOG_SCOPE( examples_27_pubsubmulti_publisher_Publisher, invalidate );
...
void Publisher::quit()
{
    LOG_SCOPE( examples_27_pubsubmulti_publisher_Publisher, quit );
...
{
    LOG_SCOPE( examples_27_pubsubmulti_publisher_Publisher, process_timer );
