//////////////////////////////////////////////////////////////////////////
// Begin generate lightcommon/src/private/SimpleTrafficSwitchClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2021
...
/************************************************************************
 * \file            lightcommon/src/private/SimpleTrafficSwitchClientBase.cpp
 ...
 * Include files
 ************************************************************************/
#include "lightcommon/src/SimpleTrafficSwitchClientBase.hpp"
...
DEF_TRACE_SCOPE(lightcommon_src_SimpleTrafficSwitchClientBase_serviceConnected);
bool SimpleTrafficSwitchClientBase::serviceConnected( bool isConnected, ProxyBase & proxy )
{
    TRACE_SCOPE(lightcommon_src_SimpleTrafficSwitchClientBase_serviceConnected);
...
DEF_TRACE_SCOPE(lightcommon_src_SimpleTrafficSwitchClientBase_processNotificationEvent);
void SimpleTrafficSwitchClientBase::processNotificationEvent( NotificationEvent & eventElem )
{
    ...
    case NEService::RESULT_DATA_INVALID:
         ...
         ************************************************************************/
            ...
            default:
                {
                    TRACE_SCOPE(lightcommon_src_SimpleTrafficSwitchClientBase_processNotificationEvent);
 ...
 ************************************************************************/
DEF_TRACE_SCOPE(lightcommon_src_SimpleTrafficSwitchClientBase_invalidResponse);
void SimpleTrafficSwitchClientBase::invalidResponse( NESimpleTrafficSwitch::eMessageIDs InvalidRespId )
{
    TRACE_SCOPE(lightcommon_src_SimpleTrafficSwitchClientBase_invalidResponse);
...
DEF_TRACE_SCOPE(lightcommon_src_SimpleTrafficSwitchClientBase_invalidRequest);
void SimpleTrafficSwitchClientBase::invalidRequest( NESimpleTrafficSwitch::eMessageIDs InvalidReqId )
{
    TRACE_SCOPE(lightcommon_src_SimpleTrafficSwitchClientBase_invalidRequest);
...
DEF_TRACE_SCOPE(lightcommon_src_SimpleTrafficSwitchClientBase_requestFailed);
...
{
    TRACE_SCOPE(lightcommon_src_SimpleTrafficSwitchClientBase_requestFailed);
...
DEF_TRACE_SCOPE(lightcommon_src_SimpleTrafficSwitchClientBase_onIsSwitchedOnUpdate);
void SimpleTrafficSwitchClientBase::onIsSwitchedOnUpdate( bool /* IsSwitchedOn */, NEService::eDataStateType /* state */ )
{
    TRACE_SCOPE(lightcommon_src_SimpleTrafficSwitchClientBase_onIsSwitchedOnUpdate);
...
DEF_TRACE_SCOPE(lightcommon_src_SimpleTrafficSwitchClientBase_requestSwitchLightFailed);
void SimpleTrafficSwitchClientBase::requestSwitchLightFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(lightcommon_src_SimpleTrafficSwitchClientBase_requestSwitchLightFailed);
...
//////////////////////////////////////////////////////////////////////////
// End generate lightcommon/src/private/SimpleTrafficSwitchClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
