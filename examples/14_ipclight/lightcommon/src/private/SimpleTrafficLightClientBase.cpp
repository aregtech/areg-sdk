//////////////////////////////////////////////////////////////////////////
// Begin generate lightcommon/src/private/SimpleTrafficLightClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2021
...
/************************************************************************
 * \file            lightcommon/src/private/SimpleTrafficLightClientBase.cpp
 ...
 * Include files
 ************************************************************************/
#include "lightcommon/src/SimpleTrafficLightClientBase.hpp"
...
DEF_TRACE_SCOPE(lightcommon_src_SimpleTrafficLightClientBase_serviceConnected);
bool SimpleTrafficLightClientBase::serviceConnected( bool isConnected, ProxyBase & proxy )
{
    TRACE_SCOPE(lightcommon_src_SimpleTrafficLightClientBase_serviceConnected);
...
DEF_TRACE_SCOPE(lightcommon_src_SimpleTrafficLightClientBase_processNotificationEvent);
void SimpleTrafficLightClientBase::processNotificationEvent( NotificationEvent & eventElem )
{
    ...
    case NEService::RESULT_DATA_INVALID:
         ...
         ************************************************************************/
            ...
            default:
                {
                    TRACE_SCOPE(lightcommon_src_SimpleTrafficLightClientBase_processNotificationEvent);
 ...
 ************************************************************************/
DEF_TRACE_SCOPE(lightcommon_src_SimpleTrafficLightClientBase_invalidResponse);
void SimpleTrafficLightClientBase::invalidResponse( NESimpleTrafficLight::eMessageIDs InvalidRespId )
{
    TRACE_SCOPE(lightcommon_src_SimpleTrafficLightClientBase_invalidResponse);
...
DEF_TRACE_SCOPE(lightcommon_src_SimpleTrafficLightClientBase_invalidRequest);
void SimpleTrafficLightClientBase::invalidRequest( NESimpleTrafficLight::eMessageIDs InvalidReqId )
{
    TRACE_SCOPE(lightcommon_src_SimpleTrafficLightClientBase_invalidRequest);
...
DEF_TRACE_SCOPE(lightcommon_src_SimpleTrafficLightClientBase_requestFailed);
...
{
    TRACE_SCOPE(lightcommon_src_SimpleTrafficLightClientBase_requestFailed);
...
DEF_TRACE_SCOPE(lightcommon_src_SimpleTrafficLightClientBase_onSouthNorthUpdate);
...
{
    TRACE_SCOPE(lightcommon_src_SimpleTrafficLightClientBase_onSouthNorthUpdate);
...
DEF_TRACE_SCOPE(lightcommon_src_SimpleTrafficLightClientBase_onEastWestUpdate);
...
{
    TRACE_SCOPE(lightcommon_src_SimpleTrafficLightClientBase_onEastWestUpdate);
...
DEF_TRACE_SCOPE(lightcommon_src_SimpleTrafficLightClientBase_broadcastLightChanged);
...
{
    TRACE_SCOPE(lightcommon_src_SimpleTrafficLightClientBase_broadcastLightChanged);
...
//////////////////////////////////////////////////////////////////////////
// End generate lightcommon/src/private/SimpleTrafficLightClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
