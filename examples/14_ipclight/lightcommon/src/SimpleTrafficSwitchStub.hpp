//////////////////////////////////////////////////////////////////////////
// Begin generate lightcommon/src/SimpleTrafficSwitchStub.hpp file
//////////////////////////////////////////////////////////////////////////
#ifndef  LIGHTCOMMON_SRC_SIMPLETRAFFICSWITCHSTUB_HPP
#define  LIGHTCOMMON_SRC_SIMPLETRAFFICSWITCHSTUB_HPP
/************************************************************************
 * (c) copyright    2021
...
/************************************************************************
 * \file            lightcommon/src/SimpleTrafficSwitchStub.hpp
 * \ingroup         SimpleTrafficSwitch Service Interface
 * \brief           This is an automatic generated code of SimpleTrafficSwitch Service Interface Stub class declaration.
 ************************************************************************/
...
protected:
     ...
     **/
    SimpleTrafficSwitchStub( Component & masterComp );
    /**
     * \brief   Destructor.
     **/
    virtual ~SimpleTrafficSwitchStub( void );
...
//////////////////////////////////////////////////////////////////////////
private:
    SimpleTrafficSwitchStub( void );
    SimpleTrafficSwitchStub( const SimpleTrafficSwitchStub & /* src */ );
    const SimpleTrafficSwitchStub & operator = ( const SimpleTrafficSwitchStub & /* src */ );
};
...
{
    return (mIsSwitchedOnState  == NEService::DATA_OK);
}

inline void SimpleTrafficSwitchStub::invalidateIsSwitchedOn( void )
{
    errorRequest( static_cast<unsigned int>(NESimpleTrafficSwitch::MSG_ID_IsSwitchedOn), false );
}
...
#endif   // LIGHTCOMMON_SRC_SIMPLETRAFFICSWITCHSTUB_HPP

//////////////////////////////////////////////////////////////////////////
// End generate lightcommon/src/SimpleTrafficSwitchStub.hpp file
//////////////////////////////////////////////////////////////////////////
