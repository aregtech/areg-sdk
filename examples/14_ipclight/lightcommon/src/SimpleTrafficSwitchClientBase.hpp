//////////////////////////////////////////////////////////////////////////
// Begin generate lightcommon/src/SimpleTrafficSwitchClientBase.hpp file
//////////////////////////////////////////////////////////////////////////
#ifndef  LIGHTCOMMON_SRC_SIMPLETRAFFICSWITCHCLIENTBASE_HPP
#define  LIGHTCOMMON_SRC_SIMPLETRAFFICSWITCHCLIENTBASE_HPP
/************************************************************************
 * (c) copyright    2021
...
/************************************************************************
 * \file            lightcommon/src/SimpleTrafficSwitchClientBase.hpp
 * \ingroup         SimpleTrafficSwitch Service Interface
 * \brief           This is an automatic generated code of SimpleTrafficSwitch Service Interface Client base class declaration.
 ************************************************************************/
...
protected:
     ...
     **/
    SimpleTrafficSwitchClientBase( const char* roleName, const char * ownerThread = static_cast<const char *>(NULL) );
...
//////////////////////////////////////////////////////////////////////////
private:
    SimpleTrafficSwitchClientBase( void );
    SimpleTrafficSwitchClientBase( const SimpleTrafficSwitchClientBase & /* src */ );
    const SimpleTrafficSwitchClientBase & operator = ( const SimpleTrafficSwitchClientBase & /* src */ );
};
...
{
    SimpleTrafficSwitchClientBase::notifyOn( NESimpleTrafficSwitch::MSG_ID_IsSwitchedOn, notify, false );
}
...
#endif   // LIGHTCOMMON_SRC_SIMPLETRAFFICSWITCHCLIENTBASE_HPP

//////////////////////////////////////////////////////////////////////////
// End generate lightcommon/src/SimpleTrafficSwitchClientBase.hpp file
//////////////////////////////////////////////////////////////////////////
