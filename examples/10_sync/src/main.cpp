...
protected:
    void onThreadRuns() override
    {
        ...
        gEventRun.lock(areg::common::WAIT_INFINITE);
        ...
        constexpr unsigned int waitTimeout{ areg::common::WAIT_1_MILLISECOND * 150 };
...
protected:
    void onThreadRuns() override
    {
        ...
        int waitResult = multiLock.lock(areg::common::WAIT_INFINITE, false, false);
...
int main()
{
...

    {
        ...
        helloThread.createThread(areg::common::DO_NOT_WAIT);
        ...
        goodbyeThread.createThread(areg::common::WAIT_INFINITE);
        ...
        goodbyeThread.shutdownThread(areg::common::WAIT_INFINITE);
