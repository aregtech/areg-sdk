//////////////////////////////////////////////////////////////////////////
// Begin generate examples/10_locsvc/private/HelloWorldClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2024
 *
 ...
 *
 * \file            examples/10_locsvc/HelloWorldClientBase.hpp
 ...
 * Include files
 ************************************************************************/
#include "examples/10_locsvc/HelloWorldClientBase.hpp"
...
DEF_TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_serviceConnected);
bool HelloWorldClientBase::serviceConnected( NEService::eServiceConnection status, ProxyBase & proxy )
{
    TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_serviceConnected);
...
DEF_TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_processNotificationEvent);
void HelloWorldClientBase::processNotificationEvent( NotificationEvent & eventElem )
{
    ...
    case NEService::eResultType::RequestOK:
         ...
         ************************************************************************/
            ...
            default:
                {
                    TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_processNotificationEvent);
 ...
 ************************************************************************/
DEF_TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_invalidResponse);
void HelloWorldClientBase::invalidResponse( NEHelloWorld::eMessageIDs InvalidRespId )
{
    TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_invalidResponse);
...
DEF_TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_invalidRequest);
void HelloWorldClientBase::invalidRequest( NEHelloWorld::eMessageIDs InvalidReqId )
{
    TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_invalidRequest);
...
DEF_TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_requestFailed);
void HelloWorldClientBase::requestFailed( NEHelloWorld::eMessageIDs FailureMsgId, NEService::eResultType FailureReason )
{
    TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_requestFailed);
...
DEF_TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_requestHelloWorldFailed);
void HelloWorldClientBase::requestHelloWorldFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_requestHelloWorldFailed);
...
DEF_TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_requestShutdownServiceFailed);
void HelloWorldClientBase::requestShutdownServiceFailed( NEService::eResultType FailureReason )
{
    TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_requestShutdownServiceFailed);
...
DEF_TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_responseHelloWorld);
void HelloWorldClientBase::responseHelloWorld( void )
{
    TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_responseHelloWorld);
...
DEF_TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_broadcastReachedMaximum);
void HelloWorldClientBase::broadcastReachedMaximum( int /* maxNumber */ )
{
    TRACE_SCOPE(examples_10_locsvc_HelloWorldClientBase_broadcastReachedMaximum);
...
//////////////////////////////////////////////////////////////////////////
// End generate examples/10_locsvc/private/HelloWorldClientBase.cpp file
//////////////////////////////////////////////////////////////////////////
