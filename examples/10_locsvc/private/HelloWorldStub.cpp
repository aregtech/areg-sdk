//////////////////////////////////////////////////////////////////////////
// Begin generate examples/10_locsvc/private/HelloWorldStub.cpp file
//////////////////////////////////////////////////////////////////////////
/************************************************************************
 * (c) copyright    2024
 *
 ...
 *
 * \file            examples/10_locsvc/HelloWorldStub.hpp
 ...
 * Includes
 ************************************************************************/
#include "examples/10_locsvc/HelloWorldStub.hpp"
...
DEF_TRACE_SCOPE(examples_10_locsvc_HelloWorldStub_startupServiceInterface);
void HelloWorldStub::startupServiceInterface( Component & holder )
{
    TRACE_SCOPE(examples_10_locsvc_HelloWorldStub_startupServiceInterface);
...
DEF_TRACE_SCOPE(examples_10_locsvc_HelloWorldStub_shutdownServiceIntrface);
void HelloWorldStub::shutdownServiceIntrface( Component & holder )
{
    TRACE_SCOPE(examples_10_locsvc_HelloWorldStub_shutdownServiceIntrface);
...
DEF_TRACE_SCOPE(examples_10_locsvc_HelloWorldStub_sendNotification);
void HelloWorldStub::sendNotification( unsigned int msgId )
{
    TRACE_SCOPE(examples_10_locsvc_HelloWorldStub_sendNotification);
...
DEF_TRACE_SCOPE(examples_10_locsvc_HelloWorldStub_errorRequest);
 ...
 ************************************************************************/
    ...
    {
        TRACE_SCOPE(examples_10_locsvc_HelloWorldStub_errorRequest);
...
DEF_TRACE_SCOPE(examples_10_locsvc_HelloWorldStub_processRequestEvent);
void HelloWorldStub::processRequestEvent( ServiceRequestEvent & eventElem )
{
    ...
    if ( (reqEvent != nullptr) && (reqEvent->getRequestType() == NEService::eRequestType::CallFunction) )
    {
        ...
        default:
            {
                TRACE_SCOPE(examples_10_locsvc_HelloWorldStub_processRequestEvent);
...
DEF_TRACE_SCOPE(examples_10_locsvc_HelloWorldStub_processAttributeEvent);
void HelloWorldStub::processAttributeEvent( ServiceRequestEvent & eventElem )
{
    ...
    else
    {
        ...
        else if (reqType == NEService::eRequestType::StartNotify)
        {
            ...
            {
                TRACE_SCOPE(examples_10_locsvc_HelloWorldStub_processAttributeEvent);
...
//////////////////////////////////////////////////////////////////////////
// End generate examples/10_locsvc/private/HelloWorldStub.cpp file
//////////////////////////////////////////////////////////////////////////
