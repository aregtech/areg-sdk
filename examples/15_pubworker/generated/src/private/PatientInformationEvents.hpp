...
public:
     ...
     **/
    PatientInformationResponseEvent( const ProxyAddress & proxyTarget, NEService::eResultType result, unsigned int responseId, const SequenceNumber &  seqNr = NEService::SEQUENCE_NUMBER_NOTIFY );
    /**
     ...
     * \param   seqNr       The sequence number of response call. By default it is NEService::SEQUENCE_NUMBER_NOTIFY.
     **/
    PatientInformationResponseEvent( const EventDataStream & args, const ProxyAddress & proxyTarget, NEService::eResultType result, unsigned int responseId, const SequenceNumber &  seqNr = NEService::SEQUENCE_NUMBER_NOTIFY );
    /**
