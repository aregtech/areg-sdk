...
DEF_LOG_SCOPE(examples_13_pubmesh_common_LocalHelloWorldClient_serviceConnected);
DEF_LOG_SCOPE(examples_13_pubmesh_common_LocalHelloWorldClient_responseHelloWorld);
DEF_LOG_SCOPE(examples_13_pubmesh_common_LocalHelloWorldClient_onServiceStateUpdate);
DEF_LOG_SCOPE(examples_13_pubmesh_common_LocalHelloWorldClient_processTimer);
...
{
    LOG_SCOPE(examples_13_pubmesh_common_LocalHelloWorldClient_serviceConnected);
...
{
    LOG_SCOPE(examples_13_pubmesh_common_LocalHelloWorldClient_responseHelloWorld);
...
{
    LOG_SCOPE(examples_13_pubmesh_common_LocalHelloWorldClient_processTimer);
    ASSERT( &timer == &mTimer );
