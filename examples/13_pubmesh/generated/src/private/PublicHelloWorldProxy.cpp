...
RemoteResponseEvent * PublicHelloWorldProxy::createRemoteRequestFailedEvent(const ProxyAddress & addrProxy, unsigned int msgId, NEService::eResultType reason, const SequenceNumber &  seqNr) const
{
...
const SequenceNumber &  PublicHelloWorldProxy::requestRegister( IENotificationEventConsumer & caller, const String & name, const ServiceAddress & service, const String & thread, const String & process )
{
...
const SequenceNumber &  PublicHelloWorldProxy::requestHelloWorld( IENotificationEventConsumer & caller, unsigned int clientID )
{
