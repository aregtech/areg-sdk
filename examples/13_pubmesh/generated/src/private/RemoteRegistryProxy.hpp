//////////////////////////////////////////////////////////////////////////
// Begin generate generated/src/private/RemoteRegistryProxy.hpp file
//////////////////////////////////////////////////////////////////////////
#ifndef  GENERATED_SRC_PRIVATE_REMOTEREGISTRYPROXY_HPP
#define  GENERATED_SRC_PRIVATE_REMOTEREGISTRYPROXY_HPP
...
private:
    ...
    public:
         ...
         **/
        explicit RemoteRegistryServiceAvailableEvent( IENotificationEventConsumer & consumer );
        /**
         * \brief   Destructor.
         **/
        virtual ~RemoteRegistryServiceAvailableEvent( void ) = default;
    //////////////////////////////////////////////////////////////////////////
    // Forbidden calls
    //////////////////////////////////////////////////////////////////////////
    private:
        RemoteRegistryServiceAvailableEvent( void ) = delete;
        DECLARE_NOCOPY_NOMOVE( RemoteRegistryServiceAvailableEvent );
    };
//////////////////////////////////////////////////////////////////////////
...
public:
     ...
     **/
    static RemoteRegistryProxy * createProxy( const String & roleName, IEProxyListener & connectListener, DispatcherThread & ownerThread );
     ...
     * \return  Returns pointer to instantiated proxy object.
     **/
    static RemoteRegistryProxy * createProxy( const String & roleName, IEProxyListener & connectListener, const String & ownerThread = String::EmptyString );
...
protected:
     ...
     *                      If nullptr, current dispatching thread is used to dispatch messages.
     **/
    explicit RemoteRegistryProxy( const String & roleName, DispatcherThread * ownerThread = nullptr );
    /**
     * \brief   Destructor
     **/
...
//////////////////////////////////////////////////////////////////////////
private:
    RemoteRegistryProxy( void ) = delete;
    DECLARE_NOCOPY_NOMOVE( RemoteRegistryProxy );
};
...
{
    return (getProxyData().getAttributeState( static_cast<msg_id>(NERemoteRegistry::eMessageIDs::MsgId_RegistryList) ) == NEService::eDataStateType::DataIsOK);
}

inline const NERemoteRegistry::ListRegistry & RemoteRegistryProxy::getRegistryList( NEService::eDataStateType & state ) const
{
    state = getProxyData().getAttributeState( static_cast<msg_id>(NERemoteRegistry::eMessageIDs::MsgId_RegistryList) );
    return mRegistryList;
}

inline bool RemoteRegistryProxy::isRemainOutputsValid( void ) const
{
    return (getProxyData().getAttributeState( static_cast<msg_id>(NERemoteRegistry::eMessageIDs::MsgId_RemainOutputs) ) == NEService::eDataStateType::DataIsOK);
}

inline unsigned int RemoteRegistryProxy::getRemainOutputs( NEService::eDataStateType & state ) const
{
    state = getProxyData().getAttributeState( static_cast<msg_id>(NERemoteRegistry::eMessageIDs::MsgId_RemainOutputs) );
...
#endif   // GENERATED_SRC_PRIVATE_REMOTEREGISTRYPROXY_HPP

//////////////////////////////////////////////////////////////////////////
// End generate generated/src/private/RemoteRegistryProxy.hpp file
//////////////////////////////////////////////////////////////////////////
