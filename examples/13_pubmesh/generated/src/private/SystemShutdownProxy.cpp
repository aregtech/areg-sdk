...
{
    ProxyBase::ServiceAvailableEvent* event = static_cast<ProxyBase::ServiceAvailableEvent *>( DEBUG_NEW SystemShutdownProxy::SystemShutdownServiceAvailableEvent(consumer) );
    if (event != nullptr)
    {
