...
{
    ProxyBase::ServiceAvailableEvent* event = static_cast<ProxyBase::ServiceAvailableEvent *>( DEBUG_NEW LocalHelloWorldProxy::LocalHelloWorldServiceAvailableEvent(consumer) );
    if (event != nullptr)
    {
