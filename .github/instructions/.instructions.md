...
| Namespaces                    | `snake_case`              | `ipc`                                 |
| areg SDK namespace start      | `AREG_NAMESPACE_BEGIN`    | `AREG_NAMESPACE_BEGIN`                |
| areg SDK namespace end        | `AREG_NAMESPACE_END`      | `AREG_NAMESPACE_END`                  |
| areg SDK namespace use        | `AREG_NAMESPACE_USE`      | `AREG_NAMESPACE_USE`                  |

**Note:** The Areg SDK namespace macros (`AREG_NAMESPACE_BEGIN`, `AREG_NAMESPACE_END`, `AREG_NAMESPACE_USE`) should be used consistently in all
headers and source files to ensure proper namespace management across the project. These macros ensure visibility of the Areg SDK code and
can be enabled or disabled via `AREG_NAMESPACE` compiler option.
