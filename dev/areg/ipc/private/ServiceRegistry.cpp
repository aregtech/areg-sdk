...
DEF_TRACE_SCOPE(areg_ipc_private_ServiceRegistry_registerServiceProxy);
DEF_TRACE_SCOPE(areg_ipc_private_ServiceRegistry_unregisterServiceProxy);
DEF_TRACE_SCOPE(areg_ipc_private_ServiceRegistry_registerServiceStub);
DEF_TRACE_SCOPE(areg_ipc_private_ServiceRegistry_unregisterServiceStub);
DEF_TRACE_SCOPE(areg_ipc_private_ServiceRegistry_getServiceList);
DEF_TRACE_SCOPE(areg_ipc_private_ServiceRegistry_getServiceSources);
DEF_TRACE_SCOPE(areg_ipc_private_ServiceRegistry_disconnectProxy);
...
{
    TRACE_SCOPE(areg_ipc_private_ServiceRegistry_registerServiceProxy);
...
{
    TRACE_SCOPE(areg_ipc_private_ServiceRegistry_unregisterServiceProxy);
    MAPPOS pos = findService( static_cast<const ServiceAddress &>(addrProxy) );
    if ( pos != NULL )
    {
        ServiceBlock * block = reinterpret_cast<ServiceBlock *>(pos);
...
{
    TRACE_SCOPE(areg_ipc_private_ServiceRegistry_registerServiceStub);
...
{
    TRACE_SCOPE(areg_ipc_private_ServiceRegistry_unregisterServiceStub);
    MAPPOS pos = findService( static_cast<const ServiceAddress &>(addrStub) );
    if ( pos != NULL )
    {
        ServiceBlock * block = reinterpret_cast<ServiceBlock *>(pos);
...
{
    TRACE_SCOPE(areg_ipc_private_ServiceRegistry_getServiceList);
...
{
    TRACE_SCOPE(areg_ipc_private_ServiceRegistry_getServiceSources);
...
{
    TRACE_SCOPE(areg_ipc_private_ServiceRegistry_disconnectProxy);
    MAPPOS pos = findService( static_cast<const ServiceAddress &>(addrProxy) );
    ServiceBlock * block = reinterpret_cast<ServiceBlock *>(pos);
    if ( block != NULL )
    {
