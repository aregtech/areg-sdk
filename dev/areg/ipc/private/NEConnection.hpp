...
namespace NEConnection
{
     ...
     **/
    RemoteMessage createBrokerRegisterService( const StubAddress & stub, ITEM_ID source );
    /**
     ...
     * \param   source  The ID of source, which initiates message.
     **/
    RemoteMessage createBrokerUnregisterService( const StubAddress & stub, ITEM_ID source );
    /**
     ...
     * \param   source  The ID of source, which initiates message.
     **/
    RemoteMessage createBrokerRegisterClient( const ProxyAddress & proxy, ITEM_ID source );
    /**
     ...
     * \param   source  The ID of source, which initiates message.
     **/
    RemoteMessage createBrokerUnregisterClient( const ProxyAddress & proxy, ITEM_ID source );
    /**
