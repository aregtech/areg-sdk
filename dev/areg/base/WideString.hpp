...
//////////////////////////////////////////////////////////////////////////
/**
 * \brief   Wide-char ASCII string class declaration. Has basic functionalities
...
public:
     ...
     **/
    static const wchar_t * const   BOOLEAN_TRUE    /*= L"true"*/; //!< Boolean value 'true' as string
    /**
...
public:
     ...
     **/
    const WideString & operator = ( const WideString & strSource );
     ...
     * \return  Returns the string object.
     **/
    const WideString & operator = ( const wchar_t * strSource );
     ...
     * \return  Returns the string object.
     **/
    const WideString & operator = ( const char * strSource );
     ...
     * \return  Returns the string object.
     **/
    const WideString & operator = ( wchar_t chSource );
     ...
     * \return  Returns the string object.
     **/
    const WideString & operator = ( const String & strSource );
     ...
     **/
    WideString & operator += ( const WideString & strSource );
     ...
     * \return  Returns string object
     **/
    WideString & operator += ( const wchar_t * strSource );
     ...
     * \return  Returns string object
     **/
    WideString & operator += ( const char * strSource );

    /**
     * \brief   Appends given wide string at the end of existing string.
     * \param   strSource   The source of 8-bit string to append at the end
     * \return  Returns string object
     **/
    WideString & operator += (const String & strSource);
...
/************************************************************************/
     ...
     **/
    friend AREG_API WideString operator + (const wchar_t chLhs, const WideString & rhs);
...
/************************************************************************/
     ...
     *
     * \example WideString::getSubstring()
     * 
     ...
     *  WideString result3 = WideString::getSubstring( next, L"0123", &next);   // results: result3 == L""          , next == NULL;
     *  
     ...
     *  WideString result7 = WideString::getSubstring( next, L" ", &next);      // results: result7 == L"0123"      , next == NULL;
     **/
    static WideString getSubstring( const wchar_t * strSource, const wchar_t * strPhrase, const wchar_t ** out_next = static_cast<const wchar_t **>(NULL) );
     ...
     **/
    static int32_t makeInt32( const wchar_t * strDigit, NEString::eRadix radix = NEString::RadixDecimal, const wchar_t ** end = static_cast<const wchar_t **>(NULL) );
    /**
     ...
     **/
    static uint32_t makeUInt32( const wchar_t * strDigit, NEString::eRadix radix = NEString::RadixDecimal, const wchar_t ** end = static_cast<const wchar_t **>(NULL) );
    /**
     ...
     **/
    static int64_t makeInt64( const wchar_t * strDigit, NEString::eRadix radix = NEString::RadixDecimal, const wchar_t ** end = static_cast<const wchar_t **>(NULL) );
    /**
     ...
     **/
    static uint64_t makeUInt64( const wchar_t * strDigit, NEString::eRadix radix = NEString::RadixDecimal, const wchar_t ** end = static_cast<const wchar_t **>(NULL) );
    /**
     ...
     **/
    static float makeFloat( const wchar_t * strDigit, const wchar_t ** end = static_cast<const wchar_t **>(NULL) );
    /**
    ...
    **/
    static double makeDouble( const wchar_t * strDigit, const wchar_t ** end = static_cast<const wchar_t **>(NULL) );
    /**
     ...
     * \return  Returns the 64-bit digit with floating point
     **/
    static bool makeBool( const wchar_t * strBoolean, const wchar_t ** end = static_cast<const wchar_t **>(NULL) );
     ...
     **/
    static WideString int32ToString( int32_t number, NEString::eRadix radix = NEString::RadixDecimal );
    /**
     ...
     * \return  Returns converted string.
     **/
    static WideString uint32ToString( uint32_t number, NEString::eRadix radix = NEString::RadixDecimal );
    /**
     ...
     * \return  Returns converted string.
     **/
    static WideString int64ToString( int64_t number, NEString::eRadix radix = NEString::RadixDecimal );
    /**
     ...
     * \return  Returns converted string.
     **/
    static WideString uint64ToString( uint64_t number, NEString::eRadix radix = NEString::RadixDecimal );
    /**
...
/************************************************************************/
     ...
     **/
    inline WideString substring( NEString::CharPos startPos = NEString::StartPos, NEString::CharCount charCount = NEString::CountAll ) const;
     ...
     *  next = test.substring(result, L"0123", next);   // results: next == NEString::EndPos, result == L" 456 789 "
     *
     ...
     *  next = test.substring(result, L" ", next);      // results: next == NEString::InvalidPos, result == L"0123"
     **/
    inline NEString::CharPos substring( WideString & outResult, const wchar_t * strPhrase, NEString::CharPos startPos = NEString::StartPos ) const;
     ...
     *              -   NEString::InvalidPos if could not find the phrase.
     **/
    inline NEString::CharPos substring( WideString & outResult, wchar_t chSymbol, NEString::CharPos startPos = NEString::StartPos ) const;
     ...
     **/
    inline WideString & convFromInt32( int32_t value, NEString::eRadix radix = NEString::RadixDecimal );
     ...
     *          are filled with 
     **/
    inline WideString & convFromUInt32( uint32_t value, NEString::eRadix radix = NEString::RadixDecimal );
    /**
     ...
     *          might make sense to use FromUInt32 method.
     **/
    inline WideString & convFromInt64( int64_t value, NEString::eRadix radix = NEString::RadixDecimal );
    /**
     ...
     *          are filled with 
     **/
    inline WideString & convFromUInt64( uint64_t value, NEString::eRadix radix = NEString::RadixDecimal );
    /**
...
{
    return ((getLength() == 1) && (static_cast<char>(getAt(0)) == ch));
}
...
inline NEString::CharPos WideString::substring( WideString & outResult, const wchar_t * strPhrase, NEString::CharPos startPos /*= NEString::StartPos*/ ) const
{   
    return TEString<wchar_t>::substring( outResult, strPhrase, startPos );
}

inline NEString::CharPos WideString::substring( WideString & outResult, const wchar_t chSymbol, NEString::CharPos startPos /*= NEString::StartPos */ ) const
{
...
{
    return WideString::makeInt32(getString(), radix, static_cast<const wchar_t **>(NULL) );
}

inline uint32_t WideString::convToUInt32( NEString::eRadix radix /*= NEString::RadixDecimal */ ) const
{
    return WideString::makeUInt32(getString(), radix, static_cast<const wchar_t **>(NULL) );
}

inline int64_t WideString::convToInt64( NEString::eRadix radix /*= NEString::RadixDecimal */ ) const
{
    return WideString::makeInt64(getString(), radix, static_cast<const wchar_t **>(NULL) );
}

inline uint64_t WideString::convToUInt64( NEString::eRadix radix /*= NEString::RadixDecimal */ ) const
{
    return WideString::makeUInt64(getString(), radix, static_cast<const wchar_t **>(NULL) );
}

inline float WideString::convToFloat( void ) const
{
    return WideString::makeFloat(getString(), static_cast<const wchar_t **>(NULL) );
}

inline double WideString::convToDouble( void ) const
{
    return WideString::makeDouble(getString(), static_cast<const wchar_t **>(NULL) );
}

inline bool WideString::convToBool( void ) const
{
    return (NEString::compareIgnoreCase<wchar_t, wchar_t>( getString(), BOOLEAN_TRUE ) == 0);
}
