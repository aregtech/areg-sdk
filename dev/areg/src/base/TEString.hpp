...
/************************************************************************
 * \file        areg/src/base/TEString.hpp
...
public:
     ...
     **/
    bool Substr( TEString<CharType, Implement> & outResult, NEString::CharPos startPos = NEString::StartPos, NEString::CharCount charCount = NEString::CountAll ) const;
     ...
     * \endcode
     **/
    NEString::CharPos Substr( TEString<CharType, Implement> & outResult, const CharType * strPhrase, NEString::CharPos startPos = NEString::StartPos ) const;
     ...
     *              -   NEString::InvalidPos if could not find the phrase.
     **/
    NEString::CharPos Substr( TEString<CharType, Implement> & outResult, CharType chSymbol, NEString::CharPos startPos = NEString::StartPos ) const;
     ...
     **/
    NEString::CharCount CopyString( const CharType * strSource, NEString::CharCount charCount = NEString::CountAll );
     ...
     **/
    NEString::CharCount AppendString( const CharType * strSource, NEString::CharCount charCount = NEString::CountAll );
     ...
     **/
    void Insert( CharType chSource, NEString::CharPos atPos );
     ...
     **/
    void Insert( const CharType * strSource, NEString::CharPos atPos, NEString::CharCount charCount = NEString::CountAll );
     ...
     *                      By default it inserts complete source of string.
     **/
    void Insert( const TEString<CharType, Implement> & strSrc, NEString::CharPos atPos, NEString::CharCount charCount = NEString::CountAll );
     ...
     **/
    inline bool ValidateString( const CharType * validityList ) const;
    ...
    /**
     * \brief   Returns the length of allocated string buffer.
     *          THe allocated string buffer size is more or equal to string length.
     **/
    inline NEString::CharCount GetBufferSize( void ) const;

    /**
     * \brief   Returns occupied size of buffer, including null-terminated character of string.
     **/
    inline unsigned int GetOccupiedBytes( void ) const;
     ...
     **/
    inline const CharType * String( void ) const;
     ...
     **/
    inline CharType GetCharAt( NEString::CharPos atPos ) const;
     ...
     **/
    inline void SetCharAt( CharType ch, NEString::CharPos atPos = NEString::EndPos );
     ...
     **/
    inline bool EnsureSpace( NEString::CharCount maxSpace );
     ...
     *          rather than to provide certain business logic. Any direct modifications may 
     *          destabilize logic of object
     **/
    inline CharType *  UnsafeBuffer( void ) ;
...
protected:
     ...
     **/
    inline NEString::SString<CharType> & getString( void );

    /**
     * \brief   Returns string structure object valid only for reading.
     **/
    inline const NEString::SString<CharType> & getString( void ) const;
...
void TEString<CharType, Implement>::readStream( const IEInStream & stream )
{
    ...
    reallocate( static_cast<NEString::CharCount>(length), static_cast<NEString::eEncoding>(encode) );
    CharType * dst  = getChars(NEString::EndPos);

    int count = Implement::ImplReadStream(stream, dst, length);
...
template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
inline const NEString::SString<CharType> & TEString<CharType, Implement>::getString( void ) const
{   return (IsValid( ) ? *mData : *NEString::getInvalidString<CharType>( ));            }

template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
inline NEString::SString<CharType> & TEString<CharType, Implement>::getString( void )
{   return (IsValid( ) ? *mData : *NEString::getInvalidString<CharType>( ));            }
...
NEString::CharPos TEString<CharType, Implement>::FindLastOf( CharType chSearch, NEString::CharPos startPos /*= NEString::EndPos*/, bool caseSensitive /*= true*/ ) const
{
    ...
    if ( canRead( startPos ) )
    {
        ...
        const CharType * begin  = GetBuffer();
...
template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
bool TEString<CharType, Implement>::Substr(TEString<CharType, Implement> & outResult, NEString::CharPos startPos /* = NEString::StartPos */, NEString::CharCount charCount /*= NEString::CountAll*/ ) const
{
    bool result = false;
    outResult.release();
    ...
    if ( canRead(startPos) )
    {
        ...
        result = outResult.CopyString(buffer, charCount) != 0;
    }
    return result;
}

template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
NEString::CharPos TEString<CharType, Implement>::Substr( TEString<CharType, Implement> & outResult, const CharType * strPhrase, NEString::CharPos startPos /*= NEString::StartPos*/ ) const
{
    NEString::CharPos result= NEString::InvalidPos;
    const CharType * buffer = GetBuffer(startPos);
    const CharType * next   = static_cast<const CharType *>(NULL);

    NEString::CharPos pos   = NEString::searchFirstOf<CharType>(strPhrase, buffer, NEString::StartPos, &next);
    ...
    outResult.CopyString( buffer, pos != NEString::InvalidPos ? pos : NEString::CountAll );
...
template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
NEString::CharPos TEString<CharType, Implement>::Substr( TEString<CharType, Implement> & outResult, CharType chSymbol, NEString::CharPos startPos /* = NEString::StartPos */ ) const
{
    NEString::CharPos result = NEString::InvalidPos;
    const CharType * buffer = GetBuffer(startPos);
    const CharType * next = static_cast<const CharType *>(NULL);

    NEString::CharPos pos = NEString::searchFirstOf<CharType>(chSymbol, buffer, NEString::StartPos, &next);
    NEString::CharPos nextPos = next != static_cast<const CharType *>(NULL) ? startPos + static_cast<NEString::CharPos>(next - buffer) : NEString::InvalidPos;
    outResult.CopyString(buffer, pos != NEString::InvalidPos ? pos : NEString::CountAll);
...
template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
inline bool TEString<CharType, Implement>::IsInteger( bool signIgnore /*= true*/ ) const
{
    bool result = false;
    if ( IsValid() )
    {
...
template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
inline bool TEString<CharType, Implement>::IsStringAlphanumeric( void ) const
{
    bool result = false;
    if ( IsValid() )
    {
...
template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
inline bool TEString<CharType, Implement>::ValidateString( const CharType * validityList ) const
{
    bool result = false;
    if ( IsValid( ) && (NEString::isEmpty<CharType>(validityList) == false) )
    {
        result = true;
        for ( const CharType * src = getChars( NEString::StartPos ); result && (*src != static_cast<CharType>(NEString::EndOfString)); ++ src )
            result = NEString::searchFirstOf<CharType>(*src, validityList) != NEString::InvalidPos;
    }
    return result;
}
...
inline void TEString<CharType, Implement>::Truncate( NEString::CharCount maxChars )
{
    ...
    else if ( NEString::getBufferRequired<CharType>(maxChars) < GetBufferSize() )
    {
        ASSERT( isValidPtr() );
        NEString::SString<CharType> * tmp = NEString::initString<CharType>(GetBuffer(), maxChars, mEncode);
...
inline void TEString<CharType, Implement>::Remove( NEString::CharPos startPos, NEString::CharCount charCount /*= NEString::CountAll*/ )
{
    ...
    {
        NEString::CharCount length = GetLength();
        NEString::CharCount remain = length - startPos;
        charCount = MACRO_MIN(charCount, remain);
...
inline void TEString<CharType, Implement>::Compact( void )
{
    ...
    {
        NEString::CharCount length  = GetLength();
        NEString::CharCount space   = NEString::getBufferRequired<CharType>( length );
        if ( space < GetBufferSize() )
        {
            NEString::SString<CharType> * tmp = NEString::initString<CharType>( GetBuffer( ), length, mEncode );
            if ( tmp != static_cast<NEString::SString<CharType> *>(NULL) )
            {
                releaseSpace( mData );
                mData   = tmp;
...
template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
NEString::CharCount  TEString<CharType, Implement>::CopyString(const CharType * strSource, NEString::CharCount charCount /*= NEString::CountAll */)
{
    NEString::CharCount result = 0;

    charCount = charCount == NEString::CountAll ? NEString::getStringLength<CharType>(strSource) : charCount;
    EnsureSpace(charCount);
    if ( IsValid() )
    {
...
template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
NEString::CharCount  TEString<CharType, Implement>::AppendString(const CharType * strSource, NEString::CharCount charCount /*= NEString::CountAll*/)
{
    NEString::CharCount result = 0;
    charCount = charCount == NEString::CountAll ? NEString::getStringLength<CharType>(strSource) : charCount;
...
void TEString<CharType, Implement>::Swap( NEString::CharPos startPos /*= NEString::StartPos*/, NEString::CharCount charCount /*= NEString::CountAll*/ )
{
    if ( canRead(startPos) )
    {
        ...
        NEString::CharCount remain = length - startPos - 1;
        charCount = MACRO_MIN(charCount, remain);
...
template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
void TEString<CharType, Implement>::Insert( CharType chSrc, NEString::CharPos atPos )
{
    if ( Move(atPos, 1) != 0 )
...
template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
void TEString<CharType, Implement>::Insert( const CharType * strSrc, NEString::CharPos atPos, NEString::CharCount charCount /*= NEString::CountAll*/ )
{
...
template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
void TEString<CharType, Implement>::Insert( const TEString<CharType, Implement> & strSrc, NEString::CharPos atPos, NEString::CharCount charCount /*= NEString::CountAll*/ )
{
    Insert( strSrc.GetBuffer(), atPos, charCount);
}
...
NEString::CharPos TEString<CharType, Implement>::Replace( const TEString<CharType, Implement> & strOrigin, const TEString<CharType, Implement> & strReplace, NEString::CharPos startPos /*= NEString::StartPos*/, bool replaceAll /*= true*/ )
{
    ...
    if ( canRead( startPos ) )
    {
        ...
        {
            bool replacedOnce = false;
            const CharType * bufOrigin = strOrigin.GetBuffer();
            const CharType * bufReplace= strReplace.GetBuffer();
...
NEString::CharPos TEString<CharType, Implement>::Replace( const TEString<CharType, Implement> & strReplace, NEString::CharPos startPos, NEString::CharCount charsRemove )
{
    ...
    if ( canRead( startPos ) )
    {
        ...
        if ( (charsRemove != 0) && (lenReplace != 0) )
        {
            result = replaceWith( startPos, charsRemove, strReplace.GetBuffer(), lenReplace );
            ...
            Move( endPos, diff );
            CharType * dst = getChars( startPos );
            const CharType * src = strReplace.GetBuffer();
            while ( *src != static_cast<CharType>(NEString::EndofString) )
                *dst ++ = *src ++;
            result = endPos + diff;
            *****************************/
...
template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
inline unsigned int TEString<CharType, Implement>::GetBufferSize( void ) const
{   return (IsValid() ? mData->strSpace : 0);                                           }

template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
inline unsigned int TEString<CharType, Implement>::GetOccupiedBytes(void) const
...
template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
inline const CharType * TEString<CharType, Implement>::String( void ) const
...
template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
inline CharType TEString<CharType, Implement>::GetCharAt( NEString::CharPos atPos ) const
{   return (canRead(atPos) ? mData->strBuffer[atPos] : NEString::EndOfString);          }

template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
inline void TEString<CharType, Implement>::SetCharAt( CharType ch, NEString::CharPos atPos /*= NEString::EndPos*/ )
{   if ( isValidPtr() ) NEString::setAt<CharType, CharType>( *mData, ch, atPos );       }

template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
inline bool TEString<CharType, Implement>::EnsureSpace( NEString::CharCount maxSpace )
{
...
inline int TEString<CharType, Implement>::TrimLeft(TEString<CharType, Implement> & strResult) const
{
    ...
    if (IsEmpty() == false)
    {
        ...
        int remain = length - result;
        if (remain != 0)
        {
            ASSERT(remain > 0);
            strResult.CopyString(begin, remain);
        }
    }
    return result;
}
...
inline int TEString<CharType, Implement>::TrimRight(TEString<CharType, Implement> & strResult) const
{
    ...
    if (IsEmpty() == false)
    {
        int length = static_cast<int>(GetLength());
        const CharType * begin  = GetBuffer();
        const CharType * end    = getChars(length - 1);
...
template<typename CharType, class Implement /*= TEStringImpl<CharType>*/>
inline CharType * TEString<CharType, Implement>::UnsafeBuffer(void)
