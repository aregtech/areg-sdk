#ifndef AREG_COMPONENT_CECOMPONENTADDRESS_HPP
#define AREG_COMPONENT_CECOMPONENTADDRESS_HPP
/************************************************************************
 * \file        areg/component/CEComponentAddress.hpp
...
#include "areg/base/CEThreadAddress.hpp"
...
//////////////////////////////////////////////////////////////////////////
// CEComponentAddress class declaration
//////////////////////////////////////////////////////////////////////////
/**
 * \brief       Component Address object. All created components in system
 *              have their unique addresses and component can be reached
 *              by addresses. The component address contains master Thread
 *              Address and role name.
 * 
 * \details     Component Address should be unique in the system. The
 ...
 *
 **/
class AREG_API CEComponentAddress
{
//////////////////////////////////////////////////////////////////////////
...
public:
     ...
     *          IsValid() method.
     **/
    static const CEComponentAddress INVALID_COMPONENT_ADDRESS;
...
/************************************************************************/
     ...
     **/
    static CEString ConvertAddressToPath( const CEComponentAddress & componentAddress );
     ...
     **/
    static CEComponentAddress ConvertPathToAddress( const char* componentPath, const char ** out_nextPart = NULL );
...
public:
     ...
     **/
    CEComponentAddress( const CEThreadAddress & threadAddress );
     ...
     **/
    CEComponentAddress( const CEThreadAddress & threadAddress, const char * roleName );
     ...
     * \return	
     **/
    CEComponentAddress( const char * roleName );
     ...
     **/
    CEComponentAddress( const char * roleName, const char * nameThread );

    /**
     * \brief   Copy constructor.
     * \param   src     The source of data to copy.
     **/
    CEComponentAddress( const CEComponentAddress & src );
    /**
     * \brief   Initialization constructor.
     *          De-serialize component address information stored in stream.
     **/
    CEComponentAddress( const IEInStream & stream );

    /**
     * \brief   Destructor.
     **/
    ~CEComponentAddress( void );
...
/************************************************************************/
     ...
     **/
    inline const CEComponentAddress & operator = ( const CEComponentAddress & src );

    /**
     * \brief   Comparing operator. Returns true if 2 addresses are equal.
     **/
    inline bool operator == ( const CEComponentAddress & other ) const;
...
/************************************************************************/
     ...
     **/
    friend inline const IEInStream & operator >> ( const IEInStream & stream, CEComponentAddress & input );

    /**
     * \brief   Streaming operator. Writes to stream component address.
     **/
    friend inline IEOutStream & operator << ( IEOutStream & stream, const CEComponentAddress & output );
...
public:
     ...
     **/
    inline const CEString & GetComponentName( void ) const;
...
/************************************************************************/
     ...
     **/
    CEThreadAddress mThreadAddress;
...
//////////////////////////////////////////////////////////////////////////
// CEComponentAddress class inline function implementation
//////////////////////////////////////////////////////////////////////////

inline const CEComponentAddress& CEComponentAddress::operator = ( const CEComponentAddress& src )
{   mThreadAddress = src.mThreadAddress; mRoleName = src.mRoleName; return (*this);                             }

inline bool CEComponentAddress::operator == ( const CEComponentAddress& other ) const
...
inline const CEThreadAddress& CEComponentAddress::GetThreadAddress( void ) const
{   return mThreadAddress;                                                                                      }

inline const CEString& CEComponentAddress::GetComponentName( void ) const
{   return mRoleName;                                                                                           }

inline bool CEComponentAddress::IsValid( void ) const
{   return (mThreadAddress.IsValid() && this->mRoleName != INVALID_COMPONENT_NAME);                             }

//////////////////////////////////////////////////////////////////////////
// Friend global operators to support streaming
//////////////////////////////////////////////////////////////////////////
inline const IEInStream & operator >> (const IEInStream & stream, CEComponentAddress & input)
{   stream >> input.mRoleName; stream >> input.mThreadAddress; return stream;                                   }

inline IEOutStream & operator << (IEOutStream & stream, const CEComponentAddress & output)
{   stream << output.mRoleName; stream << output.mThreadAddress; return stream;                                 }

#endif  // AREG_COMPONENT_CECOMPONENTADDRESS_HPP
