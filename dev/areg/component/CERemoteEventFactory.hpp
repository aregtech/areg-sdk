#ifndef AREG_COMPONENT_CEREMOTEEVENTFACTORY_HPP
#define AREG_COMPONENT_CEREMOTEEVENTFACTORY_HPP
/************************************************************************
 * \file        areg/component/CERemoteEventFactory.hpp
...
//////////////////////////////////////////////////////////////////////////
// CERemoteEventFactory class declaration
//////////////////////////////////////////////////////////////////////////
/**
 ...
 *          will be constructed.
 **/
class AREG_API CERemoteEventFactory
{
//////////////////////////////////////////////////////////////////////////
// Static methods
//////////////////////////////////////////////////////////////////////////
public:
     ...
     *          wrong or unsupported event types, function returns NULL.
     **/
    static CEStreamableEvent * CreateEventFromStream( const CERemoteMessage & stream, const CEChannel & comChannel );
     ...
     **/
    static bool CreateStreamFromEvent( CERemoteMessage & stream, const CEStreamableEvent & eventStreamable, const CEChannel & comChannel );
     ...
     **/
    static CEStreamableEvent * CreateRequestFailedEvent( const CERemoteMessage & stream, const CEChannel & comChannel );
...
//////////////////////////////////////////////////////////////////////////
private:
    CERemoteEventFactory( const CERemoteEventFactory & /*src*/ );
    const CERemoteEventFactory & operator = ( const CERemoteEventFactory & /*src*/ );
};

#endif  // AREG_COMPONENT_CEREMOTEEVENTFACTORY_HPP
