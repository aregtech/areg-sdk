...
| `Lockable`                  | `Lockable`                      | `framework/areg/base/SyncPrimitives.hpp`                            | (same file)                                                      | C++ concept name; concrete = `ResourceLock`|
...
| `Align`                         | `Align`                         | `framework/areg/base/MemoryDefs.hpp`                               | (same file, struct in namespace)                                 |                                            |
...
| `S_ByteBuffer` / `sByteBuffer`                   | `RawByteBuffer`            | `framework/areg/base/MemoryDefs.hpp`                               | `ByteBuffer` taken by interface rename     |
| `S_RemoteMessage` / `sRemoteMessage`             | `RemoteMessageFrame`       | `framework/areg/base/MemoryDefs.hpp`                               | Wire format = "frame"                      |
| `S_RemoteMessageHeader` / `sRemoteMessageHeader` | `RemoteMessageHeader`      | `framework/areg/base/MemoryDefs.hpp`                               | No collision                               |
...
| `S_InterfaceData` / `SInterfaceData`             | `InterfaceDescriptor`      | `framework/areg/component/ServiceDefs.hpp`                         | Describes a service interface               |
...
| `sLogMessage`                                    | `LogRecord`                | `framework/areg/logging/LoggingDefs.hpp`                           | Wire format; `LogMessage` is the class     |
...
| `sProperty`                                      | `PropertyRecord`           | `framework/areg/persist/PersistenceDefs.hpp`                       | Serialized form; `Property` is the class   |
| `sPropertyKey`                                   | `PropertyKeyRecord`        | `framework/areg/persist/PersistenceDefs.hpp`                       | Same reasoning                             |
...
| `BufferAllocator`                                | (keep)                     | `framework/areg/base/MemoryDefs.hpp`                               | Already clean                              |
| `BufferDeleter`                                  | (keep)                     | `framework/areg/base/MemoryDefs.hpp`                               | Already clean                              |
...
| `E_DataStateType` / `eDataStateType`             | `DataState`                | `framework/areg/component/ServiceDefs.hpp`                         |                                            |
| `E_DegubPrio` / `DebugPriority`                     | `DebugPriority`            | `framework/areg/base/private/DebugDefs.hpp`                        | Fix typo                                   |
...
| `E_ServiceCall` / `eServiceCalls`                | `ServiceCall`              | `framework/areg/component/ServiceDefs.hpp`                         |                                            |
...
| `LoggingType`                                   | `LoggingType`              | `framework/areg/logging/LoggingDefs.hpp`                           | Fix typo, singular                         |
...
| `eRemoteServices`                                | `RemoteServiceId`          | `framework/areg/ipc/RemoteServiceDefs.hpp`                         | Identifies which remote service            |
...
| `NEMath`                          | `math`             | `framework/areg/base/MathDefs.hpp`                                 | Rect, Point, Size, Coord, LargeInteger              |
| `NEMemory`                        | `memory`           | `framework/areg/base/MemoryDefs.hpp`                               | Buffer types, alignment, message frames             |
| `NESocket`                        | `socket`           | `framework/areg/base/SocketDefs.hpp`                               | SocketAddress, UserData                             |
| `NEString`                        | `strings`          | `framework/areg/base/StringDefs.hpp`                               | CharDefs, Radix, string utilities                   |
| `NEUtilities`                     | `util`             | `framework/areg/base/UtilityDefs.hpp`                            | SystemTime, Duration, misc helpers                  |
| `NEDebug`                         | `debug`            | `framework/areg/base/private/DebugDefs.hpp`                        | Debug priorities, exception handling                |
| `NESyncTypesIX`                   | `sync_posix`       | `framework/areg/base/private/posix/SyncDefsPosix.hpp`            | POSIX sync primitives (platform-internal)           |
| `NERegistry`                      | `registry`         | `framework/areg/component/Model.hpp`                        | Model, ComponentEntry, ServiceEntry, etc.           |
| `NEService`                       | `service`          | `framework/areg/component/ServiceDefs.hpp`                         | Service types, enums, ProxyData, StateArray          |
| `NEConnection`                    | `connection`       | `framework/areg/ipc/private/ConnectionDefs.hpp`                    | Connection constants                                |
| `NERemoteService`                 | `remote_service`   | `framework/areg/ipc/RemoteServiceDefs.hpp`                         | Remote connection types and IDs                     |
| `NELogging`                       | `logging`          | `framework/areg/logging/LoggingDefs.hpp`                           | Log types, priorities, ScopeInfo, LogRecord          |
| `NELogOptions`                    | `log_options`      | `framework/areg/logging/private/LogOptions.hpp`                | Log config keys, layout tokens, status              |
| `NEPersistence`                   | `persist`          | `framework/areg/persist/PersistenceDefs.hpp`                       | PropertyRecord, ConfigKeys                          |
| `NESystemService`                 | `system_service`   | `framework/aregextend/service/SystemServiceDefs.hpp`               | Service options, system service states               |
| `NELogCollectorSettings`          | `log_collector`    | `framework/logcollector/app/LogCollectorNames.hpp`          | Log collector configuration                         |
| `NEMultitargetRouterSettings`     | `router_config`    | `framework/mtrouter/app/MTRouterNames.hpp`         | Router configuration                                |
